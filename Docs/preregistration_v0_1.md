...
## Stage 1 Preregistration and Definition Freeze — Version 0.1

**Date:** 2026-07-25  
**Status:** Draft for project-owner review. No decision in this document is final until Joey approves the freeze.  
...
| Provisional extension | 2025-01-01 onward | Monitoring only until one-year outcome coverage is complete under a fixed cutoff |
...
### 8.1 Rolling-origin development folds
...
The 2024 outcomes are not permitted for model or prompt development.
