...
CURRENT_STAGE: M3.3 PRE-E0 — GOVERNANCE IS RECONCILED THROUGH D123. D123 ACCEPTED (M3_3_D123_F2_BOUNDED_CHARACTERIZATION_OWNER_ACCEPTED), CLASSIFICATION F2_MATERIAL_BUT_ACCEPTABLE, SCOPE THE FIRST-SOURCE-CANARY ASSOCIATION-FINALIZATION SHAPE ONLY. READ THIS FIRST: THE FULL-POPULATION F2 EXECUTION AGAINST THE PRESERVED D122 F1 WORLD DID NOT RUN — IT WAS REFUSED AT THE STORAGE PREFLIGHT. No F2 transaction was opened against that world, no association projection was written into it, no section 9.5 totality check ran against it, and NO COMPLETION ARTIFACT EXISTS. WHAT IS ACCEPTED IS A BOUNDED REAL F2 CHARACTERIZATION: real F2 — materialize_census_associations(..., compact_evidence=True), whose ONE TRANSACTION SPANS BOTH TRAVERSALS AND THE TOTALITY CHECK per Decision 094 sections 6.2 to 6.4 and section 9.5 — executed against PRODUCTION-SCHEMA DISPOSABLE PROJECTIONS at 25k, 50k, 100k, 200k, 400k and 800k accessions, plus READ-ONLY AND PROBE measurement against the full about 23.5 GB D122 world. MEASURED SCALING: wall exponent b = 1.0053 at R^2 = 0.99986; WAL exponent 0.9748; DB-growth exponent 0.9996 — NO N x M / QUADRATIC MECHANISM WAS FOUND and repeated probes use the accepted indexes. REPEATABILITY: the 200k rung repeated three times spread about 1.40% in wall time with BYTE-IDENTICAL WAL and DB-growth byte counts. MEMORY: plateau about 0.68 GiB, not climbing with size. FULL-WORLD READ CHARACTERIZATION: 600,000 real groups at 136.32 us/group against the preserved about 23.5 GB D122 catalog, with a BOUNDED DATABASE-SIZE CONSTANT OF ABOUT 1.36x versus the about 2 GB projections — a bounded constant, NOT a scaling exponent, which is what rules out the D118 section 1 collapse mechanism FOR THIS SHAPE. D120-SCALE PROJECTION (projected, NOT measured): wall central about 0.78 h, primary range about 0.74 to 0.82 h, outer range about 0.63 to 0.94 h; pre-commit WAL about 3.487 GiB; durable DB growth about 2.358 GiB; peak RSS about 0.68 GiB. OWNER CONCLUSION: NO F2 ARCHITECTURE REMEDIATION IS REQUIRED FOR THE FIRST-SOURCE-CANARY SHAPE, and the existing single-transaction F2 architecture IS RETAINED (D123 R70, R72). SCOPE LIMITS, RECORDED PROMINENTLY: full-population F2 was NOT executed; about 92.7% OF THE D120 POPULATION REMAINS EXTRAPOLATED FOR WALL TIME; the measured ladder tops out at 800,000 accessions, about 9.7% of the 8,258,521 accepted D120 count; EVERY COMPLETE-FIRST-SOURCE NUMBER IS EXTRAPOLATION, NOT EVIDENCE; this characterizes NOTHING about the full 76-source E0 finalization shape, per the D121 section 5 limit; and ESTABLISHED / COMPLETENESS-WRITE BEHAVIOUR WAS NEVER EXERCISED AT ALL, because the first-source shape LACKS FULL-INDEX EVIDENCE so those paths were never reached. F2 THEREFORE NO LONGER BLOCKS THE FIRST-SOURCE-CANARY ARCHITECTURE. THE CAPACITY MODEL IS NOW THE BLOCKER. MIGRATION HEAD REMAINS 0015 and 0016 is absent. E0-v3 REMAINS UNAUTHORIZED. NO COMPLETE-SOURCE RUN IS AUTHORIZED. NO FULL-POPULATION F2 RERUN IS AUTHORIZED (D123 R71).
ACTIVE_BLOCKER: THE CAPACITY / POPULATION MODEL IS UNRECONCILED, AND NO REAL EXECUTION AUTHORIZATION OF ANY KIND EXISTS IN THIS REPOSITORY. D123 exposed TWO CAPACITY CONFLICTS AND DELIBERATELY RESOLVED NEITHER. CONFLICT A — GOVERNED MEMBER COUNT: real D117/D120 enumeration and Decision 110 section 7 give 985,834, while the older D111/D112 basis — Decision 111 section 5 and Decision 112 section 6 — gives 985,479, and the D123 report cited the older figure. OWNER RULING (D123 R75): 985,834 IS THE PROVISIONAL CONTROLLING REAL MEMBER COUNT and 985,479 IS STALE AND UNRESOLVED pending a D124 trace; provisional means it governs now and is still expected to be traced. CONFLICT B — COMPLETE-SOURCE STORAGE: D123 cited the older Decision 112 section 6 figure of about 132.5 GB working state, while later accepted work carries materially different compact-capacity figures at Decision 113 sections 15 and 19 and the Decision 118 section 5 (R24) STRAINED BUT NOT INVALIDATED finding. THIS PUBLICATION DOES NOT CHOOSE BETWEEN THEM — that would be a capacity ruling, and none is authorized here. OWNER RULING (D123 R74): THE PRIOR >= 85 GiB COMPLETE-SOURCE FREE-SPACE FLOOR FROM D121 SECTION 7 IS SUSPENDED PENDING D124 CAPACITY RECONCILIATION — suspended means NEITHER MET NOR LOWERED, and it may not be relied on in either direction. NO COMPLETE-SOURCE RUN MAY BE AUTHORIZED USING THE UNRESOLVED FIGURES. Nothing in this repository is an execution authorization: not this file, not a passing gate, not a commit, not a push, and not the D123 record published here — a record of an accepted finding is not a grant. D118 R23 still binds. The full-population F2 rerun, the D117 retry, the complete-source canary, the three-source canary, and the real replay proof remain NOT RUN and NOT AUTHORIZED. All three execution authorities are None, migration 0016 is unapplied and the operational catalog stays at head 0015, no E0-v3 namespace exists, both tracked network switches stay false at request ceiling 0, and the preserved D117, D120 and D122 worlds plus the D123 disposable characterization residue stay undeleted (D123 R76, R77).
IMPLEMENTATION_AUTHORIZATION: EXERCISED FOR GOVERNANCE PUBLICATION ONLY — THE OWNER'S 2026-08-20 DECISION 123 F2 BOUNDED CHARACTERIZATION OWNER-ACCEPTANCE / GOVERNANCE PUBLICATION INSTRUCTION, TOKEN M3_3_D123_F2_BOUNDED_CHARACTERIZATION_OWNER_ACCEPTED, AUTHORIZED THIS DOCUMENTATION-ONLY PUBLICATION AND NOTHING ELSE. The touched paths are Docs/Decisions/decision_123_m3_3_f2_bounded_characterization.md (new), one Docs/Decisions/decision_registry.md index row, eight Docs/decision_index.md navigation rows, and this file. NO SOURCE-CODE CHANGE, no test change, no schema or migration change, and no Docs/change_impact_map.md change were authorized or made — that map records code-surface impact, and D123 changes no code surface, which is the same treatment D117, D118 and D120 through D122 received. NOTHING WAS EXECUTED: no F2, no F1, no canary, no complete-source run, no E0, no network, no migration 0016, no database access, and no world was created, opened, modified, or deleted. A STATED NUMBERING CONDITION IS PUBLISHED RATHER THAN SILENTLY FIXED: Decision 094 sections 6 through 9 already carries rulings numbered R70 to R78 with entirely different content, the D123 numbers were issued by the owner and are recorded EXACTLY AS ISSUED because a publication does not renumber an owner ruling, and the operational consequence is that EVERY CITATION IN THE R70 TO R78 RANGE MUST NAME ITS DECISION — 'Decision 123 R72', never 'R72' alone. Resolving the numbering itself is a D124 governance question.
NEXT_AUTHORIZED_ACTION: NEXT TECHNICAL STAGE IS D124 — CAPACITY AND MODEL RECONCILIATION — AND IT IS NOT EXECUTED, NOT STARTED, AND NOT AUTHORIZED BY ANYTHING WRITTEN HERE. This entry records OWNER SEQUENCING ONLY. D124 must reconcile the two D123 section 9 conflicts: trace the 985,834 versus 985,479 governed member count (D123 R75) and reconcile the complete-source storage figures so the suspended >= 85 GiB free-space floor can be restored, replaced, or retired (D123 R74). THE NEXT AUTHORIZED TECHNICAL ACTION IS NOT A COMPLETE-SOURCE RUN AND NOT E0. Both remain unauthorized, as do the full-population F2 rerun, the D117 retry, the three-source canary, the real replay proof, migration 0016, network, and acquisition. DO NOT DELETE ANY WORLD OR RESIDUE: the D117, D120 and D122 worlds and the D123 disposable characterization residue are all preserved through D124, and the single C3 working-catalog deletion is spent. Do not emit an owner-acceptance token — this session may publish an accepted finding and may not accept anything.
