...
IMPLEMENTATION_AUTHORIZATION: NONE — MILESTONE 3.2 IS COMPLETE, OWNER-ACCEPTED, AND CLOSED (ACCEPTED DECISION 065, 2026-08-13). NO M3.2 IMPLEMENTATION WORK REMAINS AUTHORIZED, EVERY M3.2 IMPLEMENTATION AND ONE-SHOT AUTHORITY IS EXHAUSTED OR PERMANENTLY SPENT, AND THE ACCEPTED M3.2 CONTRACT IS A COMPLETED CONTRACT THAT AUTHORIZES NOTHING FURTHER. THE DECISION 065 SECTION 9 CLOSEOUT-AND-TAG AUTHORITY IS SINGLE-USE AND IS NOW ALSO EXHAUSTED. NO M3.3 IMPLEMENTATION IS AUTHORIZED: IT REQUIRES A SEPARATE OWNER PACKET AND ITS OWN ACCEPTED STAGE CONTRACT BEFORE ANY EXECUTABLE WORK BEGINS
ACTIVE_STAGE_CONTRACT: Milestones/contracts/m3_3.md
NEXT_AUTHORIZED_ACTION: OWNER ADJUDICATION OF THE THREE CONTRACTS RECORDED BY ACCEPTED DECISION 082 — AND NOTHING ELSE. Accepted Decision 082 (2026-08-14, outcome M3_3_DECISION_081_SOURCE_VERIFICATION_OWNER_ACCEPTED) accepted the EXECUTED Decision-081 fixed Complete-Submission-Text source verification and CLOSED its network authority: SAMPLE_N 108, 108 logical requests, 109 physical attempts, 108 successful artifacts, 0 terminal absences, SAMPLE_TOTALITY PASS, NETWORK_AUTHORIZATION SPENT/CLOSED. A sample of 108 rather than 125 is the CORRECT outcome of the no-backfill rule and is NOT a defect. Measured: native 14-digit acceptance 108/108, header accession 108/108, header form 108/108, AmendmentDescription nonempty 38/108, explicit issuer-authored amendment statement 98/108, at least one purpose-evidence source 101/108, explicit original form 98/108, explicit original filing date 98/108, explicit original accession 0/108, and the frozen mechanical M9 lookup EXACTLY_ONE 50 / ZERO 38 / MULTIPLE 10 / N/A 10 — which is an INSTRUMENT RESULT and is NOT the final document-evidence linkage capability rate. The executing-model deviation (Opus 5 requested, Fable 5 executed) is a NONBLOCKING PROCESS DEVIATION recorded as D081_MODEL_DEVIATION_ACCEPTED_NO_RERUN; DECISION 081 IS NOT RERUN and its R46-R50 stand unchanged. SEVEN RULINGS ARE FROZEN. R51 D079 DIAGNOSTIC SUPERSESSION: the historical compatible-original split ZERO 4677 / EXACTLY_ONE 42159 / MULTIPLE 75 / NO_DATE 1 remains HISTORICALLY TRUTHFUL as that audit session's output but is DEMOTED from a frozen binding fact to a HISTORICAL NON-GOVERNING AUDIT OBSERVATION, and MUST NOT be an E0 reconciliation gate, candidate identity, selection identity, quota evidence, linkage evidence, or a stop condition for any future stage; DECISION 079 AND DECISION 080 ARE NOT REWRITTEN and later references are marked superseded FOR CURRENT OPERATION only; the demotion is NARROW and leaves REAL_RAW_TOTAL_AMENDMENT_CANDIDATES 46912 and FROZEN_COHORT_AMENDMENT_CANDIDATES 20258 untouched under Decision 079 R41. R52 CANONICAL ASSOCIATION-SET DIAGNOSTIC (FUTURE DIAGNOSTIC USE ONLY): determine the complete set S of substantive registrant CIK associations for an amendment accession, identify for each CIK in S the compatible original accession records whose form is exactly 10-K or 10-KT and whose report_date exactly equals the amendment report_date, UNION across every CIK in S, deduplicate by canonical accession identity, and classify the unique original-accession set size as ZERO / EXACTLY_ONE / MULTIPLE, or NO_DATE where the amendment report_date is absent; it gives ZERO LINKAGE CREDIT and establishes NO amends_original, possible_amendment_of, family identity, parentage, or quota contribution; measured by D081 as ZERO 4286, EXACTLY_ONE 42391, MULTIPLE 234, NO_DATE 1, summing exactly to 46912 and FROZEN ONLY as a D079-population audit reconciliation fact, NEVER as real linkage evidence. R53 DOCUMENT ASSERTION EXTRACTION IS ADJUDICATED: no regex or mechanical extractor is adopted as governed evidence; PURPOSE SUPPORTING SPAN, ORIGINAL FORM ASSERTED, ORIGINAL FILING DATE ASSERTED, ORIGINAL ACCESSION ASSERTED (if any), SOURCE LOCATION, and ARTIFACT SHA-256 are extracted ONLY under the frozen human/adjudicated evidence protocol; A FISCAL-PERIOD END DATE MUST NEVER BE SUBSTITUTED FOR AN EXPLICITLY STATED FILING DATE; and the Decision-081 frozen mechanical extractor remains HISTORICAL VERIFICATION INSTRUMENT EVIDENCE ONLY, with M9 NEITHER CORRECTED NOR RERUN. R54 PURPOSE-FEASIBILITY CLOSURE STANDARD: the real amendment-purpose feasibility gate may close ONLY after a pre-registered independent document-evidence adjudication establishes at least one qualifying real amendment for EACH of the three frozen categories (administrative/certification/signature/exhibit-only; financial-statement/accounting/restatement/XBRL-correction; narrative/business/risk/control/governance disclosure), each witness drawn from the frozen D081 sample or a later owner-authorized deterministic sample, carrying an accepted Complete Submission Text artifact SHA, an exact supporting span/location, a pass under the frozen independent-review protocol, and no unresolved category conflict; THIS STAGE PRODUCES NO SUCH WITNESSES and M3_3_REAL_AMENDMENT_PURPOSE_FEASIBILITY_GATE_OPEN REMAINS OPEN. R55 LINKED-FEASIBILITY CLOSURE STANDARD: the real linked-amendment feasibility gate may close ONLY after pre-registered independent document-evidence adjudication establishes at least 8 DISTINCT SUBSTANTIVE ENTITIES whose amendments explicitly identify a compatible original form, explicitly identify the exact original filing date or accession, resolve to EXACTLY ONE compatible original accession under the COMPLETE substantive registrant association set, carry no conflicting explicit statement, and can satisfy the strict-later acceptance requirement using the accepted R43 accession-level acceptance source; the 8 feasibility witnesses NEED NOT become the final selected pilot witnesses, NO QUOTA CREDIT IS PERSISTED during feasibility adjudication, and M3_3_REAL_LINKED_AMENDMENT_FEASIBILITY_GATE_OPEN REMAINS OPEN. R56 D081 SOURCE SUFFICIENCY: COMPLETE_SUBMISSION_TEXT_SOURCE_FEASIBILITY = PROVED and NATIVE_ACCEPTANCE_SOURCE_FEASIBILITY = PROVED; the Complete Submission Text is the PREFERRED SINGLE-ARTIFACT SOURCE for native acceptance time, document-level purpose evidence, and explicit-original linkage evidence; structured XBRL is SUPPLEMENTARY ONLY; AN XBRL-ONLY ARCHITECTURE IS REJECTED; and NO FURTHER NETWORK ACQUISITION IS AUTHORIZED BY THAT RULING. R57 FUTURE SAMPLING: X1 (has_xbrl true AND has_inline_xbrl false) is NOT required as a mandatory recent-cohort sampling cell in future acquisition waves — D081 showed that class absent in prospective and monitoring with one member in primary_test — future sampling may still record XBRL state as a covariate, and the D081 sample remains valid and unchanged. THREE CONTRACTS ARE RECORDED PENDING OWNER ACCEPTANCE AND NONE IS IMPLEMENTED, AND THEY ARE NOT ACCEPTED METHODOLOGY: (1) the R46 MULTI-REGISTRANT IMPLEMENTATION CONTRACT (Decision 082 §10) answering A-L — relational representation with role 'anchor' permitted ONLY for an ESTABLISHED sole substantive registrant, the census and candidate scalars NULL otherwise, a new census_accession_registrants relation plus an explicit registrant_set_completeness state so that absent full-index evidence never reads as proof of a sole registrant, PROPOSED MIGRATION 0014 with eight changes over provably empty tables, the FIVE identities that consume the false singleton (accession_tie_break_sha256; candidate_accession_table_sha256; candidate_registrant_table_sha256; candidate_snapshot_sha256; and transitively selection_input_sha256 / selection_run_id and the pilot manifest component hashes and root), byte-for-byte single-registrant preservation recommended via a NON-CIK SENTINEL that selects no registrant at all, Decision 072 R24 preserved with R23's multi-registrant predicate RESTATED ANCHOR-FREE AT IDENTICAL EXTENSION, the hard multi-registrant quota of 2 unchanged because its witness is ALREADY ACCESSION-KEYED and needs no anchor, an empty-table hard precondition with revert-and-rebuild rollback, and FOURTEEN mutation tests MR-M1 through MR-M14; FIVE OPEN OWNER ITEMS including whether Decision 021 manifest ITEM 48 'anchor CIK' may become nullable and how history/event attribution works for a joint filer); (2) the VERIFIED-EVIDENCE SCHEMA CONTRACT (Decision 082 §11) — four new append-only relations plus the migration-0009 CHECK widening 'verified' requires, PROPOSED MIGRATION 0015 separate from and ordered after 0014, with the EXACT identity implication that adding a column to an existing digest tuple changes that digest even when the column is NULL everywhere, so the evidence layer must live ENTIRELY IN NEW HASHING DOMAINS, which leaves every accepted synthetic I/R identity BYTE-UNCHANGED; and (3) the FUTURE DOCUMENT-ADJUDICATION PROTOCOL CONTRACT (Decision 082 §12) — sequential REVIEW A then REVIEW B then ADJUDICATION in separate fresh epochs over the ALREADY STORED D081 artifacts at ZERO new SEC requests, with no parallel sessions required, defining review fields, allowed abstentions, the three verbatim categories, extraction rules X-1 through X-6, span-citation and fail-closed rules, agreement and third-adjudication rules, five frozen hashes, and both feasibility-witness calculations. NO SESSION MAY BEGIN THE R46 IMPLEMENTATION, WRITE MIGRATION 0014 OR 0015 OR ANY MIGRATION, EXECUTE REVIEW A / REVIEW B / ADJUDICATION, CLASSIFY ANY REAL FILING, RESOLVE ANY REAL PARENTAGE, GRANT ANY QUOTA CREDIT, OR BEGIN M3.3-E0 (the real offline metadata parse), M3.3-E1 (the real candidate snapshot and selection), M3.3-E2 (the real manifest and root), OR M3.4 (root approval) ON ITS OWN AUTHORITY — EACH REMAINS A SEPARATE OWNER GATE THAT NO CONTRACT ACCEPTANCE, PASSING REHEARSAL, INDEPENDENT REVIEW, OWNER I/R ACCEPTANCE, GREEN SUITE, COMMIT, TAG, OR PRIVATE CATALOG SUPPLIES. E0 ADDITIONALLY STILL CARRIES THE R49 TWO-CONDITION SEQUENCING GATE, WHOSE CONDITION A (the D081 sample returned and owner-adjudicated) IS NOW SATISFIED AND WHOSE CONDITION B (the R46 correction implemented, independently reviewed, and owner-accepted) IS NOT. M3_3_REAL_AMENDMENT_PURPOSE_FEASIBILITY_GATE_OPEN and M3_3_REAL_LINKED_AMENDMENT_FEASIBILITY_GATE_OPEN are both ACTIVE and are never merged into one flag, and M3_3_REAL_ACCEPTANCE_ORDERING_ADEQUACY is PENDING FUTURE AUTHORIZED E0 VERIFICATION. NETWORK, SEC, AND HTTP AUTHORITY IS NONE WITH REQUEST_CEILING 0; reacquisition and accepted-private-evidence WRITE authority remain NONE; migrations remain 0001-0013 and MIGRATION_AUTHORIZED remains none; and m3.2-complete remains unmoved
...
M3_3_MULTI_REGISTRANT_CORRECTION_STATUS: REQUIRED BEFORE E0 — CONTRACT WRITTEN AND PENDING OWNER ACCEPTANCE; STILL NOT AUTHORIZED AND NOT IMPLEMENTED (accepted Decision 081 R46, R49; contract at accepted Decision 082 §10). The 568 multi-registrant amendment accessions found by the Decision-079 audit have NO lawful single anchor, and every anchor-selection heuristic — first-write order, minimum/maximum CIK, archive path, record order, hash, a submissions-document occurrence, and any filing-agent or submitter heuristic — remains PROHIBITED, including the intrinsic-submitter option Decision 080 §8.3 recommended as MR-3(a). Decision 082 §10 now states the exact implementation contract: role 'anchor' permitted ONLY for an ESTABLISHED sole substantive registrant; census_accessions.registrant_cik_numeric, pilot_candidate_accessions.anchor_cik_numeric, and pilot_selected_accessions.anchor_cik_numeric NULL otherwise; census_accessions.submitter_cik_numeric REMAINS FACTUAL AND IS NEVER PROMOTED TO REGISTRANT IDENTITY; a NEW census_accession_registrants relation because no durable census-level association relation exists today; an explicit registrant_set_completeness state so that ABSENT full-index evidence NEVER reads as proof of a sole registrant; PROPOSED MIGRATION 0014 with eight changes, every affected table provably empty so each STRICT-table rebuild copies zero rows; FIVE identities consuming the false singleton (accession_tie_break_sha256, candidate_accession_table_sha256, candidate_registrant_table_sha256, candidate_snapshot_sha256, and transitively selection_input_sha256 / selection_run_id plus the pilot manifest component hashes and root) against snapshot_id, entity_tie_break_sha256, evidence_sha256, and resolution_sha256 VERIFIED UNAFFECTED; byte-for-byte single-registrant preservation recommended via a NON-CIK SENTINEL that selects no registrant at all and is therefore not an anchor-selection heuristic; Decision 072 R24 preserved intact and R23's multi-registrant predicate RESTATED ANCHOR-FREE AT IDENTICAL EXTENSION; the hard multi-registrant quota of 2 unchanged because its witness is ALREADY ACCESSION-KEYED, with selection attachment moving from the composite anchor foreign key to an explicit at-least-one-co-selected-substantive-registrant trigger rule; an EMPTY-TABLE HARD PRECONDITION with revert-and-rebuild rollback and NO down-migration; and FOURTEEN mutation tests MR-M1 through MR-M14. FIVE OPEN OWNER ITEMS remain, including whether Decision 021 manifest ITEM 48 'anchor CIK' may become nullable and whether a multi-registrant accession's history attributes to EVERY substantive registrant or to NONE. The correction is still a future bounded, owner-authorized stage requiring its own decision, implementation, independent review, and owner acceptance; its supporting migration is AUTHORIZED IN PRINCIPLE only. Until it lands, M3.3-E0 is blocked by R49 condition B

M3_3_VERIFIED_EVIDENCE_MIGRATION_STATUS: AUTHORIZED IN PRINCIPLE — CONTRACT WRITTEN AND PENDING OWNER ACCEPTANCE; STILL NOT AUTHORIZED FOR IMPLEMENTATION AND NOT IMPLEMENTED (accepted Decision 081 R46, R47; contract at accepted Decision 082 §11). Migration 0009 excludes 'verified' from every candidate evidence-level CHECK by design, so neither verified amendment-purpose evidence nor verified linkage evidence can be persisted under the current schema at all, and amendment_purpose_quota_eligible additionally requires amendment_purpose_evidence_level = 'provisional'. Decision 082 §11 states the minimum design: four new append-only relations (document_artifacts, document_review_records, document_review_spans, document_adjudicated_evidence) plus the CHECK widening, at PROPOSED MIGRATION 0015, SEPARATE FROM and ORDERED AFTER the R46 migration 0014 so the evidence layer is never built on a schema that still asserts a false singleton. THE EXACT IDENTITY IMPLICATION IS FROZEN: hash_table hashes the table name, the column tuple, and the sorted rendered rows with NULL rendered as a fixed sentinel, so ADDING A COLUMN TO AN EXISTING DIGEST TUPLE CHANGES THAT DIGEST FOR EVERY ROW EVEN WHEN THE COLUMN IS NULL EVERYWHERE, while a NEW DOMAIN leaves every existing digest byte-unchanged — therefore the evidence layer may be added with ZERO disturbance to accepted synthetic I/R identities IF AND ONLY IF it lives entirely in NEW hashing domains and NO existing column tuple is widened, and no second hash implementation is introduced. The one unavoidable and correct exception is that when a verified category or verified linkage actually reaches pilot_candidate_accessions, candidate_accession_table_sha256 changes because a VALUE changed — a content change under an unchanged column tuple, affecting only future real snapshots and no synthetic fixture. FOUR OPEN OWNER ITEMS remain. Migrations remain 0001-0013 and MIGRATION_AUTHORIZED remains none
