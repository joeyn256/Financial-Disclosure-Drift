...
CURRENT_STAGE: M3.3 PRE-E0 — D125 ARCHIVAL AND VERIFIED INTERNAL RECLAMATION IS ACCEPTED, AND THE HISTORICAL LARGE WORLDS NOW LIVE EXTERNALLY RATHER THAN INTERNALLY. D125 ACCEPTED (M3_3_D125_EXTERNAL_ARCHIVAL_AND_RECLAMATION_OWNER_ACCEPTED), published as a RETROSPECTIVE DURABLE RECORD of an operation that had ALREADY COMPLETED — the Decision 125 file DID NOT EXIST BEFORE THE OPERATION AND DID NOT AUTHORIZE IT; the authorizing instrument was the GPT-5.6 Sol owner instrument issued at execution time. D125 DISCHARGES the Decision 124 section 11 obligation (D124-R7, D124-R8, D124-R9). THE D122 POST-F1 WORKING-CATALOG IDENTITY IS NOW ACCEPTED DURABLE IDENTITY AND NO LONGER A CANDIDATE (D125-R2): fa4a635d36a487774e02670bb0fab1ded1c696b5e25faf54fb6f55b69799f413, on FOUR CONVERGING READS — a fresh internal D125 hash, the historical D123 candidate, the external archive member STREAMED BACK OFF THE EXTERNAL DEVICE AND REHASHED, and multiple independent reads; the D124-R8 STOP-ON-MISMATCH CONDITION NEVER FIRED. HISTORICAL LARGE WORLDS ARE PRESERVED EXTERNALLY: seven uncompressed PAX/TAR archives at /Volumes/SSK SSD/FDD_M3_D125_ARCHIVE/ on the exFAT SSK SSD — d117_world.tar 27,629,187,072 B, d120_world.tar 19,955,783,680 B, d122_f1_world.tar 23,530,204,160 B, d123_characterization.tar 4,034,596,352 B, m3_perf_experiments.tar 84,995,072 B, c3_retained_evidence.tar 11,043,328 B, d117_diagnostics.tar 277,504 B — totalling 75,246,087,168 BYTES, ABOUT 70.0784 GiB, each with a recorded SHA-256. VERIFICATION STREAMED THE ACTUAL TAR CONTENTS BACK FROM THE EXTERNAL DEVICE: 2,777/2,777 MEMBERS MATCHED, 2,470/2,470 REGULAR-FILE SHA-256 VALUES MATCHED, 0 MISSING, 0 UNEXPECTED, 0 DUPLICATE, ALL METADATA COMPARISONS PASSED. RETENTION: permanent internal root ~/m3-retention/d125/, primary final manifest d125_manifest_final.json at SHA-256 1366a5dd484e8d0e57c3b7ae6e401f3420c21be8685494c7d28199da3e5c3a9c, with the external RETENTION copy VERIFIED BYTE-IDENTICAL to the internal record; the D124-R9 exFAT metadata limitation is answered by PAX metadata PLUS explicit manifests, per-file hashes, and recorded mode/uid/gid/owner/group/path/type/size/mtime/symlink metadata. INTERNAL COPIES LISTED IN D125 ARE RETIRED, AND ONLY AFTER EXTERNAL VERIFICATION PASSED: exactly five roots — the D117, D120, D122-F1 and D123 canary worlds under ~/m3-disposable-canaries/ plus ~/m3-perf-experiments — with the VERIFIED EXTERNAL ARCHIVES NOW STANDING AS THE PRESERVED EVIDENCE. STILL INTERNAL AND PROTECTED: ~/m3-private-evidence, the C3 m3_3_perf_c3_local_40k_v1 world, ~/m3-d117-diagnostics, ~/m3-retention/d125, the repository, the current raw SEC source, and the operational catalog. MEASURED RECLAMATION 66,289,078,272 BYTES = 61.7365 GiB against the Decision 124 section 12 clone-aware prediction of about 61.77 GiB — THE MODEL IS CONFIRMED TO ABOUT 0.03 GiB. INTERNAL FREE IS ABOUT 97.324 GiB (104,500,830,208 bytes settled) AND THE 105 GiB GATE IS NOT MET, leaving a remaining hard gap of 8,242,061,312 bytes = 7.6760 GiB; a measurement condition is stated rather than smoothed, as three readings of the live APFS volume spread about 17 MB (about 0.016%) and ALL THREE FALL SHORT BY ABOUT THE SAME 7.68 GiB. THE APPROXIMATELY 110 GiB STAGING FIGURE IS AN OWNER PREFERENCE AND MUST NEVER BE DESCRIBED AS THE FORMAL GATE — THE FORMAL ADMISSION PREDICATE REMAINS >= 105 GiB (D125-R6). NO MORE FDD EVIDENCE DELETION IS AUTHORIZED FOR CAPACITY (D125-R3) and the section 7 retirement is SPENT. EXTERNAL SSK SSD REMAINS COLD/ARCHIVE STORAGE ONLY, NO ACTIVE GOVERNED SQLITE USE, NO REFORMAT (D125-R4). MIGRATION HEAD REMAINS 0015 and 0016 is absent. E0-v3 REMAINS UNAUTHORIZED. NO COMPLETE-SOURCE RUN IS AUTHORIZED. D125 SUPERSEDES NOTHING — Decisions 121, 122, 123 and 124 stand as written and the D124-R5 gates carry forward intact.
ACTIVE_BLOCKER: INTERNAL FREE SPACE — THE GAP IS NOW ABOUT 7.68 GiB AND MUST BE CLOSED FROM ORDINARY NON-PROJECT STORAGE, NOT FROM PROJECT EVIDENCE, AND NO REAL EXECUTION AUTHORIZATION OF ANY KIND EXISTS IN THIS REPOSITORY. Archival is no longer the blocker: D125 completed it, verified it by streaming the archives back off the external device, and reclaimed 61.7365 GiB. What blocks now is the remaining arithmetic. MEASURED, NOT PROJECTED: settled internal free 104,500,830,208 bytes = 97.3240 GiB against the controlling D124-R5 starting gate of 112,742,891,520 bytes = 105 GiB, a REMAINING HARD GAP OF 8,242,061,312 BYTES = 7.6760 GiB. The D124 section 12 Plan A projection of about 98.46 GiB is now SUPERSEDED BY MEASUREMENT rather than by argument, and the earlier about 6.54 GiB projected gap is likewise replaced by the measured 7.68 GiB. OWNER PREFERENCE UNCHANGED: free or move ORDINARY NON-PROJECT DATA rather than alter append-only project raw evidence to close a gap this small; NO NON-PROJECT DELETION IS AUTHORIZED OR PERFORMED, and NO FURTHER FDD EVIDENCE DELETION IS AUTHORIZED FOR CAPACITY AT ALL (D125-R3). BEFORE ANY COMPLETE-SOURCE AUTHORIZATION: internal free space must be MEASURED at >= 105 GiB — MEASURED, NOT PROJECTED — and a FINAL LIVE M3.3 COMPLETE-SOURCE PREFLIGHT must run and pass, because CROSSING THE DISK THRESHOLD DOES NOT ITSELF AUTHORIZE EXECUTION (D125-R7). THAT PREFLIGHT MUST EXPLICITLY CHECK THE SECTION 10 RESIDUE: two HISTORICAL CONSUMED E0 namespaces, m3_3_e0_offline_parse_v1 and m3_3_e0_offline_parse_v2, and a stale catalog_writer.lease remain under the private evidence root, UNTOUCHED BY D125 — their mere existence is NOT A NEW E0 NAMESPACE and NO E0-v3 AUTHORITY EXISTS (D125-R8). Nothing in this repository is an execution authorization: not this file, not a passing gate, not a commit, not a push, and not the D125 record published here — a record that preserves evidence and frees space is NOT a grant to spend the space. D118 R23 still binds. The complete-source canary, the full-population F2 rerun, the D117 retry, the three-source canary, and the real replay proof remain NOT RUN and NOT AUTHORIZED. All three execution authorities are None, migration 0016 is unapplied and the operational catalog stays at head 0015, no E0-v3 namespace exists, and both tracked network switches stay false at request ceiling 0.
IMPLEMENTATION_AUTHORIZATION: EXERCISED FOR GOVERNANCE PUBLICATION ONLY — THE OWNER'S 2026-08-20 DECISION 125 EXTERNAL EVIDENCE ARCHIVAL AND VERIFIED INTERNAL STORAGE RECLAMATION OWNER-ACCEPTANCE / GOVERNANCE PUBLICATION INSTRUCTION, TOKEN M3_3_D125_EXTERNAL_ARCHIVAL_AND_RECLAMATION_OWNER_ACCEPTED, AUTHORIZED THIS DOCUMENTATION-ONLY PUBLICATION AND NOTHING ELSE, by expressly directing the creation or update of Decision 125, the decision registry, the decision index, and STATUS. The touched paths are Docs/Decisions/decision_125_m3_3_external_archival_and_reclamation.md (new), one Docs/Decisions/decision_registry.md index row, eleven Docs/decision_index.md navigation rows, and this file. NO SOURCE-CODE CHANGE, no test change, no schema or migration change, and no Docs/change_impact_map.md change were authorized or made — that map records code-surface impact, and D125 changes no code surface, which is the same treatment D117, D118 and D120 through D124 received. src/disclosure_drift/m3/capacity_plan.py IS UNTOUCHED and no Decision 113 capacity constant moved. THE ARCHIVAL, VERIFICATION AND RETIREMENT DESCRIBED HERE WERE PERFORMED BEFORE AND OUTSIDE THIS PUBLICATION, under the GPT-5.6 Sol owner instrument issued at execution time; THIS SESSION EXECUTED NOTHING: no copy, no deletion, no write to the external SSD, no F1, no F2, no canary, no complete-source run, no E0, no network, no migration 0016, no database access, and no governed SQLite writer. Read-only verification of the published facts was performed and is reported: git entry state, migration head, the three authority constants, both network switches, df free space, the presence or absence of the retired and retained roots, the retention manifest SHA-256, and the E0 namespace and lease residue. ONE MEASUREMENT CONDITION IS PUBLISHED RATHER THAN SMOOTHED: the settled internal free figure 104,500,830,208 bytes is controlling, while the D125 retention artifact recorded 104,503,115,776 bytes and a publication-time re-read returned 104,485,810,176 bytes — a spread of about 17 MB, about 0.016%, across three readings of a live APFS volume, ALL THREE OF WHICH FALL SHORT OF THE 105 GiB GATE BY ABOUT THE SAME 7.68 GiB. ONE OBLIGATION IS CARRIED FORWARD RATHER THAN CLOSED: the Decision 124 section 4 stored-object naming reconciliation — c85744be921b0dc5 versus the older object named at Decision 059 section 3 — is OUTSTANDING, because the D125 instrument is scoped to archival and reclamation and does not address it, and NO READER MAY CITE D125 AS HAVING CLOSED IT. No owner-acceptance token was emitted by the publishing session.
NEXT_AUTHORIZED_ACTION: ORDINARY NON-PROJECT STORAGE TOP-UP CHOSEN BY THE USER, FOLLOWED BY A FINAL LIVE M3.3 COMPLETE-SOURCE PREFLIGHT. NEITHER IS EXECUTED AND NEITHER IS AUTHORIZED BY ANYTHING WRITTEN HERE — this entry records OWNER SEQUENCING ONLY. The top-up must come from ORDINARY NON-PROJECT DATA chosen by the user: NO FURTHER DISCLOSURE DRIFT EVIDENCE MAY BE DELETED TO SATISFY THE CAPACITY GATE (D125-R3), the D125 section 7 retirement is SPENT, and the section 8 preserved material — ~/m3-private-evidence, the C3 world, ~/m3-d117-diagnostics, ~/m3-retention/d125, the repository, the current raw SEC source, and the operational catalog — STAYS PRESERVED. The target is MEASURED internal free >= 105 GiB = 112,742,891,520 bytes, which is about 7.68 GiB above the settled 97.3240 GiB; approximately 110 GiB is an OWNER PREFERENCE IF ORDINARY CLEANUP MAKES IT EASY AND IS NOT THE FORMAL GATE (D125-R6). CROSSING THE THRESHOLD AUTHORIZES NOTHING BY ITSELF (D125-R7): the final live preflight must still run, every other predicate must still pass, and IT MUST EXPLICITLY CHECK THE D125 SECTION 10 RESIDUE — the two historical CONSUMED E0 namespaces m3_3_e0_offline_parse_v1 and m3_3_e0_offline_parse_v2 and the stale catalog_writer.lease, whose mere existence is NOT a new E0 namespace (D125-R8). COMPLETE SOURCE IS NOT AUTHORIZED AND E0 IS NOT AUTHORIZED. F1, F2, the full-population F2 rerun, the D117 retry, the three-source canary, the real replay proof, migration 0016, network, and acquisition all remain unauthorized. ACTIVE GOVERNED SQLITE USE OF THE EXTERNAL SSD IS NOT APPROVED, the SSK SSD REMAINS COLD/ARCHIVE ONLY WITH NO REFORMAT (D125-R4), and Plan B remains NOT APPROVED. ONE OBLIGATION REMAINS OPEN FOR A LATER INSTRUMENT: the Decision 124 section 4 stored-object naming reconciliation, which D125 section 12 carries forward rather than discharges. Do not emit an owner-acceptance token — this session may publish an accepted ruling and may not accept anything.
