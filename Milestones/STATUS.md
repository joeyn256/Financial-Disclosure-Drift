...
CURRENT_STAGE: M3.3 — DECISION 151 (R2-C PARSER 1.3 AND FAILFAST-D) IS OWNER-ACCEPTED AND PUBLISHED BY ONE GOVERNED LOCAL COMMIT: PRESERVED WIP, PROSPECTIVELY CORRECTED (V5), THEN WAL-PRESERVATION CORRECTED, THEN VALIDATED BY NORMAL CI ON ITS EXACT TREE, THEN INDEPENDENTLY RE-REVIEWED (R3) WITH THAT TECHNICAL REVIEW OWNER-ACCEPTED, THEN CARRYING A PREPARED AND VALIDATED GOVERNANCE DOCUMENTATION CLOSEOUT THAT THE OWNER HAS SINCE ACCEPTED, AND FINALLY CLOSED BY AN OWNER-ACCEPTED FINAL LOCAL FULL GATE. NOTHING IS PENDING: THE FRESH INDEPENDENT CORRECTION REVIEW, THE GOVERNING-OWNER ADJUDICATION OF THAT DOCUMENTATION CLOSEOUT, THE SEPARATELY AUTHORIZED FINAL_FULL_GATE CLOSURE, OWNER IMPLEMENTATION ACCEPTANCE AND THE SEPARATE PUBLICATION AUTHORIZATION ARE ALL DONE. CANDIDATE ORIGIN: Claude Fable 5.1 at maximum effort in one session with no subagents, USING M3_3_D151_R21_R2C_PARSER13_FAILFAST_ENGINEERING_V3_AUTHORIZED — A TOKEN THE OWNER HAD ALREADY SUPERSEDED BEFORE THAT EXECUTION. That use is historical fact and NOT authority: V3 was not a valid live Phase-B authorization, THE OWNER DOES NOT RETROACTIVELY RATIFY IT, and the candidate therefore carries NO owner implementation acceptance; every V1/V2 engineering token is SUPERSEDED and NOT consumed, and V4 is SUPERSEDED_UNCONSUMED. THE INITIAL INDEPENDENT TECHNICAL REVIEW IS OWNER-ACCEPTED (zero BLOCKER, zero MAJOR code defects; findings MAJOR-1 and MINOR-1 through MINOR-4) — review acceptance is NOT implementation acceptance. Those five findings were corrected under M3_3_D151_R21_R2C_PARSER13_FAILFAST_PROSPECTIVE_CORRECTION_V5_AUTHORIZED, a BOUNDED PROSPECTIVE correction of the preserved WIP over an eight-path write allowlist, executed by Claude Opus 5 at maximum effort in one session with no subagents under the owner's explicit in-session executor substitution; it ratifies nothing, accepts nothing and closes no gate. ONE FURTHER PRODUCTION CORRECTION then followed under the SEPARATE LATER instrument M3_3_D151_R21_V5_WAL_PRESERVATION_PRODUCTION_CORRECTION_CI_R2_AUTHORIZED (distinct from V5, and distinct from V5's own correction item C2), executed by Claude Opus 5 at maximum effort after the owner/operator explicitly substituted Opus for the Fable the packet named: exactly one path, chunk_multipass.py::_WalPreservationGuard, whose constant-only SELECT 1 activation became SELECT COUNT(*) FROM main.sqlite_schema so a real database-backed read is forced through the mode=ro preservation guard before the production writer opens, failing closed if activation fails (b7f63ec676e9053917eba16b6ade26260707dd663d3b1a019bab9adf66ebd25c -> f33b67ab8634440ab5449a2bfe41656f0f3dabe5e03018376211d891f89714a6). WAL_C2_TEST_MODIFICATIONS = NONE, WAL_C2_R36_MODIFICATION = NONE, WAL_C2_STORAGE_FLOOR_CHANGE = NONE, WAL_C2_MIGRATION = NONE, WAL_C2_COMPATIBILITY_BRIDGE = NONE, WAL_C2_PARSER_OR_METHODOLOGY_REDESIGN = NONE. THE EXACT CORRECTED CANDIDATE TREE THEN PASSED NORMAL CI: EXACT_V5_CANDIDATE_NORMAL_CI = GREEN, bound ONLY to tree 59e52bb2aedcfcf94cd3282c5ad7e017ccf1d4ca, GitHub Actions run 34309408051, attempt 1 — both jobs successful, 6298 passed and 7 skipped. THAT IS NOT LIVE_MAIN_NORMAL_CI = GREEN (main is red independently at run 34075716227, whose d08 WAL-pathname failure cascaded into R36 and was NOT caused by the 50-GiB storage admission) AND IT IS NOT FULL-GATE CLOSURE; the provisional validation commit 3178abe09ee2eb3cb6c468e3cc38ef2b7c7a132f (sole parent 80c84c81…, tree 59e52bb2…) is evidence only, never enters the governed chain, and at that point the governed checkout still carried zero implementation commits — a count now measured by the governed-publication boundary of Decision 151 §7d. THE FRESH INDEPENDENT CORRECTION REVIEW IS COMPLETE under M3_3_D151_R21_V5_WAL_C2_POST_CI_OPUS_R3_READONLY_AUTHORIZED ("R3", a fresh Claude Opus 5 Maximum session): verdict POST_CI_C2_CANDIDATE_TECHNICALLY_ACCEPTABLE_FOR_OWNER_ADJUDICATION at zero BLOCKER and zero MAJOR, and THE GOVERNING OWNER ACCEPTED THAT TECHNICAL REVIEW AND ITS FINDING CLASSIFICATION — which is not implementation acceptance. R3 MINOR-1 = DEFERRED_NONBLOCKING AND NOT REPAIRED (tests/unit/test_decision_151_parser_1_3_failfast_d.py lies outside several test_d151_* family sweeps; the file is not renamed, R36 and the sweeps are not edited, its direct coverage is preserved, and no repair is claimed). R3 MINOR-2 = CLOSED: the bounded five-surface closeout under M3_3_D151_R21_C2_GOVERNANCE_PUBLICATION_CLOSEOUT_R1_AUTHORIZED — documentation only, zero source or test bytes changed, AGENTS.md and CLAUDE.md byte-identical, DOC_CLOSEOUT_NORMAL_CI = NOT_RUN, exiting UNCOMMITTED AND UNSTAGED and not self-accepted — was ACCEPTED BY THE GOVERNING OWNER, so GOVERNANCE_CLOSEOUT = OWNER_ACCEPTED. THE SEPARATELY AUTHORIZED FINAL LOCAL FULL GATE THEN RAN ON ITS OWN FRESH CAPACITY ADMISSION AND PASSED — one make check-fast over tree ef0e9e24f39e141191148ec5b282f36003ee343e, seven worksteal workers, all eleven gates PASS, 6305 collected / 6304 passed / 1 skipped, free space 95101231104 B at launch and never below the minimum observed 74131054592 B — and the owner ACCEPTED it under M3_3_D151_R21_FINAL_LOCAL_FULL_GATE_R1_ACCEPTED. FINAL_LOCAL_GATE_OWNER_ADJUDICATION = ACCEPTED. FINAL_FULL_GATE = CLOSED. OWNER_IMPLEMENTATION_ACCEPTED = YES under M3_3_D151_R21_IMPLEMENTATION_ACCEPTED. THE PUBLICATION-STATE DELTA THAT CARRIES ALL OF THIS CHANGES FIVE GOVERNANCE FILES AND NO SOURCE OR TEST BYTE, AND WAS COMMITTED ONCE UNDER M3_3_D151_R21_FINAL_PUBLICATION_SINGLE_GOVERNED_COMMIT_R1_AUTHORIZED, A BOUNDED AUTHORITY EXHAUSTED BY THAT SINGLE COMMIT. ACCEPTANCE ADVANCES NO SCIENTIFIC STAGE, AND V3_OWNER_ACCEPTED = NO AND V3_RETROACTIVE_RATIFICATION = NO ARE UNCHANGED. PHASE A (PROSPECTIVELY ADOPTED BY THE OWNER AS THE CURRENT BASELINE; adopting it ratifies nothing about the Phase-B execution): exactly one local governance commit, 80c84c81489785c1ed4f78777af5b69dfa924aed (TREE 8286a60dee66975a2e9f7aa3f1ebb78814f2a2c2, parent 9f71f794e79e225c9e3f298d6428fdd79d3fca31), replacing the untracked AGENTS.md duplicate with the owner-supplied CLAUDE.md compatibility pointer (SHA-256 2828d4473f628a50a6c422e925c1795b63366332d26d20e35a066803578475ca) and changing nothing else; CLAUDE.md retains 706744edaecaecf80e25a59043314f3b42e954f458e3496cbf2f5bdc210174e7. PHASE B, over that clean baseline and left UNCOMMITTED AND UNSTAGED by its own session: parser submissions-json/1.3 (a valid-CIK document with an absent, null, non-string or blank current name is a field-level NON-blocking company-name defect under the one new code PARSER_REGISTRANT_NAME_DEFICIENT; an unusable CIK remains blocking; formerNames never substitutes; the nested regions are read from their own values); MAJOR-1 bounded declaration consistency with its one named residual (a malformed top-level array, contained by the undeclared-shard refusal); FailFast-D Boundaries 1–4 (authenticated chunk semantics read from the manifest-bound run row; admission refusing a blocking or unverifiable chunk before any world at consolidate_chunks, merge_group_body and merge_calibration_subset_group_body; intermediate receipt /1 -> /2 with observed semantics, a forensic-only /1 reader and prospective retention enforced in delete_calibration_group_chunk_worlds; the level-2 engine refusing every stage after a blocking committed S2 — fresh, resumed and after a crash — through the accepted require_f0_success with a create-once semantic-refusal record); MINOR-1 (the committed S2 witness re-derived from its row by an independently derived identity, S19's published counts re-derived too); MINOR-3 (status legibility). S19, require_f0_success, BLOCKING_PARSER_STATES and E0_REQUIRED_PARSE are UNCHANGED; NO migration (head 0015, 0016 absent); the §25 protocol text is UNCHANGED (R4) with the audit fields carried in Decision 151 §4. Expected provenance movement: witness_ledger_identity moves for every new /2 write and the parser_run_id preimage carries 1.3. CANARY_AUTHORIZED = NO.
ACTIVE_BLOCKER: NONE FOR DECISION 151 — THE PHASE-B IMPLEMENTATION IS OWNER-ACCEPTED AND PUBLISHED BY ONE GOVERNED LOCAL COMMIT. The earlier five-step sequence is complete: the fresh Claude Opus 5 Maximum independent CORRECTION review and the owner's adjudication of that REVIEW were done, and so now are (1) governing-owner acceptance of the governance documentation closeout, (2) the SEPARATELY authorized FINAL_FULL_GATE closure, which ran on its own fresh capacity admission and PASSED over tree ef0e9e24f39e141191148ec5b282f36003ee343e, together with the separate remaining storage disposition, recorded from the owner's rulings rather than re-established by any storage access, (3) governing-owner implementation acceptance under M3_3_D151_R21_IMPLEMENTATION_ACCEPTED, and (4) the separate publication authorization M3_3_D151_R21_FINAL_PUBLICATION_SINGLE_GOVERNED_COMMIT_R1_AUTHORIZED, bounded to one governed local commit and exhausted by it. Decision 151 is ACCEPTED and binding. R3 MINOR-1 REMAINS DEFERRED_NONBLOCKING AND IS NOT REPAIRED, and public-main reconciliation and CI are NOT evaluated by that publication. THE V5 CORRECTION AUTHORITY IS CONSUMED AND AUTHORIZES NOTHING FURTHER — it was never implementation acceptance, committed publication, commit authority or full-gate closure, and no executor minted any successor token. THE SAME IS TRUE OF EVERY LATER INSTRUMENT: the WAL-preservation/CI-R2 authority, the R3 read-only review authority and the C2 governance-publication-closeout authority are each CONSUMED and each authorized nothing beyond its own bounded act — no test execution beyond what each named, no CI beyond run 34309408051, no commit, no push, no tag, no merge, no PR modification, no storage action and no successor token. THE R6 RECOMPUTE (H2 — 34 chunks -> 34 retained witnesses -> 5 intermediates -> one new L2 successor world under one revision and parser 1.3) IS UNAUTHORIZED, and so are any historical chunk launch, any real or governed L1/L2 launch, any S19 resume or rerun on a governed estate, any shadow execution, production F0, network or acquisition, SSD movement, deletion or reclamation of pre-existing data, old-estate mutation and any parser-1.2-to-1.3 compatibility bridge. C31R2 REMAINS NON-COMPLETE FORENSIC EVIDENCE: its level-2 world stopped at S19 on the blank-name primary CIK0001161343.json under parser 1.2, and its chunk-0012 artifacts, exact-deleted under group-0001's recorded lifecycle, are NOT restored. THE COMPLETE-SOURCE CANARY REMAINS UNAUTHORIZED, Decision 150's PASS verdict applies to the tree it reviewed and is not permission to run anything, census_orchestrator.py::_parse_bulk remains an open pre-network blocker, and every earlier blocker and accepted physical limitation stands as recorded below.
CANDIDATE_ORIGIN_AUTHORIZATION (NOT VALID AT EXECUTION): M3_3_D151_R21_R2C_PARSER13_FAILFAST_ENGINEERING_V3_AUTHORIZED — issued outside this repository and USED ONCE AFTER THE OWNER HAD ALREADY SUPERSEDED IT. It is recorded here as the candidate's origin evidence, NOT as a live authority and NOT as owner ratification. ITS TEXT PURPORTED TO AUTHORIZE: Phase A (one AGENTS.md-only local governance commit, MADE) and Phase B (the specified parser/provenance/durability/admission correction, its focused tests and synthetic fixtures, the local preparation of Decision 151 and its navigation surfaces — this ledger, the registry, the decision index and the change-impact map — validated and left UNCOMMITTED, MADE). It authorized NO Phase-B commit, NO push, NO tag, NO branch or history change, NO H2, NO historical or governed execution, NO S19 rerun, NO shadow execution, NO production F0, NO network, NO SSD movement, NO reclamation, NO old-estate mutation and NO compatibility bridge. No owner-acceptance token and no further engineering token was minted. Every prior V1/V2 engineering token is SUPERSEDED and was NOT consumed, and V4 is SUPERSEDED_UNCONSUMED. CORRECTION_AUTHORIZATION (VALID, PROSPECTIVE, NOW CONSUMED): M3_3_D151_R21_R2C_PARSER13_FAILFAST_PROSPECTIVE_CORRECTION_V5_AUTHORIZED — the owner instrument adopting the Codex-hardened bounded-correction packet (SHA-256 ab7dcd3632a3dbb53ed8faafe3fa3c346dc7b5e60c58fe20bc155d5fc7bc2b33, 34,673 bytes), executed by Claude Opus 5. IT AUTHORIZED EXACTLY the bounded C1–C5 correction of the preserved WIP within an eight-path write allowlist and its bounded validation, left UNCOMMITTED AND UNSTAGED. It authorized NO Phase-B commit, NO owner implementation acceptance, NO committed publication, NO full-gate closure, NO H2, NO historical execution, NO S19, NO shadow, NO production, NO storage reclamation, NO SSD movement, NO network or acquisition, NO push and NO tag. WAL_PRESERVATION_CORRECTION_AUTHORIZATION (VALID, PROSPECTIVE, NOW CONSUMED): M3_3_D151_R21_V5_WAL_PRESERVATION_PRODUCTION_CORRECTION_CI_R2_AUTHORIZED — a LATER and SEPARATE instrument, not V5 and not V5's correction item C2, executed by Claude Opus 5 after the owner/operator explicitly substituted Opus for the Fable the packet named. IT AUTHORIZED EXACTLY one production path (chunk_multipass.py::_WalPreservationGuard) and the exact-tree CI validation that followed, and NOTHING else. INDEPENDENT_CORRECTION_REVIEW_AUTHORIZATION (VALID, READ-ONLY, NOW CONSUMED): M3_3_D151_R21_V5_WAL_C2_POST_CI_OPUS_R3_READONLY_AUTHORIZED — the fresh Claude Opus 5 Maximum review session ("R3"), COMPLETED, verdict POST_CI_C2_CANDIDATE_TECHNICALLY_ACCEPTABLE_FOR_OWNER_ADJUDICATION at zero BLOCKER and zero MAJOR; the governing owner accepted that TECHNICAL review and its finding classification, which is NOT implementation acceptance. GOVERNANCE_DOCUMENTATION_CLOSEOUT_AUTHORIZATION (VALID, DOCUMENTATION-ONLY, NOW CONSUMED): M3_3_D151_R21_C2_GOVERNANCE_PUBLICATION_CLOSEOUT_R1_AUTHORIZED — executed by Claude Opus 5 at maximum effort under the owner's explicit in-session executor substitution ("opus is owner authorized"). IT AUTHORIZED EXACTLY a bounded update of five documentation surfaces (Decision 151, the decision registry, the decision index, this ledger and the change-impact map) and its bounded validation, left UNCOMMITTED AND UNSTAGED. It authorized NO source or test edit, NO test execution, NO CI, NO full gate, NO commit, NO push, NO tag, NO merge, NO PR modification, NO storage action and NO owner acceptance of anything. FINAL_LOCAL_FULL_GATE_AUTHORIZATION (VALID, NOW CONSUMED): M3_3_D151_R21_FINAL_LOCAL_FULL_GATE_R1_AUTHORIZED — one make check-fast over the accepted candidate tree, executed and PASSED, and its result ACCEPTED by the owner under M3_3_D151_R21_FINAL_LOCAL_FULL_GATE_R1_ACCEPTED. FINAL_PUBLICATION_AUTHORIZATION (VALID, DOCUMENTATION-ONLY, NOW CONSUMED AND EXHAUSTED): M3_3_D151_R21_FINAL_PUBLICATION_SINGLE_GOVERNED_COMMIT_R1_AUTHORIZED, executed by Claude Opus 5 at maximum effort under the owner's explicit approval of that executor. IT AUTHORIZED EXACTLY the five-file publication-state delta, its bounded scanner validation, staging of the 27-path accepted candidate and ONE governed local commit whose sole parent is 80c84c81…. It authorized NO source or test edit, NO test execution, NO CI, NO further gate, NO second or amended commit, NO push, NO merge, NO rebase, NO main update, NO PR modification, NO tag, NO release, NO storage action and NO successor token.
NEXT_AUTHORIZED_ACTION: STOP. HAND THE GOVERNED LOCAL PUBLICATION COMMIT — THE OWNER-ACCEPTED IMPLEMENTATION BYTES PLUS THE FIVE-FILE PUBLICATION-STATE DELTA — TO THE OWNER, AND AWAIT SEPARATELY AUTHORIZED FUTURE WORK. NOTHING FOLLOWS AUTOMATICALLY FROM ACCEPTANCE OR FROM THAT COMMIT. DO NOT MAKE ANOTHER COMMIT OR AMEND THIS ONE: THE PUBLICATION AUTHORITY IS EXHAUSTED BY THE SINGLE COMMIT IT AUTHORIZED. DO NOT RUN ANOTHER GATE OR TEST SUITE: THE FINAL GATE IS CLOSED AND NO LIVE INSTRUMENT AUTHORIZES A NEW ONE. THE FRESH INDEPENDENT CORRECTION REVIEW IS DONE AND MUST NOT BE REPEATED OR SELF-PERFORMED. DO NOT PUSH, MERGE, REBASE, CHERRY-PICK, UPDATE MAIN, RECONCILE PUBLIC MAIN, RE-RUN CI, MODIFY PR #1, DELETE THE TEMPORARY CI REFS, TAG OR RELEASE. DO NOT SELF-REVIEW OR SELF-ACCEPT. DO NOT BEGIN H2. DO NOT LAUNCH ANY CHUNK, L1, L2, SHADOW OR PRODUCTION RUN. DO NOT RESUME OR RERUN S19 ON A GOVERNED ESTATE. DO NOT ENABLE NETWORK. DO NOT PERFORM SEC ACQUISITION. DO NOT MOVE, DELETE OR RECLAIM ANY PRE-EXISTING DATA OR EVIDENCE. DO NOT START THE CANARY OR MINT A CANARY AUTHORITY.



> **CONTROLLING CURRENT POSITION, 2026-09-08, EXTENDED 2026-09-09 (LATEST) — published
> [Decision 151](../Docs/Decisions/decision_151_m3_3_r2c_parser_1_3_and_failfast_d.md),
> **R2-C PARSER 1.3, THE REGISTRANT CURRENT-NAME DEFECT, AND FAILFAST-D** — **owner-accepted** and
> published by one governed local commit: preserved WIP, prospectively corrected (V5), then
> WAL-preservation corrected, then validated by normal CI on its exact tree, then independently
> re-reviewed (R3) with that **technical** review owner-accepted, then carrying a governance
> documentation closeout the owner has since accepted, and finally closed by an owner-accepted final
> local full gate.
> **Candidate origin**:
> `M3_3_D151_R21_R2C_PARSER13_FAILFAST_ENGINEERING_V3_AUTHORIZED`, a token the owner had **already
> superseded** before that execution — historical fact, **not** authority; **the owner does NOT
> retroactively ratify V3** and the candidate carries **no owner implementation acceptance**. Every
> V1/V2 engineering token is superseded and NOT consumed; **V4 is `SUPERSEDED_UNCONSUMED`**; no
> owner-acceptance token has been minted. **Correction authority**:
> `M3_3_D151_R21_R2C_PARSER13_FAILFAST_PROSPECTIVE_CORRECTION_V5_AUTHORIZED` — bounded, prospective,
> now consumed. **Three later authorities, each separate and each now consumed**:
> `M3_3_D151_R21_V5_WAL_PRESERVATION_PRODUCTION_CORRECTION_CI_R2_AUTHORIZED` (one production path plus
> the exact-tree CI — **not** V5, and **not** V5's own correction item `C2`),
> `M3_3_D151_R21_V5_WAL_C2_POST_CI_OPUS_R3_READONLY_AUTHORIZED` (the completed read-only R3 review) and
> `M3_3_D151_R21_C2_GOVERNANCE_PUBLICATION_CLOSEOUT_R1_AUTHORIZED` (the five-surface documentation
> closeout). None of *them* accepted the implementation or closed a gate. **Two further instruments
> then did**, and both are consumed: `M3_3_D151_R21_FINAL_LOCAL_FULL_GATE_R1_AUTHORIZED`, whose
> `make check-fast` over the accepted tree passed and which the owner accepted as
> `M3_3_D151_R21_FINAL_LOCAL_FULL_GATE_R1_ACCEPTED`, and
> `M3_3_D151_R21_FINAL_PUBLICATION_SINGLE_GOVERNED_COMMIT_R1_AUTHORIZED`, bounded to the one governed
> local commit that carries this publication state and **exhausted by it**.
> **`FINAL_FULL_GATE = CLOSED`. `OWNER_IMPLEMENTATION_ACCEPTED = YES`. `GOVERNANCE_CLOSEOUT =
> OWNER_ACCEPTED`. `CANARY_AUTHORIZED = NO`, unchanged — acceptance advances no scientific stage.**
>
> **Read this first: this block now carries the current position, and every block below it does not.**
> The Decision 150 block that follows carried the `(LATEST)` marker until this record. **Decisions 135
> through 150 state their position as at their own dates and are otherwise left byte-unchanged.**
>
> **WHAT THIS RECORD IS.** The owner's frozen rulings R1–R6 on the blank-name primary
> `CIK0001161343.json` that stopped the historical C31R2 level-2 world at S19, and the bounded
> engineering that implements them: parser `submissions-json/1.3`, one new reason code, and the
> FailFast-D boundaries. **Decision 151 is the record; `D151-…` is the engineering campaign label** — the
> registry carries the disambiguation. The candidate was produced by Claude Fable 5.1 at maximum
> effort, one session, under the already-superseded V3; the bounded V5 correction of its five
> accepted review findings was executed by Claude Opus 5 at maximum effort, one session, no
> subagents, under the owner's explicit in-session executor substitution. **The same substitution was
> made again, explicitly, for each later step**: the WAL-preservation production correction, and this
> governance documentation closeout, were both executed by Claude Opus 5 at maximum effort where the
> packet named Fable, and the R3 review was a fresh Claude Opus 5 Maximum session. Each substitution
> is recorded as a deviation rather than concealed.
>
> ```text
> PHASE_A_COMMIT        80c84c81489785c1ed4f78777af5b69dfa924aed  (AGENTS.md pointer only; parent 9f71f794…)
>                       PROSPECTIVELY ADOPTED as the baseline; adopting it ratifies no Phase-B execution
> PHASE_B_BASELINE      HEAD 80c84c81… / TREE 8286a60dee66975a2e9f7aa3f1ebb78814f2a2c2 — clean entry
> PHASE_B_EXIT          UNCOMMITTED AND UNSTAGED — zero implementation commits
> V5_CORRECTION_EXIT    UNCOMMITTED AND UNSTAGED — zero commits; C1–C5 over eight allowlisted paths
> WAL_C2_CORRECTION     one production path — chunk_multipass.py::_WalPreservationGuard
>                       b7f63ec676e9053917eba16b6ade26260707dd663d3b1a019bab9adf66ebd25c
>                    -> f33b67ab8634440ab5449a2bfe41656f0f3dabe5e03018376211d891f89714a6
>                       SELECT 1 -> SELECT COUNT(*) FROM main.sqlite_schema; fails closed
>                       tests NONE  R36 NONE  storage floor NONE  migration NONE  bridge NONE
> C2_NORMAL_CI_TREE     59e52bb2aedcfcf94cd3282c5ad7e017ccf1d4ca
> C2_NORMAL_CI_RESULT   GREEN — run 34309408051 attempt 1 ONLY; 6298 passed, 7 skipped; both jobs
> LIVE_MAIN_NORMAL_CI   NOT_GREEN — main red independently (run 34075716227: d08 -> R36 cascade)
> PROVISIONAL_CI_COMMIT 3178abe09ee2eb3cb6c468e3cc38ef2b7c7a132f — evidence only; PR #1 (draft)
> GOVERNED_CHECKOUT_IMPLEMENTATION_COMMITS  measured by the governed-publication boundary of §7d
> R3_REVIEW             COMPLETED — technically acceptable for owner adjudication; 0 BLOCKER 0 MAJOR
> R3_TECHNICAL_REVIEW_OWNER_ACCEPTED  YES — review acceptance is NOT implementation acceptance
> R3_REVIEW_MINOR_1     DEFERRED_NONBLOCKING — family-glob coverage; NOT repaired
> R3_REVIEW_MINOR_2     CLOSED — the closeout that closed it is owner-accepted
> DOC_CLOSEOUT          five documentation surfaces; zero source/test bytes; OWNER_ACCEPTED
> DOC_CLOSEOUT_NORMAL_CI  NOT_RUN — the documentation tree was neither CI-tested nor R3-reviewed
> FINAL_LOCAL_GATE      PASS over tree ef0e9e24f39e141191148ec5b282f36003ee343e — one check-fast,
>                       7 worksteal workers, all eleven gates PASS; 6305 collected, 6304 passed,
>                       1 skipped; pre-launch free 95101231104 B, minimum observed 74131054592 B
> FINAL_FULL_GATE       CLOSED — M3_3_D151_R21_FINAL_LOCAL_FULL_GATE_R1_ACCEPTED
> OWNER_IMPLEMENTATION_ACCEPTED  YES — M3_3_D151_R21_IMPLEMENTATION_ACCEPTED
> PUBLICATION_AUTHORITY M3_3_D151_R21_FINAL_PUBLICATION_SINGLE_GOVERNED_COMMIT_R1_AUTHORIZED —
>                       bounded to ONE governed local commit, sole parent 80c84c81…, and exhausted
> PARSER_VERSION        submissions-json/1.2 -> 1.3   NEW_CODE  PARSER_REGISTRANT_NAME_DEFICIENT (non-blocking, review)
> INTERMEDIATE_RECEIPT  /1 -> /2 (observed semantics; /1 forensic-only)   MIGRATION  none (0015; 0016 absent)
> §25_DEVIATION         none (R4) — audit fields in Decision 151 §4; protocol text unchanged
> ```
>
> **WHAT WAS BUILT.** A valid-CIK document whose current name is absent, null, non-string or blank is a
> field-level NON-blocking company-name defect: registrant by CIK, no `company_name` observation, one
> quarantine at `record_path="name"`, the class in its detail, `formerNames` never substituted, the nested
> regions read from their own values; an unusable CIK stays blocking. MAJOR-1 declaration consistency is
> closed within the extractor's cheap predicates, with the one residual (a malformed top-level array)
> named and contained by the undeclared-shard refusal. FailFast-D: a chunk's manifest-bound run row is
> the semantic evidence and `status="complete"` is not; a blocking or unverifiable chunk is refused
> before any world at all three merge-admission paths, in the worker; the intermediate receipt is `/2`
> with observed semantics and prospective retention at the deletion function; the level-2 engine refuses
> every stage after a blocking committed S2 — fresh, resumed, after a crash — through the accepted
> `require_f0_success`, publishing a create-once semantic-refusal record; the committed S2 witness is
> re-derived from its row on every resume. S19 is unchanged.
>
> **WHAT ACCEPTANCE DOES NOT DO.** It advances no scientific stage and authorizes nothing operational: no H2
> (the R6 recompute needs its own owner instrument), no historical or governed launch, no S19 rerun, no
> shadow execution, no production F0, no network, no SSD movement, no reclamation, no old-estate
> mutation, no migration, no 1.2-to-1.3 bridge, no further commit, no push, no merge, no rebase and no
> tag. `V3_OWNER_ACCEPTED = NO` and `V3_RETROACTIVE_RATIFICATION = NO` are unchanged: the acceptance is
> a later, separate, prospective instrument and legitimizes nothing about the superseded V3 execution.
> C31R2 remains non-complete forensic evidence and its deleted chunk-0012 artifacts are not restored;
> the storage dispositions are recorded from the owner's rulings, not re-established by any storage
> access in this pass. Public-`main` reconciliation and CI status are **not evaluated** here — the
> recorded `main` failure at run `34075716227` stands as recorded. **The next action is STOP: hand the
> governed local publication commit to the owner and await separately authorized future work.** The
> fresh independent correction review is **done** and must not be repeated or self-performed; no
> further commit or gate is authorized, CI must not be re-run, PR #1 must not be modified, and the
> temporary CI refs must not be deleted.

> **CONTROLLING CURRENT POSITION, 2026-08-24 (LATEST) — published
> [Decision 150](../Docs/Decisions/decision_150_m3_3_final_fable_precanary_review.md),
> the **FINAL FABLE PRE-CANARY INDEPENDENT WHOLE-SYSTEM REVIEW**. Authorization
> `M3_3_D150_FINAL_FABLE_PRECANARY_INDEPENDENT_REVIEW_AUTHORIZED` with accepted predecessor
> `M3_3_D149_FINAL_PRECANARY_LIMITATION_CLEANUP_OWNER_ACCEPTED` (both issued outside this repository and
> spent by this publication), success token
> `M3_3_D150_FINAL_FABLE_PRECANARY_REVIEW_PASS_READY_FOR_OWNER`.
> **`CANARY_AUTHORIZED = NO`, unchanged.**
>
> **Read this first: this block now carries the current position, and every block below it does not.**
> The Decision 149 block that follows carried the `(LATEST)` marker until this record. **Decisions 135
> through 149 state their position as at their own dates and are otherwise left byte-unchanged** — Decision
> 143's `FAIL` verdict still stands, and so does Decision 146's.
>
> **WHAT THIS RECORD IS.** The final independent whole-system pre-canary review that
> [Decision 149](../Docs/Decisions/decision_149_m3_3_final_precanary_limitation_cleanup.md) called for,
> performed from a fresh `/clear` context by a **Claude Fable 5** session at maximum effort that wrote none
> of Decisions 145 through 149 and inherited none of their conclusions.
>
> ```text
...
> FALSIFICATION  19 load-bearing mutations, 19 KILLED, restored byte-identical
> ```
>
> **THE VERDICT APPLIES TO THE TECHNICAL TREE, NOT TO THIS DOCUMENTATION-ONLY COMMIT.** The implementation
> diff `git diff 28a0ad92406077f8e4cf55ad2261d5db96c2c308 HEAD -- src tests scripts configs` was EMPTY
> before publication and remains empty after it.
>
> **WHAT WAS PROVED.** The only governed real-canary contract is `phase-f0 -> phase-f1 -> phase-f2`, one
> process each; `--mode run` is refused by production on every externally governed root, AST-pinned above
> the whole-run call, and the refusal is proved NARROW. `PHASE_BOUNDARY_RAM_RECLAMATION = IMPLEMENTED`,
> proved in three real OS processes with distinct pids and each predecessor proved gone. Repository identity
> is a measurement reproduced live as `28a0ad92…` / `a5fd9cae…`, with dirty/deleted/renamed/untracked
> fail-closed. The selected dock topology is physically present and classified live as
> `USB_VIA_THUNDERBOLT_DOCK`, the exact volume UUID matched, on AC power with the lid open. The real frozen
> artifacts were verified — the source at `1,556,847,020` B / `c85744be…` / `985,834` members / `5,337`
> shards / structural digest `e58b9100…` / sound parent map, and the operational catalog UNCHANGED and
> read-only at `57e36a78…` / `359,378,944` B / logical `5c823d21…` / observation `b1122bb9…`. The D130
> archive is intact and isolated (tar stat-only). Network isolation holds and `_parse_bulk` is
> canary-unreachable. The 185/60/55/50 and 20/10 GiB gates are exact and F2 rollback is proved.
>
> **WHAT IT DOES NOT DO.** It accepts no record and authorizes no canary. All three activation constants
> remain `None`, both network switches remain `false`, migration head stays `0015` with `0016` absent, and
> a passing preflight still prints `canary_authorized: false`. `GOVERNED_PAUSE_RESUME` and `SAFE_TO_EJECT`
> remain `NOT_IMPLEMENTED`. **The next action is D150 owner acceptance and the separate controlled
> complete-source canary authorization decision by GPT-5.6 Sol.**

> **CONTROLLING CURRENT POSITION, 2026-08-24 (LATEST) — published
> [Decision 149](../Docs/Decisions/decision_149_m3_3_final_precanary_limitation_cleanup.md),
> the **FINAL PRE-CANARY LIMITATION CLEANUP**. Authorization
> `M3_3_D149_FINAL_PRE_CANARY_LIMITATION_CLEANUP_AUTHORIZED` with accepted predecessor
> `M3_3_D148_FINAL_INDEPENDENT_REREVIEW_OWNER_ACCEPTED` (both issued outside this repository and
> spent by this publication), completion token
> `M3_3_D149_FINAL_PRECANARY_LIMITATION_CLEANUP_COMPLETE_READY_FOR_FINAL_FABLE_REVIEW`.
> **`CANARY_AUTHORIZED = NO`, unchanged.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The Decision 148 block that follows carried the `(LATEST)` marker until this record.
> **Decisions 135 through 148 state their position as at their own dates and are otherwise left
> byte-unchanged**, as every superseded block in this file is — **Decision 143's `FAIL` verdict
> still stands, and so does Decision 146's.**
>
> **WHAT THIS RECORD IS.** The bounded cleanup of the three actionable items
> [Decision 148](../Docs/Decisions/decision_148_m3_3_final_independent_d147_rereview.md) recorded
> and deliberately left unrepaired, performed after the owner accepted D148 as a
> `PASS WITH NONBLOCKING LIMITATIONS`.
>
> ```text
...
> CLOSED       D148-MINOR-1, D148-L3, D148-L2
> ACCEPTED     D148-L1 — threat-model limitation, not actionable for canary acceptance
> DEFERRED     _parse_bulk — pre-network blocker, canary-unreachable, unrepaired
> ```
>
> **IT IS SMALL ON PURPOSE.** Two production edits, one new test module, and the runbook section
> the second edit made untrue. **No accepted test was changed, deleted or skipped** — and that is a
> **measured** fact rather than an intention: the blast radius of the only behavioural change was
> measured before the change was designed, and the alternative that would have broken ten accepted
> capacity-sequencing tests was rejected for that reason.
>
> **`D149-R1` CLOSES `D148-MINOR-1`.** The `_git` docstring claimed that resolving the executable
> to an absolute path made `PATH` order irrelevant. `shutil.which` **selects by `PATH` order**, so
> it now states the property that is true — the resolved executable is what runs, with no second
> exec-time lookup — and names **host trust** as the boundary rather than implying the module
> removes it. **No production behaviour changed**, re-derived from the module's own AST, and a
> documentation scan over every file in `src/` plus the operator runbook fails if the false claim
> reappears in any wording. The decision records are deliberately outside that scan: Decision 148
> **recorded** the claim as a finding and Decision 149 quotes it while correcting it.
>
> **`D149-R2` CLOSES `D148-L3`.** The four deleted and renamed tracked-path states are covered
> directly against **real** Git — deleted in the worktree; staged for deletion, with `HEAD^{tree}`
> asserted **not** to have moved; renamed with `git mv`, reporting the **new** path because that is
> the file now on disk; and an unstaged worktree rename, refused **twice over**. Each is driven
> through `require_clean_running_repository` to prove it **fails closed** rather than merely
> reports, with a clean-repository positive control. Behaviour was already correct; only the
> evidence was missing, and repository identity is **not** redesigned.
>
> **`D149-R3` CLOSES `D148-L2`.** `--mode run` is now **refused by production** on any working root
> the external envelope governs — one refusal, at the operator surface, taken immediately after the
> envelope is established and **before** the run is entered. **Keyed on the envelope**, because
> D138-R1 already makes the resolved root the single thing that decides whether a run is governed
> and external, and a second externality rule would be a second source of truth for one question.
> **On an internal root `--mode run` is untouched** and remains the accepted Decision 116 path —
> the bounded library and development exercise the authorization expressly permits keeping, which
> cannot be mistaken for the governed route because the governed route is external by construction.
> **Six direct proofs**: the fully qualified external launch refuses and creates no world;
> `phase-f0`, `phase-f1` and `phase-f2` each reach **admission** on that same qualified
> configuration; `cli.py` reaches the canary through exactly one function and the whole-run entry
> point has exactly one caller, with an **AST tripwire pinning the guard above the call**; and no
> authority is created. **The `D149-R3` stop condition was not reached** — no architecture redesign
> was required. The runbook §28e was corrected because production made its command untrue, which is
> the correct order of those two things.
>
> **`D149-R4` KEEPS `D148-L1` ACCEPTED**, cited as
> `D149-R4_ACCEPTED_LOCAL_CHECKOUT_WRITE_THREAT_MODEL_LIMITATION`: it needs write capability inside
> the checkout, the accepted threat model excludes such an actor, and an actor at that level can
> attack equivalent surfaces — `PATH` and tool selection among them, as `D149-R1` now says plainly.
> This record verifies only that it does **not** broaden that model or make the condition easier to
> reach, and it does neither.
>
> **FALSIFICATION 7 MUTATIONS, 7 KILLED**, every file restored byte-identical by SHA-256. `M5` —
> dropping the `mode == "run"` condition so the guard catches every mode — matters as much as `M4`:
> it is what proves the refusal is **narrow** rather than merely present, and it is killed by nine
> tests including all three phase-mode positive controls.
>
> **THREE PHASES, TWO QUALIFIED BOUNDARIES, `PHASE_BOUNDARY_RAM_RECLAMATION = IMPLEMENTED`,
> REPOSITORY IDENTITY, DOCK-ONLY NARROWING AT FOUR SEAMS, THE CHECKPOINT CONTRACT AND `_parse_bulk`
> UNREACHABILITY ARE ALL UNCHANGED.** `GOVERNED_PAUSE_RESUME` and `SAFE_TO_EJECT` remain
> `NOT_IMPLEMENTED`; migration head remains `0015` with `0016` absent; all three activation
> constants remain `None`; both network switches remain `false`. **The accepted physical
> limitations are untouched and were not "fixed".**


> **CONTROLLING CURRENT POSITION, 2026-08-24 (LATEST) — published
> [Decision 148](../Docs/Decisions/decision_148_m3_3_final_independent_d147_rereview.md),
> the **FINAL INDEPENDENT D146/D147 CORRECTION AND RAM-RESTART RE-REVIEW**. Authorization
> `M3_3_D148_FINAL_INDEPENDENT_D147_REREVIEW_AUTHORIZED` with accepted corrective predecessor
> `M3_3_D147_OWNER_ACCEPTED_FOR_D148_FINAL_INDEPENDENT_REREVIEW` (both issued outside this
> repository and spent by this publication), completion token
> `M3_3_D148_FINAL_INDEPENDENT_PRECANARY_REREVIEW_COMPLETE_READY_FOR_OWNER`.
> **`CANARY_AUTHORIZED = NO`, unchanged.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The Decision 147 block that follows carried the `(LATEST)` marker until this record.
> **Decisions 135 through 147 state their position as at their own dates and are otherwise left
> byte-unchanged**, as every superseded block in this file is — **Decision 143's `FAIL` verdict
> still stands, and so does Decision 146's.**
>
> **WHAT THIS RECORD IS.** The independent re-review of
> [Decision 147](../Docs/Decisions/decision_147_m3_3_d146_finding_correction.md), performed from a
> fresh context by a session that wrote none of Decisions 145, 146 or 147 and inherited none of
> their conclusions. Every property was reconstructed from the published repository.
>
> ```text
> REVIEWED_HEAD  ad3bb14d128da5eaf6c0fed9f234fcadf2d7a4fe
> REVIEWED_TREE  2f4b98f729cd108e7c6b6777d15877ab307c29f7
> ENTRY_CI       32691646553 — SUCCESS, both mandatory jobs
...
> ```
>
> **THE VERDICT APPLIES TO THAT TREE**, not to the documentation-only commit that publishes this
> record. Nothing under `src/`, `tests/`, `scripts/`, `configs/` or `migrations/` differs between
> the two.
>
> **`D146-MAJOR-1` IS CLOSED, AND THE MECHANISM IS A MEASUREMENT RATHER THAN A DECLARATION.** The
> identity is derived from the executing module's own location and never the working directory; it
> records **both** the git `HEAD` commit and the git `HEAD` tree, because an amend moves one and not
> the other; and it was **reproduced live by this review** — the production derivation, run against
> the reviewed checkout, returns `ad3bb14d…` / `2f4b98f7…`, matching `git rev-parse` invoked
> independently. The repository is **authenticated** by requiring the governing modules to be
> tracked files of it, which closes the enclosure case **and** the in-repository virtual-environment
> case together. The complete set of git subcommands was **re-derived from the module's own AST** to
> be exactly `rev-parse`, `status` and `ls-files`: **no mutating operation appears and none is
> required.**
>
> **THE SUCCESSOR RECOMPUTES, AND THERE IS EXACTLY ONE DERIVATION POINT** — unconditional, ahead of
> every phase branch, shared by all three phases — so the recurrence defect *helper correct, helper
> tested, production never calls it* is **absent**. The fresh measurement is the **observed** value
> and the predecessor's checkpoint supplies the **expected** one. **F1 is proved in a real second OS
> process**: F0 at commit A from a real published checkout, a governing tracked file committed as B,
> and F1 refusing in its own process naming both SHAs while leaving F0's checkpoint untouched.
> **F2 is proved on the same production path** and killed independently by mutation at **both**
> identity halves.
>
> **THE DIRTY-TREE CONTRACT IS FAIL-CLOSED ACROSS ALL SEVEN WORKING-TREE STATES** — modified,
> staged, deleted in the worktree, deleted staged, renamed staged (reported as the **new** path),
> renamed unstaged (refused twice over) and untracked non-ignored all refuse; ignored and clean
> admit. **The deleted and renamed cases are untested by Decision 147** and were verified against
> real repositories by this review.
>
> **THE EXECUTION IDENTITY WAS ENUMERATED FROM SOURCE**: seventeen inputs, six execution-governing
> capacity values, with `PHASE_MINIMUM_FREE_BYTES` correctly excluded as a derived duplicate and
> `WORKING_CATALOG_CACHE_BYTES` on Decision 119's proof. **Documentation and implementation agree.**
> **`D126-R6` IS INTACT**: 50 GiB unchanged, the dispositive gate still the statement immediately
> before `_f2` inside F2's own `write_containment`, Decision 126 byte-unchanged since its own
> publication commit, and its four §7 rationale reasons split faithfully — 1 and 2 historical, 3 and
> 4 binding.
>
> **THREE PHASES, TWO QUALIFIED BOUNDARIES, RAM RECLAMATION, EXACTLY-ONCE, DOCK-ONLY NARROWING AT
> FOUR SEAMS AND `_parse_bulk` UNREACHABILITY ARE ALL PRESERVED**, the last re-traced three ways.
> **All seven Decision 146 observations were re-judged and none reclassified**, including agreement
> that `OBS-7`'s correction was rightly refused on evidence. **Falsification: 7 load-bearing
> mutations, 7 killed**, every file restored byte-identical by SHA-256. **Validation: `make
> check-fast` exit 0, 5290 passed, 1 skipped.**
>
> **ONE MINOR AND THREE LIMITATIONS ARE RECORDED AND DELIBERATELY NOT REPAIRED.** `D148-MINOR-1` —
> a `_git` docstring sentence claims *"`PATH` order decides nothing"* where `shutil.which` selects
> by `PATH` order; the overstatement is confined to that internal docstring and is absent from the
> record, the runbook and this file. `D148-L1` — an `UNCHECKED_HASH` byte-code file under an ignored
> `__pycache__` executes unvalidated without moving the identity, **with the ordinary stale-cache
> case proved closed and the threat model deliberately not broadened**. `D148-L2` — the clean-tree
> contract gates the phase path only. `D148-L3` — the two untested tracked-path states.
>
> **A REVIEW RECORDS; IT DOES NOT REPAIR.** No file under `src/`, `tests/`, `scripts/`, `configs/`
> or `migrations/` is changed by this record, and the runbook is not corrected by it.
> **IT ACCEPTS NOTHING**, and **a `PASS` on a mechanism re-review is not permission to run
> anything.** `GOVERNED_PAUSE_RESUME` and `SAFE_TO_EJECT` both remain `NOT_IMPLEMENTED`; migration
> head remains `0015` with `0016` absent; all three activation constants remain `None`; both network
> switches remain `false`.

> **CONTROLLING CURRENT POSITION, 2026-08-24 (LATEST) — published
> [Decision 147](../Docs/Decisions/decision_147_m3_3_d146_finding_correction.md),
> the **DECISION 146 CODE-CONTINUITY AND PRE-CANARY FINDING CORRECTION**. Authorization
> `M3_3_D147_D146_FINDING_CORRECTION_AUTHORIZED` with owner adjudication
> `M3_3_D146_OWNER_ADJUDICATED_D147_CORRECTION_AUTHORIZED` (both issued outside this repository
> and spent by this publication), completion token
> `M3_3_D147_D146_FINDING_CORRECTION_COMPLETE_READY_FOR_OWNER`.
> **`CANARY_AUTHORIZED = NO`, unchanged.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The Decision 146 block that follows carried the `(LATEST)` marker until this record.
> **Decisions 135 through 146 state their position as at their own dates and are otherwise left
> byte-unchanged**, as every superseded block in this file is — **Decision 143's `FAIL` verdict
> still stands, and so does Decision 146's.**
>
> **WHAT THIS RECORD IS.** The correction of every finding
> [Decision 146](../Docs/Decisions/decision_146_m3_3_final_independent_post_d145_precanary_review.md)
> recorded against the frozen Decision 145 tree, performed under the owner's adjudication of those
> findings, by a session that wrote neither record.
>
> ```text
> ENTRY_HEAD   bf3acfe8080d94f5b4f41ccf231a2593da3f4309
> ENTRY_TREE   12ef771c66d1a40889040b5a4a29dedf6133832b
> ENTRY_CI     32686414965 — SUCCESS, both mandatory jobs
> CONSUMED     0 BLOCKER / 1 MAJOR / 2 MINOR / 7 OBSERVATION
> CLOSED       1 MAJOR / 2 MINOR — none omitted, none deferred, none narrowed away
> DISPOSED     7 of 7 observations
> ```
>
> **THE OWNER SUSTAINED `D146-MAJOR-1` AND CHOSE THE HARDER REMEDY.** Decision 146 offered two:
> bind a genuine semantic code identity, or narrow Decision 145 §12's claim to what its digest
> actually did. The owner's instruction was *"Implement genuine mechanical repository continuity …
> Do **NOT** merely weaken Decision 145's claim."* So Decision 145 §12's sentence — that the
> mechanism prevents, **mechanically**, *"a process continuing from a revision whose governing
> semantics moved"* — **is now true of the implementation**, rather than edited until it was true
> of a weaker one.
>
> **`D147-R1` — THE REPOSITORY CODE IDENTITY.** A new module `repository_identity.py`, contract
> `m3.3-canary-repository-identity/1`, derives the **git `HEAD` commit** and the **git `HEAD`
> tree** of the repository the running source was imported from. Both, because they answer
> different questions: an amend moves the commit and leaves the tree, so a tree comparison alone
> would admit a history that moved. **Four properties make it a measurement rather than a
> declaration** — it is derived from the executing module's own location and **never** from the
> working directory; the repository Git finds is **authenticated** by requiring `canary_phases.py`
> and `single_source_canary.py` to be **tracked files** of it, so an installed copy inside an
> unrelated repository cannot yield a real identity of the wrong code; **no operator-supplied SHA
> exists on any surface** — no parameter, no CLI flag, no environment variable; and every Git
> invocation is a **read**, proved from the module's own AST to be exactly `rev-parse`, `status`
> and `ls-files`.
>
> **`D147-R2` — THE CLEAN-TREE CONTRACT, WITH THE UNTRACKED RULE STATED RATHER THAN ASSUMED.** A
> phase refuses an ambiguous working tree: **modified tracked paths**, and **untracked
> non-ignored paths**, which can sit anywhere on the import path. **Ignored paths are not
> ambiguity, deliberately** — the repository's own **tracked** `.gitignore` is what declares
> `__pycache__` irrelevant, and a contract that refused it could never admit anything. The gate
> runs **first**, before the work root, the volume, the dock, the power state or the host lock.
> **A refusal is terminal and is NOT a resumable pause**: nothing is checked out, stashed, reset,
> cleaned, fetched or repaired, and no flag makes it proceed.
>
> **`D147-R3` AND `D147-R4` — BOTH HALVES, AND A REFUSAL THAT CAN BE DIAGNOSED.**
> `phase_execution_identity()` binds the declared contract inputs **and** the repository identity —
> seventeen inputs, neither replacing the other. `PhaseCheckpoint` carries `repository_head_sha` and
> `repository_tree_sha` as **named fields**, and `require_phase_admission` compares them **before**
> the aggregate digest, so a moved revision reports *expected A, observed B* rather than an
> undiagnosable `execution_identity` mismatch. **Each phase recomputes in its own process** — no
> successor reads the predecessor's recorded identity as its own. `PHASE_RESTART_CONTRACT` moves
> `/1 -> /2`; **no real canary world exists, so no checkpoint anywhere is invalidated.**
>
> **`D146-MINOR-1` CLOSED BY INVENTORY, NOT BY EDITING A COUNT.** Six execution-governing capacity
> values are folded — `LAUNCH` 185 GiB, `PRE_F1` 55 GiB, `PRE_F2` 50 GiB, plus `POST_F0` 60 GiB (a
> post-phase invariant), `F2_ALERT` 20 GiB and `F2_HARD_FLOOR` 10 GiB. `WORKING_CATALOG_CACHE_BYTES`
> stays excluded on Decision 119's evidence-neutrality proof, and **that exclusion is itself
> tested**. **No value was invented and no accepted value changed.** A test fails if a seventh
> capacity constant is ever added unclassified.
>
> **`D146-MINOR-2` AND `D146-OBS-5` CLOSED TOGETHER.** The `PRE_F2_MINIMUM_FREE_BYTES` docstring
> now separates the two Decision 126 §7 rationale sentences Decision 145 made false — marked
> **HISTORICAL** — from the two that carry `D126-R6` — marked **CURRENT AND BINDING**.
> **Decision 126 is not rewritten**, the gate did not move, and the `50` GiB value is unchanged:
> the dispositive check still runs **in the F2 process**, inside its own `write_containment`, one
> statement before `_f2`, proved from the AST rather than from the docstring describing it.
>
> **ALL SEVEN OBSERVATIONS EXPLICITLY DISPOSED.** `OBS-1` and `OBS-2` accepted, with their
> boundaries now **asserted by tests** rather than assumed; `OBS-3` closed with a focused
> `migration_head` test and no architecture change; `OBS-4` **kept** as defensive redundancy and
> pinned; `OBS-5` closed with `MINOR-2`; `OBS-6` carried forward as a future authorization boundary
> with `--mode run` **not** removed; and **`OBS-7`'s correction refused on evidence** — an
> `argv[0]` condition in `process_is_live_canary` would make *alive* **harder** to detect and could
> admit a successor while its predecessor was still writing the working catalog, which is the
> dangerous direction. The owner's escape clause required that a correction "clearly cannot weaken
> process authentication"; it demonstrably would, so the fail-closed asymmetry stands and a test
> now pins it.
>
> **THE POSITIVE CONTROL IS REAL, WHICH IS THE POINT.** Decision 146 found the old test proved the
> property only for a version string that never moves. Nothing here rests on a fake SHA: real
> temporary Git repositories with real commits, real dirty and untracked states, and **three real
> OS processes** driven through the real operator command from a published checkout — F0 at commit
> `A`, a governing tracked file changed and committed as `B`, and **F1 refusing in its own process,
> naming both SHAs**, with F0's checkpoint intact and F1's absent.
>
> **FALSIFICATION: 10 MUTATIONS, 10 KILLED**, every mutated file restored byte-identical by
> SHA-256 with an empty `git diff` over the source tree before publication. `M2` — *the identity
> helper returns a constant* — is precisely what `disclosure_drift.__version__` was, and it is now
> killed.
>
> **WHAT IS UNCHANGED.** Three major phases `F0`, `F1`, `F2`; both inter-phase boundaries
> qualified, 2 of 2; post-`F2` `TERMINAL_PROCESS_EXIT_EXPECTED`; the old process exits and is
> proved gone before the successor begins; `PHASE_BOUNDARY_RAM_RECLAMATION = IMPLEMENTED`;
> `GOVERNED_PAUSE_RESUME` and `SAFE_TO_EJECT` `NOT_IMPLEMENTED`; **no physical-detach right is
> created**; every topology and safety invariant enforced at every phase, re-proved rather than
> assumed; and `_parse_bulk` **canary-unreachable**, re-traced through the module this record adds.
>
> **WHAT IT DOES NOT AUTHORIZE.** The canary, `--mode run` or any phase mode against a real canary
> world, E0, the pre-E0 catalog transition, stale-writer-lease recovery, SEC acquisition, either
> network switch, migration `0016`, opening D130 archive content, a physical disconnection, or a
> re-run of the D141 qualification. It mints no activation constant — all three remain `None` — and
> **confers no acceptance on Decision 145, on Decision 146, or on any earlier record**. A passing
> preflight still prints `canary_authorized: false`.

> **POSITION AS AT 2026-08-23 — superseded as the current position by the Decision 147 block above, and otherwise left byte-unchanged. Published
> [Decision 146](../Docs/Decisions/decision_146_m3_3_final_independent_post_d145_precanary_review.md),
> the **FINAL INDEPENDENT POST-D145 PRE-CANARY REVIEW**. Reviewed predecessor
> `M3_3_D145_GOVERNED_MAJOR_PHASE_RAM_RECLAMATION_COMPLETE_READY_FOR_OWNER`, authorization
> `M3_3_D146_FINAL_INDEPENDENT_POST_D145_PRECANARY_REVIEW_AUTHORIZED` (issued outside this
> repository and spent by this publication), completion token
> `M3_3_D146_FINAL_INDEPENDENT_POST_D145_PRECANARY_REVIEW_FAILED_READY_FOR_OWNER`.
> **`CANARY_AUTHORIZED = NO`, unchanged.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The Decision 145 block that follows carried the `(LATEST)` marker until this record.
> **Decisions 135 through 145 state their position as at their own dates and are otherwise left
> byte-unchanged**, as every superseded block in this file is — and **Decision 143 is still not
> rewritten**: its `FAIL` verdict stands.
>
> **WHAT THIS RECORD IS.** The independent adversarial review of
> [Decision 145](../Docs/Decisions/decision_145_m3_3_governed_major_phase_restart.md) that Decision
> 145 §26 required and that the session which wrote Decision 145 was **forbidden** to perform. It
> was done from a genuinely fresh context, with no subagents and no delegated reasoning, and
> **Decision 145's conclusions were not inherited**: the phase inventory, the boundary
> classification, the `_parse_bulk` reachability and the D140 acceptance lineage were each
...
> ```
>
> **The verdict applies to that tree, not to the documentation-only commit that publishes it.**
>
> **THE PHASE INVENTORY WAS RECONSTRUCTED, AND IT AGREES.** The whole-run driver `_materialize`
> calls exactly three phase primitives — `_f0`, `_f1`, `_f2` — so the first canary has **THREE
> MAJOR EXECUTION PHASES: `F0`, `F1`, `F2`**, named from the accepted Decision 135 §11 capacity
> vocabulary. **World creation is not a fourth phase** — it is a `mkdir` inside F0's own process
> that emits no checkpoint and admits no successor — **and the result document is not a fifth**,
> being written inside F2's own process. **Both inter-phase boundaries qualify — 2 of 2** — and
> post-`F2` is `TERMINAL_PROCESS_EXIT_EXPECTED`.
>
> **MAJOR-1 — `phase_execution_identity()` BINDS NO EXECUTABLE GOVERNING CODE.** Decision 145 §12
> claims it prevents, **mechanically**, *"a process continuing from a revision whose governing
> semantics moved"*, and labels it **code** and configuration identity. It folds ten frozen
> constants plus `disclosure_drift.__version__` — the literal `"0.1.0"`, touched by **exactly one
> commit in the entire history**, `fa16668`, the Milestone 1 foundation. **This was proved by
> mutation rather than argued.** With the accepted `POST_F0` capacity floor relaxed `60 -> 1` GiB
> **and** the admission-side predecessor-status guard deleted outright, the digest is
> **bit-identical**:
>
> ```text
...
> ```
>
> An exhaustive search of `src/` finds **no git SHA, no source digest and no build identity**
> anywhere, so no other accepted mechanism closes the gap. The test named
> `test_a_successor_refuses_a_changed_code_revision` establishes the property only for a version
> string that never moves — a correct positive control for a mechanism that is inert in practice.
> **The digest is sound for the constants it binds; the claim drawn from it is not.** The realistic
> exposure is bounded — one operator, one machine, one governed checkout, a window of hours — so
> this is a correctness-of-claim defect with a narrow surface, not a live corruption channel. **The
> remedy is the owner's choice** between binding a genuine semantic code identity and narrowing §12
> to what the digest actually does.
>
> **TWO MINOR FINDINGS.** §12 says the digest folds *"the **four** capacity floors"* and it folds
> **three** — `POST_F0` (60 GiB), `F2_ALERT` (20 GiB) and `F2_HARD_FLOOR` (10 GiB) are not among
> them, and the `60 -> 1` GiB relaxation above is that finding made concrete on an accepted gate.
> And the `PRE_F2_MINIMUM_FREE_BYTES` **source docstring** still states as present fact two Decision
> 126 §7 rationale sentences that Decision 145 itself made false; §24 item 5 corrected the record
> but not the source, and named one of the two.
>
> **NINE OF THE TEN REVIEW AXES ARE SUBSTANTIATED, AND THAT IS RECORDED RATHER THAN BURIED.**
>
> * **Process replacement is real.** Three genuinely separate OS processes launched through the
>   **real operator command**, and each phase's self-reported `pid` is asserted **equal to the
>   parent-observed `child.pid`**, so the proof does not rest on self-report. No `gc.collect()`, no
>   cache clearing, no same-process continuation, no large resident parent, and **no RSS percentage
>   threshold anywhere** — `ru_maxrss` is reported only as a **peak**.
> * **The checkpoint is terminal-only, create-once and written LAST**, after the working catalog's
>   context has closed, in `WAL` with `synchronous = FULL` autocommit. **The F2
>   result-before-checkpoint window is REFUSE, not resume**: `attach_world` and `create_world` both
>   refuse a world carrying its result document, so the deliverable survives and the run stays
>   interrupted. This review does **not** relabel that as resumability.
> * **The host-lock gap is `ACCEPTABLE_LIMITATION`.** Five interleavings were traced. An intruder in
>   the gap can make this run's successor **REFUSE**, but cannot silently corrupt, duplicate or
>   advance it — because the world is create-once and named by `run_id`, capacity is re-measured
>   **inside** the lock at every phase, and advancement is gated on a durable checkpoint rather than
>   on anything that merely exists.
> * **Topology survives every restart at four production seams**, and **the D144 tripwire was
>   strengthened, not loosened**: the complete diff is the constant `3 -> 4` plus a comment, with
>   the every-call-site assertion untouched and now covering four seams instead of three.
> * **D126-R6 is honoured** — the pre-F2 gate is still taken by the process that opens the
>   transaction — so **no note, correction or supersession of Decision 126 is required**, and this
>   review does not rewrite it. Two sentences of *nonbinding rationale* aged, not one.
> * **The D140 acceptance lineage is unambiguous**, reconstructed **without assuming uniqueness**:
>   exactly three D140-shaped tokens exist in the tree **and in the entire git history**, in three
>   distinct roles, with no competing acceptance candidate. D145-R0 is confirmed accurate in full.
> * **`_parse_bulk` remains canary-unreachable**, re-traced three independent ways including a live
>   fresh-interpreter import closure and a check that no dynamic import exists on the phase path.
> * **Equivalence was reproduced**: **6** variable fields — run id, two timestamps, two free-space
>   readings and the working-catalog file digest — and **55** identical, including all five accepted
>   identities. The proof **measures** its own baseline rather than hardcoding it, so it fails in
>   **both** directions.
> * **M2's honesty was re-run, not read.** Deleting the admission-side status guard **survives all
>   68 tests**, confirming Decision 145's own statement that it is unreachable by construction; the
>   write-side substitute is killed by exactly one test, matching the reported count. Declining to
>   count an unkillable mutation is honest reporting.
>
> **A REVIEW RECORDS; IT DOES NOT REPAIR.** No file under `src/`, `tests/`, `scripts/`, `configs/`
> or `migrations/` is changed. The four bounded review mutations were restored **byte-identical by
> SHA-256** with an empty `git diff`, proved **before** the record was written.
>
> **IT ACCEPTS NOTHING.** Not Decision 145, and not Decisions 137, 138, 141, 142, 143 or 144.
> Decisions 137 and 138 remain `IMPLEMENTED — PENDING INDEPENDENT REVIEW AND OWNER ACCEPTANCE`.
> Migration head remains `0015` with `0016` absent; all three activation constants remain `None`;
> both network switches remain `false`. `GOVERNED_PAUSE_RESUME` and `SAFE_TO_EJECT` both remain
> `NOT_IMPLEMENTED`.
>
> **ONE FORWARD REQUIREMENT IS RECORDED FOR THE OWNER.** The future real-canary authorization
> **MUST** authorize only `--mode phase-f0`, `phase-f1` and `phase-f2`, each in its own process with
> a clean exit between them; it **MUST** forbid `--mode run` for the authorized real canary; and any
> `--mode run` invocation against it is **OUTSIDE AUTHORITY**. `--mode run` is **not removed** by
> this record.
...
> **CONTROLLING CURRENT POSITION, 2026-08-23 (LATEST) — published
> [Decision 144](../Docs/Decisions/decision_144_m3_3_d143_finding_correction.md), the **DECISION 143
> PRE-CANARY FINDING CORRECTION**. Accepted review baseline
> `D143_FINAL_INDEPENDENT_PRECANARY_REVIEW_FAIL`, authorization
> `M3_3_D144_D143_FINDING_CORRECTION_AUTHORIZED` (issued outside this repository and spent by this
> publication), completion token `M3_3_D144_D143_FINDING_CORRECTION_COMPLETE_READY_FOR_OWNER`.
> **`CANARY_AUTHORIZED = NO`, unchanged.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The Decision 143 block that follows carried the `(LATEST)` marker until this record.
> **Decisions 137 through 143 state their position as at their own dates and are otherwise left
> byte-unchanged**, as every superseded block in this file is — and **Decision 143 is not
> rewritten**: its `FAIL` verdict stands and remains true of the tree `a41468203e69c71c9741f3e4fab2d73cf2f7aef1`
> / `8614cfc8421bbb93375066631e0616e72d074fd3` it was made against.
>
> **WHAT THIS RECORD IS.** The closure of **every** finding Decision 143 recorded — **2 MAJOR, 3
> MINOR and 2 OBSERVATION, all seven closed, none omitted and none deferred**. It is a **TRUTH
> CORRECTION, NOT AN ARCHITECTURE EXPANSION**: no new mechanism was invented. The narrowing that
> closes MAJOR-1 was built by Decision 141 and had been correct and fully tested all along; **what
> was missing was a caller.**
>
> **D144-R1 — MAJOR-1 CLOSED. THE SELECTED TOPOLOGY IS NOW MECHANICALLY ENFORCED.** Decision 142
> §4 selected `USB_VIA_THUNDERBOLT_DOCK` and §6 forbade automatic **and** operator fallback, and
> **no production caller supplied `required_transport`** — all three seams left it at its `None`
> default, which admits **either** qualified topology, so **a directly attached qualified SSD
> passed the whole envelope**, including as the answer to a dock refusal. The correction is **one
> constant and three call sites**: `FIRST_CANARY_REQUIRED_TRANSPORT: Final = TRANSPORT_DOCK` in
> `single_source_canary.py`, passed by `run_single_source_canary`,
> `run_single_source_prefix_profile` **and** `run_canary_source_command`. **ALL THREE, NOT ONE** —
> `--mode preflight` matters most, because the D142 §6 failure mode is a dock refusal answered by
> re-plugging directly, and a preflight that then went green would be that fallback with a
> receipt. **IT IS A MODULE CONSTANT AND DELIBERATELY NOT AN OPERATOR INPUT**: no CLI flag,
> configuration key or environment variable supplies, widens or disables it, and none may be
> added. **NO FALLBACK OF ANY KIND WAS INTRODUCED** — not automatic, not operator, no
> try-dock-then-direct path, no switch that disables transport enforcement.
>
> **`USB_DIRECT` IS NOT REVOKED.** D141-R8 and Decision 142 §5 stand entire: both classes remain
> qualified, an unqualified third still refuses, `require_qualified_transport` with no requirement
> still admits direct, **`require_external_envelope` STILL ADMITS DIRECT when nothing narrows it**,
> and the mechanism is **symmetric** — demanding direct refuses a dock attachment identically. What
> is narrowed is the **first-canary production envelope**, and nothing else.
>
> **D144-R2 — MAJOR-2 CLOSED.** Runbook §28f.C presented **eight** rows under *"each is checked by
> the application rather than by reading this page"* and two were not. It is now split into
> **§28f.C.1 mechanically enforced launch predicates**, each with the ruling that enforces it, and
> **§28f.C.2 operator rules the application checks none of**, led by co-tenancy. **Transport
> appears in C.1 only because D144-R1 made it true, and the section says so.** **NO NEW CO-TENANCY
> ENFORCEMENT MECHANISM WAS INVENTED** — §28f.E did not overstate; the table was the defect.
>
> **D144-R3 — MINOR-2 CLOSED.** Runbook §28d's Decision 137-era table is brought current rather
> than deleted: condition 1 (external power) becomes **automatic at launch** after D141-R9,
> conditions **13 (lid)** and **14 (transport)** are added, the count reads **eight mechanical,
> four operator, two held by the launch command**, and **conditions 1–12 keep their original
> numbers** so citations do not silently repoint. A currency banner names §28f.C as controlling.
> **"AT LAUNCH" IS STATED AS THE WHOLE OF THE GUARANTEE** for power, lid and transport.
>
> **D144-R4 — MINOR-3 CLOSED.** The decision registry's own Decision 141 row read
> `PENDING ... OWNER ACCEPTANCE` with **no acceptance token** for the whole life of Decisions 142
> and 143; it now reads `ACCEPTED — OWNER ACCEPTED FOR CONTINUATION 2026-08-23` under
> `M3_3_D141_OWNER_ACCEPTED_FOR_CONTINUATION`, citing Decision 142 §3. **DECISIONS 137, 138 AND 140
> ARE UNTOUCHED — they remain `IMPLEMENTED — PENDING INDEPENDENT REVIEW AND OWNER ACCEPTANCE`, and
> their safety predicates are enforced in the tree and are NOT weakened by any later record.**
>
> **MINOR-1 CLOSED.** The `cli.py` help for `--require-volume-uuid` now states the assertion is
> **MANDATORY on any external route** and that **OMITTING IT IS ITSELF A REFUSAL** (D140-R2) — the
> meaning Decision 142 §9 corrected in two runbook places and could not reach in `src/`. **The
> internal Decision 116 path was not weakened by accident**: the flag stays optional at the parser,
> because an internal root needs no assertion and never did.
>
> **OBSERVATION-1 — NO CODE CORRECTION; DOCUMENTATION PRECISION.** The host execution lock covers
> `--mode run` only, independently re-verified (one call site in `src/`). Its exact scope is now
> written where the operator reads it, and a concurrent `--mode profile-prefix` is listed as the
> operator rule it is. **No lock was widened and no state machine built.**
>
> **OBSERVATION-2 — NO MUTATION; VERIFIED INFORMATIONAL ONLY.** The envelope's guards apply only
> where the envelope applies, which is deliberate under D141-R10. One test was nonetheless added
> proving the D144 narrowing did **not** make the internal path pay for it, asserted **through the
> production operator command** with `ioreg` and `pmset` fatal.
>
> **PRODUCTION REACHABILITY PROVED, NEVER ASSUMED** — nine proofs through real entry points, plus
> an **AST pin** requiring every envelope call in the module to carry the narrowing, because
> MAJOR-1 was an **absent** argument at every call site at once.
>
> **FALSIFICATION: 5 MUTATIONS, ALL 5 KILLED**, reversible and source-isolated, every mutated file
> restored **byte-identical by SHA-256** after every mutation and verified again at the end. No
> broad mutation framework was run.
>
> **`CensusOrchestrator._parse_bulk` REMAINS PROVABLY CANARY-UNREACHABLE (case B)** and an open
> **PRE-NETWORK** blocker, deliberately unrepaired — **the corrections did not make it reachable.**
>
> **WHAT THIS RECORD DOES NOT DO.** It authorizes no canary, no canary-world construction, no
> execution namespace, no launch receipt, no complete-source execution, no E0, no migration `0016`
> (head remains `0015`, `0016` absent), no network activity, no SEC acquisition, no D130
> modification, no real canary `SQLITE_TMPDIR`, no pause/resume implementation, and no physical
> disconnect testing. **It accepts no predecessor record.** **CORRECTING THE FINDINGS OF A FAILED
> REVIEW IS NOT PASSING IT** — the independent rereview those corrections invite is a separate act,
> to be performed from a genuinely fresh session context and **NOT by the session that made them.**
> All three activation constants remain `None`; both tracked network switches remain `false`.
...
> architecture freeze, and the correction of one false runbook sentence. Accepted predecessor
> `M3_3_D141_OWNER_ACCEPTED_FOR_CONTINUATION`, authorization
> `M3_3_D142_PRECANARY_ARCHITECTURE_FREEZE_AND_RUNBOOK_CORRECTION_AUTHORIZED` (issued outside this
> repository and spent by this publication), completion token
> `M3_3_D142_PRECANARY_ARCHITECTURE_FREEZE_COMPLETE_READY_FOR_OWNER`.
> **`CANARY_AUTHORIZED = NO`, unchanged.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The Decision 141 block that follows carried the `(LATEST)` marker until this record; that
> marker is corrected here — **Decisions 137, 138, 139, 140 and 141 state their position as at
> their own dates and are otherwise left byte-unchanged**, as every superseded block in this file
> is.
>
> **This is a governance and documentation publication only. No file under `src/` or `tests/` was
> touched, and every guard behaves exactly as it did before.** What changed is which of two
> already-qualified configurations the owner has chosen, what the runbook says about a flag the
> code already enforces, and whether further pre-canary architecture work is planned.
>
> **D142-R1 — Decision 141 is `OWNER ACCEPTED FOR CONTINUATION`**, as a **bounded qualification
> only**. The measured and integrated transport class remains `USB_VIA_THUNDERBOLT_DOCK`. Every
> Decision 141 §12 limitation is carried forward intact; **no bounded observation is upgraded into
> a general reliability claim**, and **D141 and D140 are not rewritten**.
>
> **D142-R2 — the first-canary topology is SELECTED**, answering the question Decision 141 §16
> deliberately left to the owner: **`USB_VIA_THUNDERBOLT_DOCK`**, on Volume UUID
> `397A4D4A-9508-391E-814E-3B533C7BD049`, USB `0x090C`:`0x2320`, serial `SSKPSSD0000000000071`,
> ordered dock cascade `0x8087:0x0B40` → `0x17EF:0x30B6` → `0x17EF:0x30B8`, on **the D141-qualified
> physical dock port and profile**. **A changed BSD identifier is not a refusal.**
> **`USB_DIRECT` remains qualified and is NOT revoked — and is NOT selected.** **There is no
> automatic and no operator fallback between them**: a refusing dock preflight means **STOP and
> return to the owner**, never a switch of that same canary to direct storage.
>
> **D142-R3 — governed pause/resume is DEFERRED beyond the first canary.**
> `GOVERNED_PAUSE_RESUME = NOT_IMPLEMENTED`. There is **no `SAFE_TO_EJECT` state**, no governed
> detach, no governed reconnect, no topology switch, no storage migration, and no pause-and-move
> workflow. **`kill -STOP` is not a governed pause**, **closing the lid is not a governed pause**,
> and **qualifying the dock did not create permission to detach it**. The first canary runs under
> the existing continuous-attachment model with every existing mechanical launch predicate still
> applying. **A need to detach or reconfigure means the run is INTERRUPTED and lost, not PAUSED**,
> and **no operator procedure pretending to recover from a physical disconnection may be written**.
> Decision 140 §17 remains open owner work; **no pause/resume implementation and no new state
> machine is authorized**.
>
> **D142-R4 — the §28d runbook correction.** The D140-era claim that `--require-volume-uuid` is
> **optional** was **FALSE** under accepted Decision 140 §4 (D140-R2), and it appeared in **two**
> places, so both are corrected. **This was a documentation defect only** — the shipped code has
> enforced the mandatory rule since D140. §28d now reads: mandatory for the external-SSD canary
> envelope, **omitting it is a refusal**, and supplying it **does not disable or weaken any other
> launch guard**. **The exact UUID requirement is preserved**, it is **not** weakened into a
> mount-name check, and it is **not** made optional through any other CLI, configuration, or API
> path. **Decision 140 is not rewritten to repair a runbook sentence.**
>
> **D142-R5 — the pre-canary architecture is FROZEN**: no further pre-canary architecture change is
> planned. This is the confirmation Decision 141 §19 was waiting on. The intended next phase is one
> **FINAL INDEPENDENT PRE-CANARY REVIEW**, **not authorized by Decision 142**, to be performed
> later from a genuinely fresh session context against the exact published Decision 142 commit.
>
> **D142-R6 — no canary, no canary world, no execution namespace, no launch receipt, no
> complete-source execution, no E0, no migration `0016` (head remains `0015`, `0016` absent), no
> network activity, no SEC acquisition, no D130 modification, no real canary `SQLITE_TMPDIR`, and
> no pause/resume implementation.** Any existing `canary_authorized` value remains `false`. All
> three activation constants remain `None`; both tracked network switches remain `false`.
> **Selecting a topology is not authorizing a run on it.**

> **SUPERSEDED POSITION, 2026-08-23 — published
> [Decision 141](../Docs/Decisions/decision_141_m3_3_thunderbolt_dock_qualification.md), the
> qualification of **how** the accepted external volume is attached, and the minimal integration
> of that qualification into the pre-canary system. Entry baseline
> `M3_3_D140_CORRECTED_PUBLICATION_BASELINE_OWNER_ACCEPTED_FOR_CONTINUATION`, authorization
> `M3_3_D141_THUNDERBOLT_DOCK_QUALIFICATION_AND_INTEGRATION_AUTHORIZED` (issued outside this
> repository and now spent), completion token
> `M3_3_D141_THUNDERBOLT_DOCK_QUALIFICATION_COMPLETE_READY_FOR_OWNER`, **no acceptance token**.
> **`CANARY_AUTHORIZED = NO`, unchanged.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The Decision 140 block that follows carried the `(LATEST)` marker until this record; that
> marker is corrected here — **Decisions 137, 138, 139 and 140 state their position as at their own
> dates and are otherwise left byte-unchanged**, as every superseded block in this file is.
>
> **Decision 140 asked what the envelope does when the volume is not there. Decision 141 asked how
> the volume is attached when it *is* there, and the accepted runbook's answer was false.** §28e
> condition 3 read *"the SSD is **directly connected** — no hub"*. It is **three USB hub tiers deep
> inside a ThinkPad Thunderbolt 4 Dock**. A **second, independent finding**:
> `require_launch_power_conditions` — the D140-R20 AC-power and lid guard — was fully implemented,
> fully unit-tested, named by that same table as *"checked at launch"*, and **called by no
> production path**. The guard existed and was unreachable.
>
> **The commercial name misled twice.** It is a Thunderbolt **4** dock, not the Thunderbolt 3 the
> topology change was described as, and it negotiated **`usb_four`** mode rather than native
> Thunderbolt; its **downstream Thunderbolt receptacle is empty**, and `diskutil` reports the
> volume's own **`BusProtocol = USB`**. `DOCK_TRANSPORT_CLASS = USB_VIA_THUNDERBOLT_DOCK`.
>
> **The Volume UUID remains primary and is unweakened**, and **no BSD identifier is frozen or
> compared** — a changed `disk4` number does **not** refuse.
>
> `DOCK_LINK_FLAPS = 0`, `SSD_DETACH_EVENTS = 0`, `IO_ERRORS = 0`.
> `DOCK_POWER_AND_STORAGE_COEXIST = PASS`, measured **during** the load.
> `D140_SAFETY_ON_DOCK_PATH = PASS` — **17/17** live controls, each asserting the **reason** for
> its outcome. **D130 unchanged**: 24 entries, compact proofs identical, tar **0 opens with the
> tripwire proved armed**, free space returned **byte-identical**.
>
> Full suite **5140 passed / 1 pre-existing skipped / 0 failed**; **11 reversible mutations, all 11
> killed** — **M10 and M11 are the reachability mutations**. **No canary is authorized. E0 is not
> authorized. Migration head remains `0015`. Governed pause/resume remains NOT IMPLEMENTED —
> qualifying the dock does not create a way to detach it.**

> **SUPERSEDED POSITION, 2026-08-23 — published
> [Decision 140](../Docs/Decisions/decision_140_m3_3_total_pre_canary_hardening.md), the closure of
> every actionable finding the **accepted** D139 independent review raised: **0 blocker, 2 major,
> 7 minor, 10 informational**. Review-acceptance token
> `M3_3_D139_FABLE_REVIEW_FINDINGS_OWNER_ACCEPTED`, correction authorization
> `M3_3_D140_TOTAL_PRE_CANARY_HARDENING_AUTHORIZED` (issued outside this repository and now spent),
> completion token `M3_3_D140_TOTAL_PRE_CANARY_HARDENING_COMPLETE_READY_FOR_FABLE_REVIEW`, **no
> acceptance token**. **The prior canary authorization is superseded and withdrawn:
> `CANARY_AUTHORIZED = NO`.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The Decision 138 block that follows carried the `(LATEST)` marker until this record; that
> marker is corrected here — **Decisions 137, 138 and 139 state their position as at their own
> dates and are otherwise left byte-unchanged**, as every superseded block in this file is.
>
> **Decision 138 asked whether the envelope could be walked around. Decision 139 asked what it does
> when the volume is not there, and the answer was worse than the question.** With the SSD
> unplugged, `/Volumes/SSK SSD/world` has nearest existing ancestor `/Volumes`; with an ordinary
> **writable** directory left at the mount point, it has that directory. Both are internal storage,
> both classified **internal**, and an internal root with no assertion runs with **no guard at all**.
> **Intent is now read from the name, `--require-volume-uuid` is mandatory, the mount must exist and
> be a mount point reporting the exact UUID, the volume is re-authenticated immediately before
> `mkdir`, and `create_world` creates no parent** — so a vanished mount point can no longer be
> recreated on the internal disk and filled.
>
> **The single highest-value item is proved on the real source**: a read-only structural preflight
> now establishes the D129 shard-to-parent map **before** F0 rather than ~27 hours into a run, and it
> returned **985,834 members, 5,337 shards, 5,337 declared, 0 orphan, 0 duplicate-parent, 0
> conflicting-parent, parent map sound** in `108.432` s.
>
> **Governed pause/resume is NOT implemented** and returns
> `D140_PAUSE_RESUME_ARCHITECTURE_REQUIRES_OWNER_REDESIGN` (Decision 140 §17). **There is no
> `SAFE_TO_EJECT` state, `kill -STOP` is not a governed pause, and the SSD must not be disconnected
> while a canary runs.**
>
> Full suite **5107 passed / 1 pre-existing skipped / 0 failed**; **22 reversible mutations, all 22
> killed**. **No canary is authorized. E0 is not authorized. Migration head remains `0015`.**

> **SUPERSEDED POSITION, 2026-08-23 — published
> [Decision 138](../Docs/Decisions/decision_138_m3_3_d137_safety_envelope_correction.md), the
> bounded correction of the three majors the **accepted** D137 independent review raised.
> Review-acceptance token `M3_3_D137_INDEPENDENT_IMPLEMENTATION_REVIEW_OWNER_ACCEPTED`, correction
> authorization `M3_3_D138_D137_SAFETY_ENVELOPE_CORRECTION_AUTHORIZED` (issued outside this
> repository and now spent), classification `BOUNDED_CORRECTION_ONLY`, completion token
> `M3_3_D138_D137_SAFETY_ENVELOPE_CORRECTION_COMPLETE_READY_FOR_REVIEW`, **no acceptance token**.
> **The envelope Decision 137 built could be walked around. Now it cannot.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The Decision 137 block that follows carried the `(LATEST)` marker until this record; that
> marker is corrected here — **Decision 137's block states its position as at its own date and is
> otherwise left byte-unchanged**, as every superseded block in this file is.
>
> **Correction is not acceptance, and D137 never had any.** The accepted verdict is
> `D137_INDEPENDENT_REVIEW_CORRECTION_REQUIRED` — **zero blockers, three majors**. Decision 138
> corrects the **implementation**; **Decision 137 remains historical and is not rewritten to pretend
> the defects never existed**. Neither record carries an acceptance token, and the **D136-R8**
> exception still takes effect only after D137 implementation **and acceptance**.
>
> **MAJOR-1 — the envelope was opt-in.** `require_volume_uuid` was both the assertion *and* the
> switch, so an operator who never typed `--require-volume-uuid` reached an unqualified disk, or the
> immutable D130 archive itself, with **no guard running at all**. The decision now comes from the
> **path**: `external_volume_candidate()` classifies the resolved root by **device number on its
> nearest existing ancestor**, and `require_external_envelope()` runs the **complete** D137 envelope
> for any external root. **An internal root with no assertion returns `None` and is byte-for-byte
> the accepted Decision 116 path.** An **unclassifiable** root refuses — internal is the only answer
> that admits without proof. The flag can now only **add** a requirement, and it must be
> `397A4D4A-9508-391E-814E-3B533C7BD049`; **an arbitrary UUID is refused before anything is
> measured**, and **D138 creates no generic external-volume authorization**.
>
> **MAJOR-2 — the `10` GiB floor was a printed opinion.** It is now enforced **inside the process
> running F2**: `F2CapacityGuard` samples from F2's own per-accession loop in **both** traversals
> and once **before** the transaction opens, and raises from **inside** the open transaction, so it
> **rolls back**. The in-flight projection is **discarded, not truncated**, and **no partial F2
> association state commits**. A **capacity-measurement failure takes the same path**. Sampling is
> bounded by a **monotonic** clock — `5` s scheduled against a `60` s ceiling — **not** by iteration
> count. **No thread, no signal, no deletion, no escalation.** The watchdog is demoted to
> supplemental observability: **exit `6` does not stop F2**.
>
> **MAJOR-3 — two accepted gates were never written.** `POST_F0 >= 60` GiB / `64,424,509,440` B and
> `PRE_F1 >= 55` GiB / `59,055,800,320` B are now executable, **before F1 begins**. The `185` GiB
> and `50` GiB floors keep their own accepted call sites and are **not moved**.
>
> **The rollback proof is not that an exception was raised.** The capacity provider reads the
> association row count on the **same connection** from inside the open transaction, watches it
> **climb from zero**, breaches at the first non-zero count, and the table is **`0`** afterwards —
> with a control run that commits, so an empty table proves a rollback rather than a projection that
> never wrote.
>
> **`384` before, `450` after** — the accepted D137 count reproduced first, then `384 + 66` with no
> regression. **`13` reversible mutations, every one killed**, every mutated file verified
> byte-identical afterwards. **Two test weaknesses were found by falsification rather than by design
> and are recorded** rather than quietly fixed.
>
> **The live preflight ran once, read-only, and created nothing.** Four **no-flag** controls all
> refused — external root, archive child, volume root, arbitrary asserted UUID — which under
> Decision 137 were every one of them admissions.
>
> **Nothing is authorized by this.** No canary, no world, no run identity, no E0, no migration
> `0016`, no network. All three activation constants remain `None`, migration head stays `0015`, and
> `CensusOrchestrator._parse_bulk` remains an open PRE-NETWORK blocker, deliberately unrepaired.

> **CONTROLLING POSITION AS AT 2026-08-23 — published
> [Decision 137](../Docs/Decisions/decision_137_m3_3_external_working_root_and_capacity_safety.md),
> implementation authorization
> `M3_3_D137_EXTERNAL_WORKING_ROOT_AND_CAPACITY_SAFETY_IMPLEMENTATION_AUTHORIZED` (issued outside
> this repository and now spent), classification `BOUNDED_SAFETY_IMPLEMENTATION_ONLY`, completion
> token `M3_3_D137_IMPLEMENTATION_COMPLETE_READY_FOR_OWNER_REVIEW`, **no acceptance token**.
> **The disk Decision 136 proved suitable can now be used safely — and still may not be used.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The [Decision 136](../Docs/Decisions/decision_136_m3_3_external_ssd_active_volume_qualification.md)
> block that follows carried the `(LATEST)` marker until this record; that marker is corrected here —
> **Decision 136's block states its position as at its own date and is otherwise left
> byte-unchanged**, as every superseded block in this file is. Every block below this one still
> carries a `(LATEST)` marker written when it was current; **they are historical and none of them is
> the current position** — only the topmost block ever is.
>
> **Implementation is not acceptance, and acceptance is not authorization.** Decision 136 §11
> (**D136-R11**) assigned nine items to this stage and Decision 137 ships all nine. It carries **no
> acceptance token**, and the **D136-R8** narrow one-canary exception takes effect only after D137
> implementation **and acceptance**. A passing preflight prints `canary_authorized: false`.
>
> **No second root-selection mechanism was created** (D137-R2). The canary already takes an
> operator-supplied absolute `--work-root` and already enforces it twice through one primitive — at
> the operator surface for a fast refusal, and inside `run_single_source_canary` as the run's own
> invariant. **What was missing was never a way to *name* an external root but a way to
> *authenticate* one**: `SQLITE_TMPDIR` returned **zero** repository-wide matches before this stage.
> The guards live in **one** new module and reach the run through **one optional parameter**;
> omitted, every path behaves exactly as accepted Decision 116 left it.
>
> **Identity is the Volume UUID, and nothing else** (D137-R1). `require_qualified_volume()`
> authenticates against **`397A4D4A-9508-391E-814E-3B533C7BD049`**, case-insensitively and otherwise
> exactly. **`disk4` and `disk4s2` are attach-time identifiers and are never identity**, and the
> mount path is not either — `/Volumes/SSK SSD` is whatever volume happens to be mounted there. A
> **wrong UUID**, a **missing volume**, and a **failed lookup** are three causes with **one outcome:
> refusal**, and **no fallback to internal storage** in any of them. Identity is read from
> `diskutil info -plist` as a **property list**, never from the human-oriented table, and the mount
> point is **derived** by an `st_dev` walk because `diskutil` will not answer for a subdirectory.
> **No test depends on the operator's SSD** — every guard resolves its identity provider from module
> globals **at call time**, so a substitution reaches the composed preflight and the run path too.
>
> **The archive is isolated under aliasing, and a lookalike is not falsely refused** (D137-R3). A
> working root that **is**, lies **inside**, or **contains** the D130 archive is refused, decided on
> `realpath`-resolved, case-folded **components**. `realpath` collapses `..` and follows symlinks
> before anything is compared, so aliasing cannot get in; and a component-wise prefix cannot mistake
> `FDD_M3_3_D130_D128_ARCHIVE_WORKING` for a child of the archive, so a lawful sibling is not
> refused. **A naive `startswith` fails the second case.**
>
> **Three floors, three questions, and none replaces another.** `PRE_LAUNCH` `>= 185` GiB /
> **`198,642,237,440`** B **refuses to launch** (D137-R4), measured on the filesystem hosting the
> **selected** root, with **nothing deleted, moved, or cleaned to reach it** and an unmeasurable
> volume refusing. `POST_F1_PRE_F2` `>= 50` GiB / **`53,687,091,200`** B **refuses F2** before its
> transaction opens (D137-R5). The **continuous** `DURING_F2` floor stays at `10` GiB /
> **`10,737,418,240`** B — **D124-R5, unchanged** — with alerting from `20` GiB (D137-R6).
> **Raising the admission gate did not raise the emergency floor.**
>
> **The `30` GiB constant is gone from code, and its absence is proved rather than asserted**
> (D137-R5). `PRE_F2_MINIMUM_FREE_BYTES` moved from `30 * 1024**3` to `50 * 1024**3`. **The constant
> moved; the mechanism did not** — the strict `<`, the call site between F1's return and F2's call
> (D126-R6), the refusal's shape, and the Decision 094 §6.4 ordering are byte-unchanged, and **the
> guard is retained, not removed**. It was one constant read from one comparison, so raising it
> retires the old behaviour entirely; `test_the_superseded_thirty_gibibyte_amount_no_longer_admits`
> pins free space at **exactly `32,212,254,720`** and requires a refusal. **Decision 127's own test
> file is updated in place, not deleted and not skipped.**
>
> **A hard stop during F2 is a rollback, not a truncation** (D137-R6). F2 is a **single
> transaction**, so stopping inside it discards the in-flight projection rather than truncating it,
> and the watchdog says so in the message itself. The `capacity` subcommand **reports and never
> acts**: no signal, no deletion, no cleanup at any threshold, and the accepted D131 no-escalation
> invariant untouched. Its thresholds are **imported** from the package — a monitor carrying its own
> copy of a frozen floor can drift from the gate it monitors.
>
> **Phase evidence is recorded where it can honestly be taken** (D137-R7). `PRE_LAUNCH`, `POST_F0`,
> `PRE_F1`, `POST_F1_PRE_F2`, and `POST_F2` are written into the result document; an invented label
> is **refused**. **`DURING_F2` is deliberately absent in-process** — F2 is one blocking call inside
> one transaction, so claiming it there would invent a measurement never taken. **An unknown
> measurement stays `None`, never `0`.** A run with no external requirement records nothing and
> renders no key, leaving the accepted D119 byte-level evidence-equivalence **unchanged**.
>
> **`SQLITE_TMPDIR` is validated, never set** (D137-R8). Required explicitly, absolute, existing,
> outside the archive, and on the **same qualified volume**. Assigning it from inside a guard would
> put a process-wide side effect in a path whose purpose is to refuse unsafe states, and would hide
> the setting the operator must be able to see. Unset, SQLite spills to the internal volume
> **silently**.
>
> **The D130 archive check is bounded, and the tar is never opened** (D137-R10). The four
> Decision 130 §6 compact proofs are hashed; the `103,966,696,960`-byte tar is **`stat`-ed only**.
> That it is never read is proved by a **tripwire over `Path.read_bytes`**, not by reading the
> source. A precheck difference refuses a launch; a postcheck difference is a **blocker**.
>
> **Validation, stated as numbers.** Focused baseline **`317` passed** before any edit; **`384`
> passed** after — `317 + 65 + 2`, **no regression**. **`17` reversible source mutations, every one
> caught by named tests**, with the tree verified byte-identical afterwards and **no source-mutating
> framework used**.
>
> **One bounded read-only live preflight ran.** UUID **exact match**; the D130 archive present with
> **`24` entries** and **no differences** in `0.171` s; free **`310,498,951,168` B / `289.1747`
> GiB** against the `185` GiB floor, **surplus `111,856,713,728` B / `104.1747` GiB**; the
> archive-child, volume-root, unset-`SQLITE_TMPDIR`, and internal-`SQLITE_TMPDIR` controls **all
> refused**. **Nothing was created, written, deleted, or benchmarked on the volume, and the tar was
> never opened.** One honest discrepancy: free space is `393,216` B — three `131,072`-byte ExFAT
> allocation blocks — **higher** than Decision 136 §5 recorded. It is stated rather than rounded
> away, and it moves no floor and no verdict.
>
> **Eight of the twelve operator conditions cannot be verified mechanically** (D137-R9), and the
> runbook says so: external power, a stationary drive, no eject, no reformat, no competing writes,
> and sleep prevention are **operator assertions**, and **the preflight's silence about them is not
> evidence they hold**. No attempt is made to programmatically infer "the Mac is physically
> stationary".
>
> **Nothing new is claimed about ExFAT durability** (D137-R11). **No** journaled-filesystem
> semantics, **no** power-loss safety, **no** surprise-removal safety, **no** USB-bridge cache-flush
> correctness. Decision 136 §9 (D136-R6) established **process-crash recovery only**, and that
> boundary is preserved exactly. These guards reduce **capacity and path** risk.
>
> **Four residual limitations are carried rather than closed.** `DURING_F2` depends on the operator
> running the watchdog alongside the run, and nothing forces it. The external requirement is
> **opt-in** — which is what keeps every existing internal-volume canary path working, and means the
> guards protect a run that *asks* to be protected. The `SQLITE_TMPDIR` guard validates **placement,
> not peak**. And **no live end-to-end rehearsal was performed**, because that would require creating
> a world on the volume: the composed preflight's **accepting** path is proved synthetically and by
> its live **refusals**, not by a live pass.
>
> **What did not change.** **D129-R2** — every D128 semantic count remains rejected; **D129-R8** —
> from scratch, new world, new run identity; **D129-R12** — not discharged. The **D131** runtime
> configuration, parser, and shard-dispatch semantics are untouched, and **D134's `mmap` and
> relaxed-checkpoint candidates remain rejected**. **D125-R3 stands; D125-R4 stands as the general
> rule**, narrowed only by D136-R8. Migration head remains **`0015`** with **`0016` absent**,
> unapplied and not authorized. **All three activation constants remain `None`.** Network remains
> disabled at both tracked switches, request ceiling `0`. **`census_orchestrator.py::_parse_bulk`
> remains an open PRE-NETWORK blocker, deliberately unrepaired.**
>
> **A complete-source canary is not authorized. E0 is not authorized.** The next authorized action
> is **independent review of this implementation, and nothing else.**

> **CONTROLLING CURRENT POSITION, 2026-08-23 (LATEST) — accepted
> [Decision 136](../Docs/Decisions/decision_136_m3_3_external_ssd_active_volume_qualification.md),
> acceptance token `M3_3_D136_QUALIFICATION_EVIDENCE_OWNER_ACCEPTED`, numeric acceptance token
> `M3_3_D136_D135_NUMERIC_AUTHENTICATION_OWNER_ACCEPTED`, architecture ruling token
> `M3_3_D136_SINGLE_CANARY_EXTERNAL_SSD_EXCEPTION_SELECTED`, classification
> `BOUNDED_VOLUME_QUALIFICATION_ONLY`, verdict
> `D136_EXTERNAL_SSD_PASS_WITH_ARCHIVE_ISOLATION_REQUIRED`.
> **The disk D135 said must not be assumed suitable has now been proved suitable — mechanically,
> and conditionally.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The [Decision 135](../Docs/Decisions/decision_135_m3_3_corrected_run_capacity_reconciliation.md)
> block that follows carried the `(LATEST)` marker until this record; that marker is corrected here —
> **Decision 135's block states its position as at its own date and is otherwise left
> byte-unchanged**, as every superseded block in this file is. Every block below this one — the
> Decision 135 block dated `2026-08-23` included — still carries a `(LATEST)` marker written when it
> was current; **they are historical and none of them is the current position** — only the topmost
> block ever is.
>
> **Qualification is not adoption.** [Decision 135](../Docs/Decisions/decision_135_m3_3_corrected_run_capacity_reconciliation.md)
> §10 (**D135-R5**) named three distinct steps — *selecting a path is not qualifying a volume, and
> qualifying a volume is not adopting it*. **D136 completes the second and only the second.** It
> proves the six requirements D135-R5 set, and it **adopts nothing, changes no path configuration,
> and starts no run**.
>
> **The qualified volume, and the identity that matters** (D136-R1). `/Volumes/SSK SSD`, **Volume
> UUID `397A4D4A-9508-391E-814E-3B533C7BD049`**, `/dev/disk4s2` on physical `/dev/disk4`, **ExFAT
> served by Apple FSKit** — a user-space framework, not a kernel VFS driver — USB, External, Solid
> State, `131,072` B allocation block, **SMART Not Supported**, read/write. Exactly one external
> volume was present, so the identity was unambiguous, and **no rejection criterion was triggered**:
> it is local physical storage, not network, SMB/NFS/WebDAV, cloud-backed, or remote user-space
> storage. **The stable identity is the Volume UUID, never the attach-time `disk4s2`** — which is why
> D136-R11 makes a UUID-keyed fail-closed guard a D137 requirement.
>
> **Capacity passes with a wide margin, and the floors did not move** (D136-R2). Post-cleanup free
> **`310,498,557,952` B / `289.1743` GiB** against the START floor `198,642,237,440` B / `185` GiB —
> **surplus `111,856,320,512` B / `104.1743` GiB**, with `141.4218` GiB of headroom at the projected
> peak live footprint and `161.4302` GiB at the projected final durable footprint. Three pre-write and
> three post-cleanup observations each had a spread of **`0`** bytes, and **no archived byte is
> counted as free**. Against D135-R4's internal shortfall of `71,795,462,144` B this is a swing of
> `183,651,782,656` B. **The `185` GiB START and `50` GiB PRE-F2 floors are unchanged and still
> controlling.**
>
> **SQLite is correct on ExFAT — tested, not assumed** (D136-R3). Run in the project's **own**
> environment (`.venv`, Python `3.12.13`, SQLite `3.53.4`, **not** the system `3.9.5`/`3.35.5`) with
> **no project code altered**. The accepted D131 pragmas read back exactly: `journal_mode=wal`,
> `synchronous=2`, `cache_size=-524288`, `wal_autocheckpoint=1000`, `foreign_keys=1`,
> `busy_timeout=10000`, `mmap_size=0`. **Locking used separate OS processes**, not two cursors in
> one: writer B was refused for its full `2.1759` s bounded timeout and **left no row**, a reader was
> **never blocked** (`0.0005` s) with correct WAL snapshot isolation, and B committed in `0.003` s
> after release — **no double writer**. **Crash recovery is correct both ways**, under a **ten-check
> PID-and-command-line authentication immediately before each `SIGKILL`** with no escalation ladder
> and no project or canary process signalled: `500` uncommitted rows **absent** after the kill, `500`
> committed rows **survived** a kill with a `24,752` B uncheckpointed WAL and were recovered by a
> **fresh process**, `TRUNCATE` returned `[0,0,0]`, `integrity_check == ok` throughout.
>
> **I/O practicality passes — and licenses no runtime claim** (D136-R4). `2` GiB non-sparse with
> write-hash equal to read-back-hash, **`250.438` MiB/s fsync-complete** against the `50` MiB/s floor
> (**`5×`**), `322.438` MiB/s read, `0` I/O errors. The bounded **synthetic** SQLite workload — **D134
> not reconstructed, no SEC JSON parsed, no canary run** — built `793.96` MiB in `4.176` s with commit
> latency median `0.0388` s, p95 `0.0544` s, max `0.0741` s, WAL high-water `8.927` MiB, **`0` stalls
> over `5` s**, `0` I/O errors, `integrity_check == ok`, and the WAL truncated to `0`. **A flat WAL
> sample is not absence of checkpointing** — SQLite reuses the WAL in place; the proof it ran is that
> the high-water held at `8.927` MiB **while `793.96` MiB was written**. **No complete-source runtime
> may be extrapolated from any of it.**
>
> **Allocation does not force the floor up** (D136-R5). External ratios `1.000000` (the `2` GiB file)
> and `1.0000443` (the SQLite database) are **better than the internal APFS `1.0002757`** the floor
> was derived on; rescaling adds only `6,073,630` B durable and `7,024,938` B peak. **No floor is
> raised and no adjustment is proposed.** The `128` KiB minimum allocation is a **known minor**
> many-small-file risk — an `8,192` B database allocated `131,072` B, `16×` — bounded because the run
> world is a few very large objects: **`853,404` files would be needed to consume the surplus**.
> **`SQLITE_TMPDIR` behaviour on ExFAT is UNMEASURED** and carries to D137.
>
> **What D136 does NOT establish** (D136-R6). **Process-crash recovery only.** No power-loss safety,
> no surprise-removal safety, no USB-bridge cache-flush correctness, no journaled-filesystem
> semantics. **ExFAT has no metadata journal**, so a loss during a metadata update can damage
> directory structure, not merely an in-flight file — and `SIGKILL` exercises **SQLite's** WAL
> recovery, never the filesystem's. **The `~0.9` ms `F_FULLFSYNC` return is explicitly not evidence
> of a physical flush**: it is equally consistent with the bridge silently ignoring the command, and
> D136 cannot distinguish the two without power-cut testing.
>
> **The archive did not move, and that is why the verdict is conditional** (D136-R7). The `~104` GB
> pax archive was **not opened, not hashed, not re-hashed**; only the
> [Decision 130](../Docs/Decisions/decision_130_m3_3_d128_archival_and_reclamation.md) §6 compact
> proofs were verified, in `0.040` s, and the postcheck found **zero differences across all `24`
> entries** with the archive directory **never written**. The scratch tree was a **sibling at the
> volume root**. But `d130_post_deletion_proof.txt` shows **no internal copy exists**, so the archive
> and any future active database share **filesystem, physical device, cable and bridge, and
> surprise-removal failure domain**. That is the single failing PASS predicate. **The verdict was not
> softened from a FAIL** — no concrete predicate failed — and it is **not INCONCLUSIVE**.
>
> **The D135 numeric ruling** (D136 §3). **The authoritative row-uplift numerator is `21,098,678`**,
> from `15,996,591 + 5,102,087`, giving `U_rows ≈ 1.3189484`. The D136 packet asserted `21,099,278`
> and directed a hard stop if the repository showed otherwise; **the premise was inverted**. All four
> required sources carry `21,098,678`, `capacity_model_locked.json` hash-authenticates against the
> `cba5ba2b…b69a982` **D135 itself published**, and re-running the accepted `bc` cross-check
> reproduces **every** published total exactly while the alternative reproduces **none**. **The
> blocking token was correctly not returned** — it names a mismatch between publication and locked
> model, and none exists. Recorded as an **OWNER PACKET TYPO**; **no repository correction is
> required or authorized**, because the repository was never wrong.
>
> **The narrow exception, and what it does not grant** (D136-R8, D136-R9).
> [Decision 125](../Docs/Decisions/decision_125_m3_3_external_archival_and_reclamation.md) §11
> (**D125-R4**) — *the SSK SSD remains cold/archive storage only, no active governed SQLite use, no
> reformat* — **remains the GENERAL rule**. D136's own bounded synthetic disposable tests did not
> violate it. **One narrow exception** is created: after successful **D137** implementation and
> acceptance, **this exact volume** may host **ONE** corrected M3.3 complete-source canary working
> world, as a **separate sibling tree**, with **no write inside
> `/Volumes/SSK SSD/FDD_M3_3_D130_D128_ARCHIVE`** and **the D130 archive immutable**. It authorizes
> **no** arbitrary active governed SQLite use and **grants no authority now**. The shared
> failure-domain risk is **explicitly accepted for that one future canary only**, on five stated
> grounds — and **this converts ExFAT into nothing and claims zero risk nowhere**. Twelve physical
> and run conditions (D136-R10) bind any later authorization; they are **future run conditions only**.
>
> **What did not change** (D136-R12). The `30` GiB constant **remains live in code exactly as
> written** — `PRE_F2_MINIMUM_FREE_BYTES` in `src/disclosure_drift/m3/single_source_canary.py` is
> **not edited and not authorized to be**; replacing its behaviour is **D137** work. **D129-R2 remains
> controlling** and **D129-R8 remains controlling** — from scratch, new world, new run identity. The
> **D131 runtime configuration is unchanged** and **D134's mmap and relaxed-checkpoint candidates
> remain rejected**. Every **D124-R5** gate carries forward. **D125-R3 stands.** Migration head
> remains `0015`, `0016` absent and unauthorized; all three activation constants remain `None`;
> network disabled at both tracked switches at request ceiling `0`;
> **`census_orchestrator.py::_parse_bulk` remains an open PRE-NETWORK blocker**. **A complete-source
> canary is NOT authorized. E0 is NOT authorized.**
> **Qualifying a volume is not adopting it, and adopting it is not authorizing the run.**

> **CONTROLLING CURRENT POSITION, 2026-08-23 (LATEST) — accepted
> [Decision 135](../Docs/Decisions/decision_135_m3_3_corrected_run_capacity_reconciliation.md),
> acceptance token `M3_3_D135_CORRECTED_RUN_CAPACITY_MODEL_OWNER_ACCEPTED`, architecture ruling token
> `M3_3_D135_EXTERNAL_WORKING_VOLUME_PATH_SELECTED`, classification `CAPACITY_PLANNING_MODEL_ONLY`,
> verdict `D135_CORRECTED_RUN_CAPACITY_MODEL_INSUFFICIENT`.
> **The capacity model D129-R12 demanded now exists — and its verdict is that this machine cannot
> host the run.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The [Decision 134](../Docs/Decisions/decision_134_m3_3_bounded_performance_ab.md) block that
> follows carried the `(LATEST)` marker until this record; that marker is corrected here —
> **Decision 134's block states its position as at its own date and is otherwise left
> byte-unchanged**, as every superseded block in this file is. Blocks dated `2026-08-22` and earlier
> still carry `(LATEST)` markers written when each was current; **they are historical and none of
> them is the current position** — only the topmost block ever is.
>
> **The blocker moved; it did not clear.**
> [Decision 129](../Docs/Decisions/decision_129_m3_3_d128_semantic_adjudication.md) §12 (**D129-R12**)
> ruled the old [Decision 124](../Docs/Decisions/decision_124_m3_3_capacity_reconciliation.md) model
> insufficient as an authorization basis and stated plainly that D129 **does not construct** the
> replacement. **D135 constructs it.** But **answering D129-R12 as a modelling obligation does not
> discharge it as a gate**: the model's own verdict is `INSUFFICIENT`, and the word attaches to the
> **capacity**, not the model — *the model is defensible; the machine does not currently hold what it
> asks for*. The corrected complete-source canary is now unauthorized **pending successful
> external-volume qualification and adoption of the resulting capacity/path architecture**.
>
> **The accepted floors** (D135-R2, D135-R3). **START `185` GiB / `198,642,237,440` bytes** —
> remaining projected peak growth `158,648,106,397` B with the `25%` reserve branch binding at
> `39,662,026,600` B. **PRE-F2 `50` GiB / `53,687,091,200` bytes** — remaining growth
> `29,585,782,350` B with the **`20` GiB reserve floor** binding. The `105` GiB launch gate and the
> `30` GiB pre-F2 gate are **superseded for planning purposes only**.
>
> **The `30` GiB constant is still in code, and editing it is NOT authorized.**
> `PRE_F2_MINIMUM_FREE_BYTES = 30 * 1024**3` in `src/disclosure_drift/m3/single_source_canary.py` is
> **byte-unchanged**. D135 §8 rules it insufficient and **explicitly does not authorize editing it**.
> **A session that edits it as an obvious follow-up would be acting outside D135**; a session that
> reads the `30` as a validated threshold would be reading a superseded planning value. Deferring is
> safe **because no run is authorized** — a gate never reached cannot be reached at the wrong value.
>
> **Why the old gate had to go.** The corrected projection consumes **`27.5539` GiB of the old
> `30` GiB gate outright**, leaving **`2.4461` GiB with zero safety reserve** — almost exactly the
> `~2 GiB` margin D129 §11.3 found D128 *actually* experienced. **It is not a comfortable threshold
> that happens to be low; it is a near-miss restated at a larger workload.**
>
> **The model** (D135 §§3–6). Every durable input is a **measured** value from an accepted record or
> from byte-verified D134 preserved evidence, entry-gated against the D134 preservation manifest —
> **so the D134 preservation ruling paid for itself here**. The D130 `~104 GB` pax archive was **not
> opened, not re-hashed, not extracted**; the accepted source archive was **not opened or hashed**;
> **`0` databases were opened**; the operational catalog was **not touched**; **no network was used**.
> **Model A governs every component** — D128's measured live state scaled by
> **`U_rows` = `21,098,678/15,996,591` ≈ `1.31895`**, the conservative supported proxy — giving a
> **projected peak live of `158,648,106,397` B / `147.7526` GiB**. **The D128 timeline closes
> internally**, matching F2's published `~8.67 GiB` WAL peak to within **`34,752,593` B**.
> **Model B never governs** and is **demonstrably an understatement**: it carries **no pre-F2 WAL term
> at all**, no pre-F2 breakpoint, and a low-ordinal prefix at `~317` accessions/member against a
> corrected source-wide `~19.3` — and **its density rises with scale** (`+4.06%`), so extrapolating
> from it is an understatement **rather than a conservative bound**.
>
> **Two independent arithmetic paths** — Python `Fraction` + `ceil` and BSD `bc` at `scale=0`, the
> second written from the raw measured inputs alone — **agree exactly on all `21` integer-byte
> totals**.
>
> **The measurement could not have been fitted.** The model was **locked and hashed before any
> free-space observation** — `capacity_model_locked.json`, SHA-256 `cba5ba2b…b69a982`, carrying that
> attestation, with the observation document recording **the same hash** as the model it was compared
> against. **No threshold was altered in response to the measurement.**
>
> **The internal volume is insufficient** (D135-R4). Minimum observed free **`126,846,775,296` B /
> `118.1353` GiB** against the `185` GiB floor — **shortfall `71,795,462,144` B / `66.8647` GiB** —
> with **`0` APFS and `0` Time Machine snapshots** withholding space, so the shortfall is real. The
> floor is **`81.04%` of the entire `228.2739` GiB container**; **the projected FINAL durable state
> alone (`127.7441` GiB) already exceeds current free space by `9.6089` GiB** before any transient,
> WAL, or reserve — **the finished catalog does not fit, never mind the run that builds it**; and
> current free space **does** clear the obsolete `105` GiB gate by `13.1353` GiB, **precisely the trap
> [Decision 130](../Docs/Decisions/decision_130_m3_3_d128_archival_and_reclamation.md) §10 (D130-R6)
> named — clearing a superseded gate is not readiness**. The measurement is **descriptive only**:
> nothing was cleaned, deleted, moved, or reclaimed.
>
> **The owner's architecture direction** (D135-R5). The owner **cannot practically free enough
> internal storage** — and the finding above is why no cleanup closes it — so the **active external
> working volume** path is selected **for qualification**. **No internal cleanup campaign is required
> or authorized. No complete-source canary is authorized. The currently attached SSD must not be
> assumed suitable until a future D136 proves it**, against **six independent requirements**:
> filesystem suitability; SQLite WAL and locking correctness; durability and recovery; sufficient free
> capacity against the D135 floors; sustained-write practicality; and safe separation from retained
> D130 evidence — **every item, not a majority**. **Selecting a path is not qualifying a volume, and
> qualifying a volume is not adopting it.** **No external SSD was touched by this publication**: not
> benchmarked, not written to, not deleted from, not moved on, not reformatted, not repartitioned,
> D130 archive evidence not modified, and **no inference about filesystem suitability is made**.
>
> **Monitoring is planning input only** (D135-R7). Six points, **no automatic destructive cleanup**
> anywhere, the `DURING_F2` hard floor **unchanged at `10` GiB** (D124-R5) — and because **F2 is a
> single transaction, a stop is a rollback**, which the operator must be told explicitly. **Nothing is
> implemented by this record.**
>
> **What it does not establish** (D135-R8, D135-R9). No certified corrected semantic count, no
> corrected runtime, no complete-source semantic correctness, no canary acceptance, no E0 or network
> readiness, and **no permission to execute anything**. The `19,034,205` planning accession universe
> and every related quantity remain **`CAPACITY_PLANNING_CARDINALITIES_ONLY`** — sized to plan a disk,
> **not certified counts** — so **D129 §4 (D129-R2)'s rejection of every D128 count stands entirely**
> and **D129 §14 (D129-R8) still requires any later canary to run from scratch, in a new world, under
> a new run identity**.
>
> **Its own limitations, stated rather than smoothed** (D135 §15). The model rests on **one
> complete-source run, and that run was defective**. **No F0 or F1 interior breakpoint exists anywhere
> in the evidence.** Peak temporary and spill usage was **never measured at scale** — carried as `0`
> **because `0` is what the evidence supports, not because `0` is known to be right**. The **D131
> deferred-shard reopen phase has never been measured at full scale**. And **the floors are planning
> values, not measured requirements**.
>
> **D135 supersedes nothing.** Decisions 121 through 134 stand as written; **every D124-R5 gate
> carries forward intact**; the **D131 runtime configuration is unchanged** and **D134's mmap and
> checkpoint candidates remain rejected** (D135-R6). Migration head remains `0015`, `0016` absent and
> unauthorized; all three activation constants remain `None`; network disabled at both tracked
> switches at request ceiling `0`; **`census_orchestrator.py::_parse_bulk` remains an open PRE-NETWORK
> blocker** (D135-R10). **A complete-source canary is NOT authorized. E0 is NOT authorized.**
> **Modelling what a run would need is not authorizing the run.**

> **CONTROLLING CURRENT POSITION, 2026-08-22 (LATEST) — accepted
> [Decision 134](../Docs/Decisions/decision_134_m3_3_bounded_performance_ab.md), acceptance token
> `M3_3_D134_BOUNDED_PERFORMANCE_AB_OWNER_ACCEPTED`, publication token
> `M3_3_D134_GOVERNANCE_PUBLICATION_AUTHORIZED`, preservation ruling token
> `M3_3_D134_DURABLE_EVIDENCE_PRESERVATION_OWNER_ACCEPTED`, classification
> `BOUNDED_PERFORMANCE_EXPERIMENT_NO_ADOPTION`, outcome
> `D134_NO_LOW_RISK_PERFORMANCE_CHANGE_WORTH_ADOPTING`.
> **Two low-risk runtime candidates were measured honestly and both were rejected. Nothing was
> adopted, and nothing executable changed.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The [Decision 133](../Docs/Decisions/decision_133_m3_3_watchdog_linux_portability_repair.md)
> block that follows carried the `(LATEST)` marker until this record; that marker is corrected here —
> **Decision 133's block states its position as at its own date and is otherwise left byte-unchanged**,
> as every superseded block in this file is. Blocks dated `2026-08-20` and earlier still carry
> `(LATEST)` markers written when each was current; **they are historical and none of them is the
> current position** — only the topmost block ever is.
>
> **A negative result is a result.** The experiment existed to answer whether a cheap runtime change
> would materially improve the complete-source path. **The answer is no**, and recording it is what
> stops the same two candidates being proposed again as though they were untried.
>
> **The design** (D134 §3). The accepted source `sec_bulk_submissions-c85744be921b0dc5.zip`
> (`1,556,847,020` bytes, SHA-256
> `c85744be921b0dc5be4e3c7dd44552fc0f57d354d61df38cd92a13926982b82f`, `985,835` members); a selection
> rule **frozen before any arm ran**; and two fixtures **byte-identical to the accepted source** with
> `0` mismatches — `ab3000` (`3,520` members, `1,276,084` accessions) and `ab6000` (`6,871` members,
> `2,181,341` accessions). The baseline is the accepted D131 configuration, **read back from a real
> writing connection rather than recalled**.
>
> **Candidate A — `PRAGMA mmap_size` — rejected** (D134-R2). `4,294,967,296` bytes requested,
> **`2,147,418,112` granted** — SQLite `3.53.4` clamps at `MAX_MMAP_SIZE=0x7fff0000` — with the
> baseline reading back `0`, so **the arms differ on the connection's own read-back, not merely on the
> request**. `ab3000` **`12.84%`**, `ab6000` **`9.775%`**: both `MODEST_5_TO_15`, **neither reaching
> the `>= 15%` preferred threshold**. **The benefit declined as the catalog grew** — map coverage
> `80.64%` → `45.33%` — so **the trend runs the wrong way for complete source**. Peak RSS rose
> **`+1,795,063,808`** and **`+1,427,111,936`** bytes against the `2.271` GiB D120 baseline peak on an
> `8` GiB host; under mmap an I/O error on a mapped page arrives as **`SIGBUS`**; and adoption would
> have required changing the accepted **D119** pragma-surface test.
>
> **Candidate B — relaxed checkpoint cadence — rejected** (D134-R3). A **non-vacuous `32×`**
> reduction — `5,120` eligible boundaries, `5,120` → **`160`** issued, `4,960` suppressed — bought
> **`1.185%`**, `IMMATERIAL_<5`, and left **WAL high-water byte-identical at `768,054,552` bytes**.
> **Peak WAL is set entirely by F2's single association transaction, which neither arm checkpoints
> inside, so the F0/F1 cadence never governed the peak at all.** Any future proposal to control peak
> WAL by tuning F0/F1 cadence is **answered here in advance: it cannot work.** The cancelled `ab6000`
> checkpoint arm **does not need to be run**.
>
> **The early stop** (D134-R4). The `ab6000` mmap result of `9.775%` triggered the **precommitted**
> `>= 5%`, `< 10%` case `STOP_AFTER_MMAP_R1`. Counts matched the baseline exactly, the arm was
> non-vacuous, and no measurement anomaly was flagged. **Reduced repetition at `ab6000` is an accepted
> consequence of a rule fixed in advance, not a defect requiring more execution**, and **no cancelled
> arm is restarted**.
>
> **Semantics** (D134-R5). `8` measured arms, `6` arm-to-baseline comparisons, **all semantically
> equal**: `0` stable-column table differences across `27` tables per arm, compact-evidence member
> digest and semantic result document equal, and `10` tables differing **only** in already-classified
> volatile columns. It is **bounded to the measured fixtures** and establishes **nothing** population-
> or source-wide.
>
> **Preservation before reclamation** (D134-R8). **The first cleanup attempt was correctly refused**:
> every fixture hash and per-arm/per-table digest existed **only** inside the deletion targets, so
> deleting them would have made the equivalence claim above **permanently unverifiable**. Under the
> owner's preservation ruling, `32` JSON artifacts totalling `2,919,526` bytes were promoted
> **byte-exactly** — `32/32` verified by `cmp` **and** an independent `shasum` pass, `0` missing, `0`
> mismatch, `0` collision — and authenticated by `evidence/d134_preservation_manifest.json`
> (`39,960` bytes, SHA-256
> `68ed5537af2be388b7ebdf7bff6545f71be3c586649104bb3523731aee6d60b3`). An eleven-row audit matrix
> passed, and **the published `12.84%` / `9.775%` / `1.185%` and all `6` semantic verdicts were
> re-derived from the preserved copies alone**. **Only then** were `worlds/` and `fixtures/` deleted,
> reclaiming **`23.891` GiB**. That reclamation is **ordinary scratch cleanup — it is not a capacity
> model, not a capacity margin, and not an input to one**.
>
> **The limitations are stated, not smoothed** (D134 §10). `ab6000` carries a **single repetition**
> per arm and its checkpoint arm was **never measured**; two operating points **do not define a
> curve**; and the largest fixture is **under `0.7%`** of the source. **None of them changes the
> decision** — the mmap benefit is below threshold *and trending down*, and the checkpoint candidate
> is immaterial *and mechanically incapable* of moving peak WAL.
>
> **What it changes about the position.** The performance step of the controlling sequence is now
> **complete and closed with no adoption**, so the **[Decision 129](../Docs/Decisions/decision_129_m3_3_d128_semantic_adjudication.md)
> §12 (D129-R12) corrected-run capacity reconciliation is now the immediate next substantive stage** —
> a change from the position before this record, where the performance A/B stood ahead of it. It
> requires its **own owner instrument** (D134-R6). `CensusOrchestrator._parse_bulk` remains an **open
> PRE-NETWORK blocker** (D131-R4 / D134-R7), and **[Decision 129](../Docs/Decisions/decision_129_m3_3_d128_semantic_adjudication.md)
> §4 (D129-R2) remains fully controlling — every D128 semantic count remains rejected**. Migration
> head remains `0015` with `0016` absent and unauthorized, all three activation constants remain
> `None`, both tracked network switches remain `false` at request ceiling `0`, **a complete-source
> canary is NOT authorized, and E0 is NOT authorized**.


> **CONTROLLING CURRENT POSITION, 2026-08-22 — accepted
> [Decision 133](../Docs/Decisions/decision_133_m3_3_watchdog_linux_portability_repair.md),
> acceptance token `M3_3_D133_LINUX_PORTABILITY_REPAIR_OWNER_ACCEPTED`, publication token
> `M3_3_D133_GOVERNANCE_PUBLICATION_AUTHORIZED`, classification
> `OPERATOR_TOOL_PORTABILITY_REPAIR_ONLY`, outcome
> `D131_WATCHDOG_LINUX_COMMAND_AUTHENTICATION_REPAIRED_AND_CI_PROVEN`.
> **The watchdog now authenticates its exact target on Linux as well as macOS. Nothing semantic
> moved.**
>
> **Read this first: this block now carries the current position, and every block below it does
> not.** The [Decision 132](../Docs/Decisions/decision_132_m3_3_bounded_real_semantic_proof.md)
> block that follows carried the `(LATEST)` marker until this record; that marker is corrected
> here — **Decision 132's block states its position as at its own date and is otherwise left
> byte-unchanged**, as every superseded block in this file is. Blocks dated `2026-08-20` and
> earlier still carry `(LATEST)` markers written when each was current; **they are historical and
> none of them is the current position** — only the topmost block ever is.
>
> **D133 is retrospective by design, and the reason is the defect itself.** The code shipped at
> `977a811b…` **without** a governance record, deliberately: the claim D133 must make is a claim
> about **Linux**, and the developer platform is macOS, where the defect is invisible by
> construction. A record written from macOS alone could have asserted the repair but could not have
> established it, so **the record waited for a fresh push-triggered Ubuntu CI result**. The delay is
> a **methodological requirement**, not a convenience.
>
> **The root cause** (D133-R1). The D131 watchdog authenticated its target with
> `/bin/ps -o command= -p PID`. On Ubuntu/`procps` that truncates to **`80` columns** when stdout is
> not a terminal — exactly what `capture_output` gives it — and a canary's command line is a
> virtualenv interpreter followed by an absolute path, comfortably past that width. The expected
> substring fell off the end, so the watchdog **correctly failed safe** with
> `STOP_REFUSED_TARGET_MISMATCH` and **never signalled a legitimate long-command target on Linux**.
> macOS BSD `ps` does not truncate in that condition, so **the defect escaped the local macOS
> acceptance gate** — the gate was green, and green truthfully about macOS. It is a
> `PRODUCT_DEFECT` in operator tooling, **not** a semantic-pipeline defect.
>
> **The minimal repair** (D133-R2). `/bin/ps -ww -o command= -p PID`, honoured by **both** BSD `ps`
> and `procps`, so one argv serves both platforms with **no platform branch and no `/proc`
> fallback**. **Everything else is unchanged**: the positive-PID domain, the `-o state=`
> process-state probe, exact-target authentication semantics, the `SIGINT`-only policy,
> `STOP_FAILED` behaviour, `ProcessLookupError` handling, `PermissionError` handling, the `lsof`
> intersection network probe, and `MEMBER_COUNT_INCONSISTENT` at exit `5`. The published change set
> is **`2` files, `+49 / -2`** — one operator script and one test file.
>
> **The regression guard asserts the argv, not the behaviour** (D133-R3).
> `test_the_command_probe_asks_ps_for_unlimited_width` captures the actual `ps` argument vector,
> because **the four originally Linux-failing tests still pass on macOS without `-ww`** — only the
> *request* distinguishes the two implementations. **Removing `-ww` is killed by that exact test**,
> on either platform.
>
> **Validation.** `make check-fast` **exit `0`, run exactly once**: `4900` collected, **`4899`
> passed, `1` skipped, `0` failed**, the single skip **pre-existing and unrelated**
> (`tests/unit/test_m23_pilot_manifest.py:429`) (D133-R4). Linux CI: workflow `CI`, run
> `32605572777`, SHA `977a811b…`, **`SUCCESS`**; the SEC-enabled required job and the
> core-environment job both `SUCCESS`; Linux pytest `4899` passed, `1` skipped, `0` failed; **all
> four previously failing nodes passed** under `ubuntu-latest`/`procps`; the new regression test
> passed; and the previously skipped **CLI smoke, secret scan, and repository hygiene** steps
> executed and passed. **No manual workflow rerun was used** (D133-R5).
>
> **D131's operational acceptance is restored cross-platform** (D133-R6). Its **semantic**
> acceptance was **never invalidated**; only the **operational/watchdog** half was temporarily
> reopened. **D131-R6 and D131-R9 are again accepted** for the currently governed environments, and
> **their content is unchanged — only their platform coverage was ever in question.**
>
> **D132 is unaffected** (D133-R7). The bounded real semantic proof remains **fully accepted and
> unchanged**, and **no D132 claim is reopened**: the repair is disjoint from shard dispatch, parent
> binding, parser provenance, the restored historical accessions, and archive-order semantic
> equivalence.
>
> **No revert was warranted, and none was performed** (D133-R8). The failure was **fail-safe** — a
> legitimate target **refused**, an unintended target **not signalled**. **No persisted project data
> was corrupted and no semantic result changed**, so the minimal repair was the correct disposition
> rather than pulling the accepted D131 repairs off `main`.
>
> **D133 changed no production package code, configuration, schema, or migration**, and **supersedes
> nothing**: Decisions 121 through 132 stand as written and **every D124-R5 gate carries forward
> intact**. **Next is a bounded performance A/B, then the D129-R12 corrected-run capacity
> reconciliation, then and only then an owner decision on another complete-source canary** — the
> same sequence Decision 132 §17 fixed, **neither advanced nor reordered**, each step requiring its
> own owner instrument (D133-R10). `CensusOrchestrator._parse_bulk` remains an **open PRE-NETWORK
> blocker** (D131-R4), and **[Decision 129](../Docs/Decisions/decision_129_m3_3_d128_semantic_adjudication.md)
> §4 (D129-R2) remains fully controlling — every D128 semantic count remains rejected** — with §12
> (D129-R12) **unresolved** (D133-R9). Migration head remains `0015` with `0016` absent and
> unauthorized, all three activation constants remain `None`, both tracked network switches remain
> `false` at request ceiling `0`, **a complete-source canary is NOT authorized, and E0 is NOT
> authorized**.

> **CONTROLLING CURRENT POSITION, 2026-08-22 — accepted
> [Decision 132](../Docs/Decisions/decision_132_m3_3_bounded_real_semantic_proof.md), acceptance
> token `M3_3_D132_BOUNDED_REAL_SEMANTIC_PROOF_OWNER_ACCEPTED`, publication token
> `M3_3_D132_GOVERNANCE_PUBLICATION_AUTHORIZED`, classification
> `BOUNDED_REAL_SEMANTIC_FIXTURE_ONLY`, outcome
> `D131_REPAIR_PROVEN_OVER_AUTHENTICATED_REAL_SEVEN_MEMBER_FIXTURE`.
> **The D131 repair is proven against real SEC bytes, over seven members and no more.**
>
> **Read this first: this block now carries the current position, and the two blocks below it do
> not.** [Decision 130](../Docs/Decisions/decision_130_m3_3_d128_archival_and_reclamation.md) and
> [Decision 131](../Docs/Decisions/decision_131_m3_3_d128_semantic_and_operational_repair.md) were
> published through the machine-readable markers above rather than through their own position
> blocks, so the Decision 129 block that follows continued to carry a stale `(LATEST)` marker after
> both. That marker is corrected here — **Decision 129's block states its position as at its own
> date and is otherwise left byte-unchanged**, as every superseded block in this file is.
>
> **D132 is retrospective.** The proof ran under the owner instrument
> `M3_3_D132_BOUNDED_REAL_SEMANTIC_PROOF_AUTHORIZED`, issued outside this repository; that grant is
> **spent**, and the record authorized none of it. **No new repository mode was required** (D132-R1):
> the proof drove the accepted D131 path from `select_planned_source` through the deferral, explicit
> parent resolution, `sec.archive.iter_named_members`, `parse_historical_submissions`, and
> `CensusCatalog.persist_streamed` to the reverse lookup, and **no repository semantics were
> reimplemented** — the scratch harness supplied disposable fixture provenance and world
> initialization only.
>
> **What was measured.** Against the accepted source `sec_bulk_submissions-c85744be921b0dc5.zip`
> (`1,556,847,020` B, SHA-256 `c85744be…82b82f`, `985,834` governed JSON members, corroborated at
> `5,337` historical shards across `4,144` distinct parent CIKs — the same population D128
> mishandled), a rule-selected set of four real shards under three real parents was parsed from two
> disposable fixtures built over the **same seven byte-exact real SEC payloads**, differing **only in
> member order** (`PARENT_FIRST` `d99c264a…95ea8`, `CHILD_FIRST` `efcf4e20…4477d`, each `169,186` B;
> no normalization, no reserialization, no field edit, no CIK edit, no synthesized accession).
> **`0` historical shards reached the primary parser and `4` of `4` reached
> `parse_historical_submissions`** in both orders, at `submissions-json/1.2` and
> `submissions-historical/1.1` (D132-R5). **The primary's `filings.files[].name` declaration, the
> persisted `census_historical_references.registrant_cik_padded`, the reverse lookup, and the
> parser's `registrant_cik` argument all agreed** for every shard across **three distinct
> registrants**, with **no observation-wide CIK leak** (D132-R6). **`4,135` real historical
> accessions were restored that are absent from the corresponding selected primaries** (D132-R7).
> Both orders produced `7` members, `7,139` records, `7,139` parsed, `0` quarantined, `0` malformed
> references, `parser_state` `completed`, and the accepted order-independent semantic comparison
> returned **`PASS`** (D132-R8). An orphaned-shard fixture holding the four byte-exact real shards
> **without their declaring primaries** — filenames still encoding the correct CIKs — was **refused
> fail-closed** under D129-R5 at `0` records, `0` accessions, `0` references, `0` parser runs, plan
> `parser_state` `not_started`, so **a filename CIK cannot rescue absent explicit parent evidence**
> (D132-R9).
>
> **Two figures are explicitly non-generalizable.** The **`4,135` is NOT a source-wide count** and
> must not be extrapolated to the archive; and the incidental agreement of completeness digest,
> parser run id, and manifest ordinals across the two orderings **follows from D131 deferral
> behaviour** and must not be generalized to arbitrary archive permutations.
>
> **Nothing was mutated** (D132-R11): repository unchanged, operational catalog bytes unchanged at
> SHA-256 `57e36a78…af2ded` — matching two prior independent evidence artifacts rather than only
> itself — accepted source SHA and mtime unchanged, and network prohibited by configuration **and**
> additionally guarded by raising `socket` stubs. No E0, no E0 namespace, no complete-source canary,
> no `census_orchestrator` import, no migration `0016`, no authority change. **The `~96 MB` evidence
> root is private and disposable and is NOT copied into the repository**; the Decision record is the
> durable pointer, authenticated by manifest SHA-256 `732e696a…95b3a7` (D132-R10).
>
> **The claim boundary** (D132-R12): D132 certifies **only** bounded real semantic behaviour of the
> D131 repair over the authenticated seven-member fixture — `7` members of `985,834`. It certifies
> **no** source-wide completeness, accession count, or record count, **no** corrected D128 counts,
> **no** replacement of D128, and **no** E0, canary, performance, or capacity readiness.
> **[Decision 129](../Docs/Decisions/decision_129_m3_3_d128_semantic_adjudication.md) §4 (D129-R2)
> remains fully controlling — every D128 semantic count remains rejected** — and §12 (D129-R12)
> **remains unresolved**.
>
> **D132 changed no production code, test, script, configuration, or migration**, and **supersedes
> nothing**: Decisions 121 through 131 stand as written and **every D124-R5 gate carries forward
> intact**. **Next is a bounded performance A/B, then the D129-R12 corrected-run capacity
> reconciliation, then and only then an owner decision on another complete-source canary** — each
> step requiring its own owner instrument (D132-R13). `CensusOrchestrator._parse_bulk` remains an
> **open PRE-NETWORK blocker** (D131-R4). Migration head remains `0015` with `0016` absent and
> unauthorized, all three activation constants remain `None`, both tracked network switches remain
> `false` at request ceiling `0`, **a complete-source canary is NOT authorized, and E0 is NOT
> authorized**.

> **CONTROLLING CURRENT POSITION, 2026-08-22 — accepted
> [Decision 129](../Docs/Decisions/decision_129_m3_3_d128_semantic_adjudication.md), owner token
> `M3_3_D129_D128_SEMANTIC_ADJUDICATION_OWNER_ACCEPTED`, outcome `D128_SEMANTIC_REPAIR_REQUIRED`.
> **The complete-source canary has run. It is accepted as an execution and rejected as a
> measurement.**
>
> **Read this first: this is a retrospective record of a completed run, and a PARTIAL acceptance.**
> D128 — run identity `m3_3_d128_complete_first_source_v1` — had already finished when the record was
> written. **The Decision 129 file did not exist before the run and did not authorize it**; the
> authorizing instrument was the owner instrument issued at the time, which this repository does not
> hold. **There is no `decision_128_*.md` file and there never was one**: `D128` names a **run
> identity**, not a decision record, so the registry index steps from `127` to `129` and §2 records
> that gap as expected rather than missing.
>
> **The partition is the whole point, and neither half may be read alone.** "D128 passed" and "D128
> failed" are both wrong. It ran, completely, for `33 h 18 m 43 s` — and what it counted is not
> trustworthy.
>
> **What is ACCEPTED (§3, D129-R1).** The full `985,834`-member complete-source traversal mechanics;
> exactly-one-source execution mechanics; the runtime and resource evidence; bounded-memory
> feasibility at peak RSS `3,178,020,864` bytes = `2.9598 GiB`; **F1 feasibility**; **F2
> feasibility**; the [Decision 127](../Docs/Decisions/decision_127_m3_3_pre_f2_admission_guard.md)
> pre-F2 admission gate's **operation** — its first exercise in a real complete-source run, and it
> **admitted**; complete working-catalog finalization; the write-ahead-log checkpoint **to zero**;
> **operational-catalog nonmutation**; the monitor and runtime evidence; and **D128 itself as a valid
> negative semantic experiment**. **Feasibility is not correctness** — every one of those is a
> statement about whether the path can run, never about what it recorded.
>
> **What is REJECTED and NOT owner-certified (§4, D129-R2).** D128's accession counts as semantically
> complete; `counts_are_trustworthy`; `parser_state` as successful; **D128 as an E0-readiness proof**;
> and **any downstream research count based on the omitted shard population**. **No E0 authorization
> follows from D128.**
>
> **Defect A — bulk shard dispatch, `PARSER_IMPLEMENTATION_DEFECT` (§5, D129-R3).** `5,337`
> legitimate members matching the tracked `HISTORICAL_FILE_NAME_PATTERN`
> `^CIK[0-9]{10}-submissions-[0-9]{3}\.json$` were routed through `parse_submissions_document(...)`
> instead of the historical-submission contract and were rejected — **correctly**, because that
> parser's contract is *one document describes one CIK* and a shard is not that document. **The
> defect is the dispatch, not the rejection.** It cost **`5,102,087`** shard accessions, of which
> **`2,064,473`** were recovered elsewhere and **`3,037,614` are genuinely absent** from a real
> universe of **`19,034,205`** — an omitted share of **`15.96%`**, about **one accession in six**.
>
> **And it is not evenly distributed, which is what makes it a research problem.** Form 10-K family:
> **`42,363`** absent = **`13.57%`** across all years, but **`9.11%`** in the development cohort
> `2010`–`2021` against **`0.25%`** in the evaluation cohort `2022`–`2026` — roughly a **`36x`**
> differential. **This is recorded as a STRUCTURAL CONFOUND on the preregistered temporal comparison,
> not as a negligible random loss.** No `§25` deviation is recorded: the counts are rejected before
> any preregistered analysis consumed them.
>
> **Defect B — observation-wide reference binding, `PARSER_IMPLEMENTATION_DEFECT` (§6, D129-R4).**
> **`5,337` of `5,337`** `census_historical_references` rows received **one incorrect
> observation-wide registrant CIK**, where **`4,144`** distinct registrants are represented. **The
> compounding hazard is the guard itself**: `_historical_registrant_cik(...)` refuses unless the match
> is unique — `len(rows) != 1` — so zero candidates fail closed and two or more fail closed, but **one
> consistently wrong candidate passes silently and is then returned as authority**.
>
> **The corrected resource record (§11), and two corrections to the earlier summary.** Wall
> **`119,923.08` s** = `33 h 18 m 43 s`; parse ≈ `26 h 59 m 30 s`; F1 ≈ `1 h 44 m 47 s`; F2 ≈
> `4 h 20 m 54 s`; close ≈ `7 m 27 s`; post-parse ≈ `6 h 19 m 12 s`, **with a published `364` s
> residual attributed to no named component**. Final working catalog `103,694,548,992` bytes =
> **`96.5729 GiB`**; minimum free `18,851,307,520` bytes = `17.5568 GiB`, so **the continuous
> `10 GiB` floor was never breached**; final free `28,195,401,728` bytes = `26.2589 GiB`.
> **Correction 1**: pre-F2 free at admission was **≈ `31.98`–`32.01 GiB`, not ≈ `37 GiB`**, so **the
> real margin above the `30 GiB` gate was ≈ `2 GiB`** — the gate did its job with far less room than
> anyone believed. **Correction 2**: the **≈ `15.17 GiB` peak write-ahead log occurred BEFORE the
> pre-F2 gate**, during parse-finalization/resolution, while **F2's own WAL peak was ≈ `8.67 GiB`**.
> Actual F1+F2 `6 h 05 m 41 s` against the
> [Decision 124](../Docs/Decisions/decision_124_m3_3_capacity_reconciliation.md) §8 planning ≈
> `3.37 h` is an **underprediction of ≈ `1.8x`–`1.9x`**.
>
> **The watchdog never stopped anything, and could not have (§9, D129-R10)** — forensic result
> `WATCHDOG_FALSE_ALERT_SIGNAL_NOT_DELIVERED_TO_CANARY`. Watchdog v1 targeted Python PID `6456`; its
> socket condition was **false** because the `lsof` selectors were **ORed without `-a`**; the chain
> launched as a background job from **non-interactive `zsh`**, so Python **inherited
> `SIGINT = SIG_IGN`**; `kill -INT` therefore had **no effect**. **No rollback and no replay
> occurred**, compact evidence proves **one row per member**, and `/usr/bin/time` recorded **zero
> received signals**. Before any corrected long run, **`SIGINT` delivery must be positively proven**,
> and **a watchdog may not treat a successful `kill(2)` return as proof that the process stopped**.
> The `13` post-traversal stall alerts were likewise **false** (§10, D129-R11): the member counter had
> correctly reached its terminal value while F1 and F2 legitimately continued.
>
> **What must happen next, and it is exactly one thing.** **D130 — the D128 external archival and
> internal reclamation — and nothing else.** **D128 is NOT resumable and NOT repairable in place**
> (§14, D129-R8): a corrected proof needs **new code, a new run identity, a new create-once world,
> and a full source rerun from the beginning**. Until D130, **D128 is RETAINED UNCHANGED** as the only
> complete-source observation that exists, and this publication **archives, deletes, moves, and
> mutates nothing**. After D130: a bounded parser, reference, and watchdog correction stage; then
> semantic validation; then the corrected-run capacity reconciliation (§12, D129-R12 — **the old
> Decision 124 launch-capacity model is NOT sufficient by itself**, and Decision 129 **does not
> construct the new one**); then the corrected complete-source canary. **Each step requires its own
> owner instrument.**
>
> **Nothing is authorized by this. Accepting a run's mechanics is not authorizing another run.** No
> corrected rerun, no complete-source run, no E0, no E0-v3, no F1, no F2, no canary, no disposable
> world, no migration `0016`, no network, and no acquisition. **Decision 129 implements no repair** —
> its §§7–10 invariants are specified and not written. **It supersedes nothing**: Decisions 121
> through 127 stand as written and **every D124-R5 gate carries forward intact**, including the
> `>= 30 GiB` pre-F2 gate, which §11.3 shows was met by about `2 GiB` — **a calibration fact, not a
> relaxation**. All three activation constants remain `None`, migration head remains `0015` with
> `0016` absent, no E0-v3 namespace exists, and both tracked network switches remain `false` at
> request ceiling `0`. **Complete source is NOT authorized. E0 is NOT authorized.**


> **CONTROLLING CURRENT POSITION, 2026-08-20 — the
> [Decision 127](../Docs/Decisions/decision_127_m3_3_pre_f2_admission_guard.md) pre-F2 free-space
> admission guard is IMPLEMENTED and READY FOR INDEPENDENT REVIEW, outcome
> `M3_3_D127_PRE_F2_GUARD_IMPLEMENTATION_READY_FOR_INDEPENDENT_REVIEW`, closing the sole
> [Decision 126](../Docs/Decisions/decision_126_m3_3_complete_first_source_final_preflight.md) §7
> blocker.**
>
> **Read this first: this is an implementation, not an acceptance, and not an authorization.** D127
> carries a review token, **not** an owner-acceptance token, and **no owner-acceptance token was
> emitted**. **Closing the D126 §7 gap does not open the run** — it removes the reason the run could
> not be authorized, which is a different thing from authorizing it.
>
> **What was implemented, and it is deliberately small.** One file,
> `src/disclosure_drift/m3/single_source_canary.py`, in three places — **`57` added lines, `0`
> removed, `0` modified**:
>
> - the frozen `PRE_F2_MINIMUM_FREE_BYTES = 30 * 1024**3` = **`32,212,254,720`** bytes, exported in
>   `__all__`;
> - `_require_pre_f2_free_space()`, measuring `shutil.disk_usage(...).free` on the disposable world's
>   own volume — `working.path.parent`, the directory holding the working catalog and its
>   write-ahead log — comparing with a **strict `<`** so the floor itself **admits**, and raising
>   `SingleSourceCanaryError` naming the **actual free bytes**, the **required minimum**, and that
>   **F2 was refused before its single transaction opened**, while naming **no path**;
> - the call site, placed **between** F1 `count_persisted_accession_resolutions(...)` and F2
>   `materialize_census_associations(...)` inside `_materialize`, leaving the Decision 094 §6.4
>   resolution-before-projection ordering **unchanged**.
>
> **Why it had to be in-path.** Decision 126 §7 rules that **no external sampler can satisfy the
> predicate**: no enforceable pause exists at the boundary, ledger state does not distinguish F1
> from impending F2, an external process can signal but cannot decline admission atomically, and a
> sampling race survives any cadence. **Only the code about to open the transaction can decline to
> open it.**
>
> **The proofs, and their non-vacuity.** `tests/unit/test_d127_pre_f2_admission_guard.py`, **6
> passing**: the constant pinned to its literal byte value; refusal one byte below the floor with
> the full message contract; a **real end-to-end run below the floor in which F2 is replaced by a
> tripwire that records nothing**; admission at **exactly** the floor and one byte above; an
> ordering log of `["F1", "GUARD", "F2"]` from three **real** wrapped participants; and the accepted
> catalog byte-identical after the refusal. **Non-vacuity is proved by mutation, because a test that
> passes against a missing guard proves nothing**: deleting the guard call produces **2 failures**,
> weakening `<` to `<=` produces **1**, and both mutations were applied, measured, and **reverted**.
>
> **What did not change**, which is the point of a scoped instrument: no `105 GiB` launch gate and
> no continuous `10 GiB` monitor in production code (both stay wrapper/monitor-enforced per
> D126-R5), `create_world` untouched, temporary-directory handling untouched, the F1 and F2
> algorithms untouched, write-ahead log / checkpoint / cache / `synchronous` untouched, schemas and
> migrations untouched, E0 and the three authority constants untouched, network not enabled, and
> **no canary executed**.
>
> **One consequence is stated rather than smoothed** (Decision 127 §5). The guard applies to
> **every** run of the path, including the Decision 116 and Decision 119 three-member synthetic
> worlds, so **on a machine with less than `30 GiB` free those suites would refuse at the admission
> gate** rather than fail at anything they test. **That is a consequence of the authorized scope,
> not a defect in it** — making the floor injectable is scope expansion, and a test-overridable
> safety floor is weaker than what D124-R5 asked for.
>
> **Nothing is authorized by this.** Independent review comes first, then owner acceptance, and only
> then the two things Decision 126 §10 (D126-R8) requires: a **regenerated run identity and
> command**, and a **new final live preflight**. All three activation constants remain `None`,
> migration head remains `0015` with `0016` absent, no E0-v3 namespace exists, and both tracked
> network switches remain `false` at request ceiling `0`. **Complete source is NOT authorized. E0 is
> NOT authorized.**


> **CONTROLLING CURRENT POSITION, 2026-08-20 — accepted
> [Decision 126](../Docs/Decisions/decision_126_m3_3_complete_first_source_final_preflight.md),
> outcome `M3_3_D126_COMPLETE_SOURCE_PREFLIGHT_OWNER_ACCEPTED`, verdict
> `NOT_READY_IMPLEMENTATION_GAP`, discharging the
> [Decision 125](../Docs/Decisions/decision_125_m3_3_external_archival_and_reclamation.md) §13
> (D125-R7) final-live-preflight requirement, its §10 (D125-R8) residue check, and the
> [Decision 124](../Docs/Decisions/decision_124_m3_3_capacity_reconciliation.md) §4 stored-object
> naming reconciliation that D125 §12 carried forward.**
>
> **Read this first: this is a retrospective record of a completed READ-ONLY preflight, not an
> authorization.** The preflight had already run when the record was written. **The Decision 126
> file did not exist before it and did not authorize it.**
>
> **The verdict's shape matters more than the word `NOT_READY`, and four things must be read
> together:** this is **NOT a live-state failure**; **every live-state predicate PASSED**;
> **complete-source execution did NOT occur**; and **complete-source execution remains
> UNAUTHORIZED**. **The blocker is a missing guard in this repository's own source, not a condition
> of the machine.**
>
> **Disk passes, with room (D126-R2).** Entry free **`137,633,968,128` bytes = `128.1816 GiB`**;
> exit free **`136,576,831,488` bytes = `127.1971 GiB`**; the preflight itself consumed
> `1,057,136,640` bytes = `0.9845 GiB`. **Both readings clear both levels** — the formal D124-R5
> gate of `112,742,891,520` bytes = `105 GiB` and the D125-R6 owner *preference* of
> `118,111,600,640` bytes = `110 GiB` — with exit standing `23,833,939,968` bytes = `22.1971 GiB`
> above the gate. **The D125 §9 shortfall of `7.6760 GiB` is closed by measurement**, from ordinary
> non-project storage, with **no further Disclosure Drift evidence deleted** (D125-R3). `0 GiB` of
> material stale pytest scratch remained. **One measurement condition is published rather than
> smoothed**: a publication-time re-read returned `136,511,447,040` bytes = `127.1362 GiB`, about
> `65 MB` below the exit figure, and **all three readings clear both levels**.
>
> **The frozen source and the catalog match what governance already recorded.**
> `sec_bulk_submissions-c85744be921b0dc5.zip` at `1,556,847,020` bytes, SHA-256
> `c85744be921b0dc5be4e3c7dd44552fc0f57d354d61df38cd92a13926982b82f`, **`985,835` raw ZIP entries**,
> **`985,834` governed JSON members**, and **exactly one** non-JSON `placeholder.txt`. Catalog file
> SHA-256 `57e36a78…0af2ded`, logical digest `5c823d21…6ad306`, observation-set digest
> `b1122bb9…8e533be`, **migration head `15`**, **`76` plan sources**, **all parser states
> `not_started`**, and **zero** E0 parser/accession/record materialization residue — the path would
> **start from a clean state, not resume into one**.
>
> **The source-pointer reconciliation is discharged (D126-R4).** Runtime authority is the
> **single-valued** `census_plan_sources.observation_id` `09fdacf651ba4d0a80f5d2ab4e36f4a3` plus its
> `985,834` governed member rows — one pointer, one archive, one member count. **Decision 059
> remains historically correct and is NOT amended**: it named the object stored *then*, and a record
> that correctly describes an earlier state is not corrected by a later state arriving. The
> identifier `c85744be921b0dc5` is recorded as the **first sixteen hexadecimal characters of the
> object's own SHA-256**, so **pointer and bytes verify each other** without reference to any
> document. **One nonblocking documentation limitation is recorded rather than repaired**: the
> controlling August-11 observation carries **no explicit `supersedes_observation_id` edge** to the
> August-07 one. It affects **no runtime correctness**, because selection reads the single-valued
> pointer and never walks a supersession chain, and it **authorizes no catalog write**.
>
> **The D125 §10 residue check was performed (D126-R3).** `m3_3_e0_offline_parse_v1` and
> `m3_3_e0_offline_parse_v2` remain present and **consumed**, **no `v3` exists**, and both are
> **structurally irrelevant to the canary path**. The lease is **`released`** — `lease_id`
> `3a37a7ee0e0c4496a4fba845d4d5d2a1`, `writer_pid` `68482` **dead**, `released_at_utc`
> `2026-08-18T01:44:33.497032Z`, file SHA-256 `8c0f251f…19db29b` — and the advisory lock was
> available. **The former stale-`held` condition, the one Decisions 102 through 107 were built to
> reconcile, is ABSENT.** No recovery authority and no recovery action is required, and **the file
> must not be modified**: a `released` lease is the correct terminal state of a writer that exited
> properly, not a defect to clean up.
>
> **The sole blocker was one missing line of production code (§7).** F1
> `count_persisted_accession_resolutions(...)` was immediately followed by F2
> `materialize_census_associations(...)` with **no `>= 30 GiB` admission predicate between F1's
> return and F2's transaction opening**, which D124-R5 requires taken *immediately before* F2 and
> explicitly **not** inherited from the starting gate. **The gate is not weakened by being unmet;
> that is what makes it the blocker.** D126-R6 authorized exactly one later stage to close it — one
> frozen constant, one guard, three focused tests — and **no implementation occurred in the D126
> publication**.
>
> **The other four D124-R5 requirements need no repository change (D126-R5).** Start `>= 105 GiB`
> and the continuous `10 GiB` floor are wrapper/monitor-enforceable; **no `VACUUM`** already holds by
> construction; and `SQLITE_TMPDIR` uses the **sibling** `<work-root>/<run-id>__sqlite_tmp/` rather
> than `<world>/tmp`, **because precreating `<world>/tmp` violates the world's create-once
> semantics**.
>
> **No arbitrary wall-clock kill ceiling (D126-R7).** `~15 h` optimistic / `~24 h` central /
> `~34 h+` possible is a **planning envelope, not a deadline**; resource and progress monitoring
> controls. **The run is not resumable**, so elapsed time alone is **not a valid kill criterion**.
> AC power was confirmed; a future run needs an explicit **per-process** `caffeinate -i -m -s`
> assertion against `sleep=1`/`disksleep=10`, and **persistent `pmset` settings must not be
> altered**.
>
> **The proposed command is not frozen (D126-R8).** `m3_3_d126_complete_first_source_v1` and its
> command were **not executed** and are **not frozen**, because D127 changes the code baseline. Both
> must be **regenerated** after D127 acceptance **and** a new final live preflight.
>
> **D126 supersedes nothing.** Decisions 121 through 125 stand as written, and the D124-R5 gates
> carry forward intact — **including the `>= 30 GiB` pre-F2 gate, recorded as unenforced by code
> rather than as relaxed**. All three activation constants remain `None`, migration head remains
> `0015` with `0016` absent, and both tracked network switches remain `false` at request ceiling
> `0`. **Passing every live-state predicate is a measurement, not an authorization (D126-R9):
> complete source is NOT authorized, and E0 is NOT authorized.**


> **CONTROLLING CURRENT POSITION, 2026-08-20 (LATEST) — accepted
> [Decision 125](../Docs/Decisions/decision_125_m3_3_external_archival_and_reclamation.md), outcome
> `M3_3_D125_EXTERNAL_ARCHIVAL_AND_RECLAMATION_OWNER_ACCEPTED`, discharging the
> [Decision 124](../Docs/Decisions/decision_124_m3_3_capacity_reconciliation.md) §11 archival
> obligation.**
>
> **Read this first: this is a retrospective record of a completed operation, not an authorization.**
> The archival, the external verification, and the internal retirement had **already run** when the
> record was written. **The Decision 125 file did not exist before the operation and did not
> authorize it** — the authorizing instrument was the GPT-5.6 Sol owner instrument issued at
> execution time. **A record that preserves evidence and frees space is not a grant to spend the
> space.**
>
> **The D122 identity is accepted, and is no longer a candidate (D125-R2).** The post-F1
> working-catalog SHA-256 is
> `fa4a635d36a487774e02670bb0fab1ded1c696b5e25faf54fb6f55b69799f413`. D124-R8 required the instrument
> to hash the actual preserved catalog, compare against the historical D123 completion-report
> candidate, **stop on mismatch**, and record the identity **before** deletion. **Four independent
> reads converged**: a fresh internal D125 hash, the historical D123 candidate, the **external archive
> member streamed back off the external device and rehashed**, and multiple independent reads. **The
> stop-on-mismatch condition never fired.**
>
> **The historical large worlds are preserved externally.** Seven uncompressed **PAX/TAR** archives at
> `/Volumes/SSK SSD/FDD_M3_D125_ARCHIVE/` on the exFAT `SSK SSD`: `d117_world.tar` `27,629,187,072` B,
> `d120_world.tar` `19,955,783,680` B, `d122_f1_world.tar` `23,530,204,160` B,
> `d123_characterization.tar` `4,034,596,352` B, `m3_perf_experiments.tar` `84,995,072` B,
> `c3_retained_evidence.tar` `11,043,328` B, and `d117_diagnostics.tar` `277,504` B — **totalling
> `75,246,087,168` bytes, about `70.0784 GiB`**, each with a recorded SHA-256.
>
> **Verification streamed the actual TAR contents back from the external device**, rather than
> re-stating what the writer believed it had written — which is what makes the retirement safe.
> **`2,777`/`2,777` members matched**, **`2,470`/`2,470` regular-file SHA-256 values matched**, `0`
> missing, `0` unexpected, `0` duplicate, and **all metadata comparisons passed**.
>
> **Retention (D124-R9 satisfied).** Permanent internal root `~/m3-retention/d125/`; primary final
> manifest `d125_manifest_final.json` at SHA-256 `1366a5dd…3a9c`; **the external RETENTION copy was
> verified byte-identical to the internal record.** exFAT's metadata limits are answered by **PAX
> metadata plus explicit manifests, per-file hashes, and recorded
> `mode`/`uid`/`gid`/`owner`/`group`/`path`/`type`/`size`/`mtime`/symlink metadata** — the manifest is
> the authority for what the filesystem cannot hold.
>
> **The internal copies listed in D125 are retired — and only after verification passed.** Exactly
> five roots: the D117, D120, D122-F1, and D123 canary worlds under `~/m3-disposable-canaries/`, plus
> `~/m3-perf-experiments`. **The ordering is the governance point** — D124-R7 permitted removal only
> after external verification, and that is the order that occurred. **The verified external archives
> now stand as the preserved evidence.** Still internal and protected: `~/m3-private-evidence`, the C3
> `m3_3_perf_c3_local_40k_v1` world, `~/m3-d117-diagnostics`, `~/m3-retention/d125`, the repository,
> the current raw SEC source, and the operational catalog.
>
> **The reclamation is measured, and the model held.** Reclaimed **`66,289,078,272` bytes =
> `61.7365 GiB`** against the Decision 124 §12 clone-aware prediction of about `61.77 GiB` — **the
> model is confirmed to about `0.03 GiB`**, measured from statvfs free-block change rather than `du`,
> because D120 and D122 shared APFS extents.
>
> **The `105 GiB` gate is NOT met (D125-R5).** Settled internal free **`104,500,830,208` bytes =
> `97.3240 GiB`** against the controlling D124-R5 gate of `112,742,891,520` bytes = `105 GiB` —
> **a remaining hard gap of `8,242,061,312` bytes = `7.6760 GiB`**. A **measurement condition** is
> stated rather than smoothed: three readings of the live APFS volume spread about `17 MB`, about
> `0.016%`, and **all three fall short by about the same `7.68 GiB`**. **Approximately `110 GiB` is an
> owner preference if ordinary cleanup makes it easy — it is NOT the formal gate. The formal admission
> predicate remains `>= 105 GiB`** (D125-R6).
>
> **No further Disclosure Drift evidence may be deleted for capacity (D125-R3).** The retirement is
> **spent**, and the preserved material stays preserved. **The external `SSK SSD` remains cold/archive
> storage only — no active governed SQLite use, no reformat** (D125-R4).
>
> **Residue, recorded truthfully (D125-R8).** Two **historical consumed** E0 namespaces —
> `m3_3_e0_offline_parse_v1` and `m3_3_e0_offline_parse_v2` — and a stale `catalog_writer.lease`
> remain under the private evidence root. **D125 did not modify any of them.** **Their mere existence
> is not a new E0 namespace** — a consumed namespace is spent, not available, and **no E0-v3 authority
> exists** — and **they must be explicitly checked during the final pre-complete-source safety
> preflight**. Two idle historical `tmux` servers held no project handles.
>
> **One obligation is carried forward rather than closed.** The Decision 124 §4 stored-object naming
> reconciliation — `c85744be921b0dc5` versus the older object named at Decision 059 §3 — is
> **outstanding**, because the D125 instrument is scoped to archival and reclamation. **No reader may
> cite D125 as having closed it.**
>
> **D125 supersedes nothing.** Decisions 121, 122, 123, and 124 stand as written, and the D124-R5
> gates carry forward intact. **All three activation constants are `None`**, the operational catalog
> stays at migration head `0015`, migration `0016` is absent, no E0-v3 namespace exists, and both
> tracked network switches stay `false` at request ceiling `0`.
>
> **Real state is untouched by this publication.** Documentation only: no source code, no test, no
> schema, and no migration changed; no database was opened; no governed SQLite writer was opened;
> nothing was archived, copied, moved, or deleted **by this publication**; nothing was written to the
> external SSD; and no owner-acceptance token was emitted by the publishing session.
>
> **The next action is ordinary non-project storage top-up chosen by the user, followed by a final
> live M3.3 complete-source preflight. Crossing the disk threshold authorizes nothing by itself
> (D125-R7). Complete source is NOT authorized. E0 is NOT authorized.**

> **CONTROLLING CURRENT POSITION, 2026-08-20 (LATEST) — accepted
> [Decision 124](../Docs/Decisions/decision_124_m3_3_capacity_reconciliation.md), outcome
> `M3_3_D124_CAPACITY_RECONCILIATION_OWNER_ACCEPTED_WITH_CORRECTION`, closing both
> [Decision 123](../Docs/Decisions/decision_123_m3_3_f2_bounded_characterization.md) §9 conflicts.**
>
> **Read this first: this is a capacity reconciliation, not an execution authorization.** It closes
> two conflicts, retires two figures from current planning, sets the complete-first-source
> free-space gate, and approves an external volume **in principle** for archival use. **A record
> that resolves a capacity question is not a grant to spend the capacity.** No complete source, no
> E0, no F1, no F2, no canary, **no archival, no copy, and no deletion**.
>
> **Conflict A is closed — the governed member count (D124-R1).** The older
> `sec_bulk_submissions-9ca4642200dbcc45.zip` holds `985,480` raw entries and **`985,479`** governed
> JSON members; the current controlling `sec_bulk_submissions-c85744be921b0dc5.zip` holds `985,835`
> raw and **`985,834`** governed. Each carries **exactly one** non-JSON `placeholder.txt`, so the
> governed-member rule is identical across them and the `355`-member difference is **two different
> SEC snapshot objects — not a filter, a parser, or a code discrepancy**. **`985,834` is FINAL**
> controlling; **`985,479` is `SUPERSEDED-BY-OBJECT`, not erroneous** — Decision 111 §5 and
> Decision 112 §6 correctly counted what they measured.
>
> **Conflict B is closed — the storage contract (D124-R2).** The Decision 112 §6 about-`132.5 GB`
> figure is `e0-compact-evidence/1`, whose **resolution layer is still uncompacted**; Decision 113's
> `e0-compact-evidence/2` **additionally compacts resolution and derived evidence**. They are
> **successive evidence contracts, not contradictory predictions of one implementation** — the later
> figure is smaller because the contract **writes less**. `/2`, calibrated by D118 and by the later
> real D120, D122, and D123 evidence, controls. **Decision 112 is not retired as historical
> evidence** — only its use as *current planning capacity* is, and
> `src/disclosure_drift/m3/capacity_plan.py` is untouched.
>
> **One error is published rather than inherited (D124-R4).** Over Decision 122 §5's `8,258,521`
> accessions: `638,071 / 8,258,521 = 0.077262` is the **explicit-accession fraction**, about
> **`7.73%`**; `5,104,568 / 8,258,521 = 0.618097` is **field-resolution *rows* per accession**,
> because one explicit accession can emit **multiple** field rows. The D124 technical review read the
> second as the first — wrong by roughly a factor of eight. **The claim that `61.8%` of accessions
> were explicit is not published; no claim that the tail becomes more implicit is published; and
> linear F1 byte extrapolation is not characterized as "conservative-high" on that basis.** The
> linear F1 central projection survives because it rests on **measured bytes per accession**.
>
> **The accepted capacity model — planning estimates, not complete-source observations.**
> Materialization durable about `54.62 GB`; compact sidecar about `0.27 GB`; F1 durable growth about
> `9.40 GB` at about `1.33 h`; F2 durable growth about `6.59 GB` with a pre-checkpoint write-ahead
> log of about `9.52 GB`, about `2.04 h` wall, about `0.68 GiB` resident set; central peak about
> **`75.27 GiB`**, conservative modeled peak about **`89.27 GiB`**. **Scope is the complete FIRST
> SOURCE only — this is not 76-source E0 capacity evidence.** Population: **`21,508,823`** distinct
> accessions central, band `21.50 M`–`21.55 M`, a model input rather than an observation (D124-R3).
>
> **The gate is `>= 105 GiB` = `112,742,891,520` bytes (D124-R5)**, superseding the reviewer's
> recommended `100 GiB`. About `110 GiB` is preferable headroom, **not a second authorization
> predicate**. In flight: a continuous hard-stop floor of **`10 GiB`**, and **`>= 30 GiB` measured
> immediately before opening F2 — below that, F2 must not begin**. **No `VACUUM`**, and SQLite
> temporary storage must be explicitly placed and accounted on the internal run volume. **The
> Decision 121 §7 `>= 85 GiB` floor is SUPERSEDED, not merely suspended.**
>
> **The external SSD is approved in principle as archival storage only (D124-R6).** `SSK SSD`,
> `500 GB` nominal, about `499.94 GB` / `465.61 GiB` free at observation, USB SuperSpeed+ at about
> `10 Gbps` visible, filesystem **exFAT**, user-reported sequential capability about `1050 MB/s`
> **which was not independently benchmarked**. **Active SQLite use is NOT approved**; reformatting is
> neither approved nor required; **no categorical claim is made about whether SQLite can technically
> operate on exFAT**; Plan B is unnecessary and **NOT APPROVED**; and the **internal APFS Apple SSD
> remains the intended active working volume**.
>
> **Retention: eligibility is not authorization (D124-R7, R8, R9).** D117, D120, D122, the D123
> characterization residue, and disposable performance material become eligible **under a later
> archival instrument**, and **only after external verification may authorized internal copies be
> removed**. C3's retained about-`10 MiB` evidence and tiny diagnostics stay internal. The D122
> post-F1 catalog **requires a fresh SHA-256**: the historical candidate `fa4a635d…9413` is **not yet
> accepted durable identity**, so the instrument must **hash the actual catalog, compare, stop on
> mismatch, and record the identity before deletion**. Because exFAT does not preserve all relevant
> POSIX metadata, the archive must carry an explicit cryptographic/metadata manifest and/or a
> metadata-preserving container.
>
> **Plan A does not open a complete-source run (D124-R10).** About `61.77 GiB` reclaim plus about
> `36.70 GiB` free projects to about `98.46 GiB` against the `105 GiB` gate — short by about
> **`6.54 GiB`**. Before any complete-source authorization: **archival complete, authorized internal
> copies reclaimed, internal free space MEASURED at `>= 105 GiB`** — measured, not projected — **and
> all other preflight predicates passing**. **E0 remains NOT AUTHORIZED**, and the D124 observations
> about possible 76-source storage are **non-governing**.
>
> **The ruling-number collision is closed going forward, not repaired backward (D124-G1, G2, G3).**
> Decision 094 R70–R78 and Decision 123 R70–R78 are **both historically immutable** and **neither is
> renumbered**; every future reference to a colliding ID must **name its decision**; and from
> Decision 124 onward new owner rulings use **decision-scoped IDs** — `D124-R1`, `D124-R2`, and so on.
>
> **All three activation constants are `None`**, the operational catalog stays at migration head
> `0015`, migration `0016` is absent, no E0-v3 namespace exists, and both tracked network switches
> stay `false` at request ceiling `0`.
>
> **Real state is untouched by this publication.** Documentation only: no source code, no test, no
> schema, and no migration changed; no database was opened; no governed SQLite writer was opened; no
> world was created, opened, modified, archived, copied, or deleted; nothing was written to the
> external SSD, which was a **read-only discovery**; and no owner-acceptance token was emitted by the
> publishing session.
>
> **The next technical and operational stage is D125 — archival plus verified internal reclamation.**

> **CONTROLLING CURRENT POSITION, 2026-08-20 (LATEST) — accepted
> [Decision 123](../Docs/Decisions/decision_123_m3_3_f2_bounded_characterization.md), outcome
> `M3_3_D123_F2_BOUNDED_CHARACTERIZATION_OWNER_ACCEPTED`, classification
> `F2_MATERIAL_BUT_ACCEPTABLE`, over accepted
> [Decision 121](../Docs/Decisions/decision_121_m3_3_finalization_feasibility_preflight.md) and
> [Decision 122](../Docs/Decisions/decision_122_m3_3_d120_f1_finalization_characterization.md).**
>
> **Read this first: the full-population F2 execution did not run.** It was **refused at the
> storage preflight**. No F2 transaction was opened against the preserved D122 F1 world, no
> association projection was written into it, no §9.5 totality check ran against it, and **no
> completion artifact exists**. **Nothing below may be cited as a completed full-population F2
> run**, and nothing below is one.
>
> **What is accepted is a bounded real F2 characterization**, scoped to the
> **first-source-canary association-finalization shape only**: real F2 —
> `materialize_census_associations(..., compact_evidence=True)`, whose **one transaction spans both
> traversals and the totality check**, the Decision 094 §§6.2–6.4 and §9.5 correctness property —
> executed against **production-schema disposable projections** at `25k`, `50k`, `100k`, `200k`,
> `400k`, and `800k` accessions, plus **read-only and probe** measurement against the full about
> `23.5 GB` D122 world.
>
> **The scaling result is a negative one, and it is the important one.** Fitted exponents: wall
> **`b = 1.0053`** at **`R^2 = 0.99986`**, write-ahead log `0.9748`, durable database growth
> `0.9996` — all at or just below linear, so **no `N x M` / quadratic mechanism was found**, and
> repeated probes use the accepted indexes. The `200k` rung repeated three times spread about
> **`1.40%`** in wall time with **byte-identical** write-ahead-log and database-growth byte counts,
> and peak resident set plateaus at about **`0.68 GiB`** without climbing with size.
>
> **Database size costs a bounded constant, not an exponent.** Read-only against the preserved
> about `23.5 GB` D122 catalog: **`600,000` real groups** at **`136.32 us` per group**, and moving
> from the about `2 GB` projections to the full world — roughly twelvefold — costs about
> **`1.36x`**. That is what rules out the Decision 118 §1 database-size-dependent collapse
> mechanism **for this shape**.
>
> **Projected at D120 scale — projected, not measured:** wall central about **`0.78 h`** (primary
> `0.74`–`0.82 h`, outer `0.63`–`0.94 h`); pre-commit write-ahead log about **`3.487 GiB`**;
> durable database growth about `2.358 GiB`; peak resident set about `0.68 GiB`. **Material**
> because that log is real and multi-gibibyte — about `3,113x` the `1.12 MiB` F1 peak Decision 122
> §5 measured, the F1/F2 asymmetry Decision 121 §4 predicted from the transaction structure —
> and **acceptable** because it is nowhere near the Decision 118 §2 `>= 169.61 GiB` regime.
> **Owner conclusion: no F2 architecture remediation is required for the first-source-canary
> shape**, and the existing single-transaction architecture is retained (Decision 123 R70, R72).
>
> **The scope limits are part of the finding, not a caveat on it.** About **`92.7%`** of the D120
> population remains **extrapolated** for wall time; the measured ladder tops out at `800,000`
> accessions, about `9.7%` of the `8,258,521` accepted D120 count; **every complete-first-source
> number is extrapolation, not evidence**; this characterizes **nothing** about the full 76-source
> E0 finalization shape, per the Decision 121 §5 limit; and **established / completeness-write
> behaviour was never exercised at all**, because the first-source shape **lacks full-index
> evidence** so those code paths were never reached.
>
> **F2 no longer blocks the first-source-canary architecture. The capacity model is now the
> blocker.** D123 exposed two conflicts and **resolved neither**. **Conflict A — the governed
> member count**: real D117/D120 enumeration and Decision 110 §7 give **`985,834`**, the older
> D111/D112 basis (Decision 111 §5, Decision 112 §6) gives `985,479`, and the D123 report cited the
> older figure — **`985,834` is the provisional controlling real count and `985,479` is stale and
> unresolved**, pending a D124 trace (Decision 123 R75). **Conflict B — complete-source storage**:
> D123 cited the older Decision 112 §6 about `132.5 GB` figure while later accepted work carries
> materially different compact-capacity figures (Decision 113 §15 and §19, and the Decision 118 §5
> (R24) *strained but not invalidated* finding). **This publication does not choose between them.**
> **The prior `>= 85 GiB` complete-source free-space floor from Decision 121 §7 is SUSPENDED
> PENDING D124** (Decision 123 R74) — **neither met nor lowered** — and **no complete-source run
> may be authorized using the unresolved figures**.
>
> **A numbering condition is published rather than silently fixed.** Decision 094 §§6–9 already
> carries rulings numbered R70–R78 with entirely different content. The Decision 123 numbers were
> issued by the owner and are recorded **exactly as issued**, because a publication does not
> renumber an owner ruling. **Every citation in that range must name its decision** — "Decision 123
> R72", never "R72" alone. Resolving the numbering is a D124 governance question.
>
> **What is preserved.** The D117, D120, and D122 worlds **and the D123 disposable
> characterization residue** are all preserved through D124 (Decision 123 R76, R77). **No deletion
> of any kind is authorized.**
>
> **The next technical stage is D124 — capacity and model reconciliation — and it is not executed
> and not authorized here.** This position records **owner sequencing only**. **The next authorized
> technical action is not a complete-source run and not E0**, and both remain unauthorized along
> with the full-population F2 rerun (Decision 123 R71), the D117 retry, the three-source canary,
> the real replay proof, migration `0016`, network, and acquisition. All three activation constants
> are `None`, the operational catalog stays at migration head `0015`, migration `0016` is absent,
> no E0-v3 namespace exists, and both tracked network switches stay `false` at request ceiling `0`.
>
> **Real state is untouched by this publication.** Documentation only: no source code, no test, no
> schema, and no migration changed; no database was opened; no world was created, opened, modified,
> or deleted; and no owner-acceptance token was emitted by the publishing session.
...
> outcome `M3_3_D116_DISPOSABLE_SINGLE_SOURCE_EXECUTION_PATH`, superseding the capacity
> disposition [Decision 113](../Docs/Decisions/decision_113_m3_3_compact_derived_e0_evidence.md)
> §15 recorded and answering the execution-path gap D115 stopped on.**
> **Decision 116 grants no execution authority.** All three activation constants are `None`,
> migration `0016` is unapplied, no E0-v3 namespace exists, and nothing below reopens any of them.
>
> **The capacity blocker is cleared, on this host (R6).** Measured available about `107.09 GiB`
> against about `90.54 GiB` required — projected working state about `69.33 GB`, overhead about
> `1.05 GB`, the governed 25 GiB reserve, a projected remaining reserve of about `41.54 GiB`, and
> shortfall `0` — under requirement identity
> `791618e03a8ed6028d6b0ba70f1fca4473d2434b52e99ec1ddddaec97dba2b31`, which
> `src/disclosure_drift/m3/capacity_plan.py` reproduces term for term. The classification
> `LOCAL_CAPACITY_INSUFFICIENT_AFTER_D113` is no longer the active host blocker. **That is not
> E0-v3 authorization**, and Decision 113's own compaction ruling is unchanged.
>
> **D115 closed without executing (R7).** No disposable world was created, no execution command
> was constructed, and no real source was parsed. Its authorization is closed and may not be
> reused; a real-canary authorization will be issued only as a new owner instrument.
>
> **What stopped it, and what closes that (R8).** The reachable production driver loads the whole
> plan, traverses every planned source, defaults to full evidence, and wires no Decision 112 §8
> sidecar — so there was no supported way to run exactly one governed source under
> `e0-compact-evidence/2` and be *relied on* to stop. The path that closes it is additive and
> canary-only: the `m3 canary-source` operator surface over
> `src/disclosure_drift/m3/single_source_canary.py`, plus a one-source entry point beside the
> accepted whole-plan driver. It selects one `census_plan_sources` row by `source_instance_id` and
> refuses an absent or ambiguous one, takes no path argument, opens the accepted catalog strictly
> read-only on every path and takes no writer lease on it, builds a Decision 111 run-local working
> catalog inside a create-once disposable world beneath an operator-supplied work root refused
> unless it lies outside both the checkout and the private evidence root, binds the compact
> contract **explicitly**, emits the accepted member manifest, projection digest,
> `ResolutionDigest`, `CorroborationDigest`, and compact-evidence identity, **terminates after
> that one source**, promotes nothing, applies no migration, and touches no E0 authority constant
> and no E0 run namespace.
>
> **It is implemented and proved, and it is not accepted.** This position records readiness for
> owner review only. No acceptance, no green gate, no local commit, and no cleared capacity
> constitutes owner acceptance of the path or authorization to run a real source.
>
> **Real state is untouched.** No real SEC source was parsed, no D115 run identity or world was
> created, the accepted operational catalog is unchanged at migration head `0015`, the private
> evidence root received no write, and the frozen source artifacts are unchanged.

> **CONTROLLING CURRENT POSITION, 2026-08-18 (LATEST) — accepted
> [Decision 113](../Docs/Decisions/decision_113_m3_3_compact_derived_e0_evidence.md), outcome
> `M3_3_D113_COMPACT_DERIVED_EVIDENCE`, answering the two costs
> [Decision 112](../Docs/Decisions/decision_112_m3_3_compact_e0_evidence_contract.md) §7
> measured and did not reach.**
> The accepted D112 candidate `3a17c5d` is published to `origin/main`. **Decision 113 grants no
> execution authority**; all three activation constants are `None` and none is reopened below.
>
> **The ruling.** D112's own principle — persist an entry only where it carries information the
> canonical row does not already carry — now reaches the two layers it did not. A **Decision 012
> resolution row is not persisted** when its complete governed content is a deterministic pure
> function of already-persisted canonical evidence, and a **`company.idx` row that corroborates
> an already-canonical accession** is represented by the parsed record the traversal already
> wrote. The physical number of resolution and corroboration rows may differ; the logical
> governed result may not.
>
> **Why it is safe.** The omission is decided by **comparing whole resolutions**, never by a list
> of cases: `is_default_resolution` compares the resolution the resolver produced against the one
> the reader will rebuild, so a competing value, a conflict, ambiguity, a malformed alternative,
> an authority-level choice, a prior-cohort history, and an approved 2024 transition each make
> the two differ and are each materialized without needing their own clause. `submitter_cik` and
> `amendment_relationship` are `absent` for 100 % of accessions because no source-native name
> maps to either, so the contract states that once as source-class metadata — and deliberately
> **not** as a special case, so an accession that unexpectedly carried one is still materialized
> by the general rule. Cohort resolution takes the same rule and is omitted or materialized
> **together** with the field resolutions. A full-index row that disagrees, adds a co-registrant,
> is malformed, or meets a canonical value not yet established stays explicit: a disagreement is
> never compacted into a boolean.
>
> **What binds it.** Contract `e0-compact-evidence/2` — a strict superset of `/1`, whose version
> string is retained and never reused. A **resolution-completeness digest** over the full logical
> result, implicit and explicit alike, which physical omission cannot move. A **corroboration
> digest** over every assertion and its disposition, folding each row's `record_sha256` over the
> **complete** raw row, so the dropped `raw_line` stays bound rather than merely undetectable.
> Both live in the versioned run-local sidecar and both enter its identity; migration `0016`
> stays reserved and the operational catalog stays at head `0015`.
>
> **The capacity predicate is corrected (§19).** The E0 preflight asked for three copies of the
> *current* catalog plus a gibibyte. The current catalog is the pre-E0 one, so that admitted any
> host with about 2.1 GB free while a complete execution needs two orders of magnitude more. The
> requirement is now computed from measured densities and the planned work, its identity digests
> every term, and a catalog whose source plan does not fingerprint identically to the plan the
> densities were measured over is refused rather than answered from a stale projection.
>
> **The verdict.** The complete 76-source working state projects to about 69.3 GB against 85.8 GB free, leaving a projected reserve of 14.36 GiB against the 25 GiB Decision 113 §15 requires - short by 11.4 GB. The same projection under Decision 112's contract was about 186.5 GB, so the compaction removed 63 % of it and would have cleared D112's own 15 GiB bar; it does not clear the 25 GiB bar raised for actual v3 authorization. The first-source canary, the three-source canary, and
> the real replay proof were **not run**, and §15 forbids further semantic compaction once the
> projection fails. **The next owner action is additional local storage, not another evidence
> redesign.**
>
> **Real state is untouched.** The accepted operational catalog was opened strictly read-only and
> `immutable=1` on every path; its bytes, digests, migration chain at head `0015`, write-ahead
> log, and writer lease are unchanged, v1 and v2 and the backups are unchanged, and no v3
> namespace exists.

> **CONTROLLING CURRENT POSITION, 2026-08-18 (LATEST) — accepted
> [Decision 112](../Docs/Decisions/decision_112_m3_3_compact_e0_evidence_contract.md), outcome
> `M3_3_D112_COMPACT_E0_EVIDENCE_CONTRACT`, answering the MAJOR
> [Decision 111](../Docs/Decisions/decision_111_m3_3_e0_bounded_persistence_and_working_catalog.md)
> §5 returned.**
> Both records now exist, closing the numbering gap at 111: the D111 remediation had been carried
> only by its commit message, and D111 §§2–5 now carry it from `Docs/Decisions/`. The accepted D111
> candidate `ab4398a` is published to `origin/main`. **Decision 112 grants no execution authority**;
> all three activation constants are `None` and none is reopened by anything below.
>
> **The ruling.** For E0 the frozen immutable source artifact is the authoritative complete raw
> evidence, so **one SQLite row per ordinary raw field observation is no longer required**. The
> ruling is deliberately limited to E0 successor execution: it rewrites no historical M2 acquisition
> evidence and reaches no table other than `census_accession_observations` and
> `census_parsed_records`.
>
> **The contract, and why it is safe.** An accession field observation is omitted only when it is
> *inert* or *exactly reconstructible*. `CANONICAL_FIELD_BY_SOURCE_FIELD` is the complete set of
> source-native names any accepted consumer reads — Decision 012 resolution drops every other name
> before looking at it and the Decision 094 §6.2 membership projection selects only `cik` and
> `cik_padded` — so roughly eleven of every seventeen rows were written, read back, and discarded.
> For the rest, `census_accessions` already stores the governed value together with the provenance
> triple the observation carried, and the observation identifier is a pure function of those, so
> where the raw value round-trips through the canonical column exactly the row duplicates it.
> **Everything that does not round-trip is materialized**: a malformed date, a value normalisation
> would rewrite or drop, a blank membership rendering, and every governed field of a second or
> competing witness. **An incumbent is back-filled before any rival**, because the accepted conflict
> pass marks a row only when it can see a sibling that differs — writing the newcomer alone would
> leave a disagreement with one side missing. The accession-class parsed-record payload, which is
> read by nothing, is projected to the governed fields and labelled `__evidence_contract__`, with
> `record_sha256` still over the complete raw record so identity does not move. A **versioned
> run-local sidecar** carries the member manifest and the completeness digest; migration `0016`
> stays reserved and the working catalog stays a byte-for-byte schema twin of the operational one.
>
> **What was proved, and how.** Equivalence is asserted row for row over twelve governed tables,
> including the field resolutions' winning and competing observation identifier lists — the sharpest
> part, because those name observations the compact catalog never stored — with observation rows
> asserted a **strict subset** so a compact path that wrote a *different* row fails even if it wrote
> the same number. Sufficiency is proved by **removing the fallback**: the D093 §6 resolver runs
> against a connection whose authorizer denies `census_accession_observations` and
> `census_parsed_records` outright, and the denial harness is itself tested. Replay is proved across
> two separately built worlds sharing no object. Two mutation proofs require the equivalence to
> break when exception rows are omitted and when the reconstruction is made lossy.
>
> **What it bought, measured on real data.** `census_accession_observations` falls from a projected
> 204.2 GB to **110.5 bytes per accession**, about **2.4 GB** for the whole first source — a
> **98.8 %** reduction with every conflicting, malformed, ambiguous, and second-witness row retained.
> Growth is **linear**: 3.185× the bytes for 3.124× the accessions across a 3.1× scale-up. Peak RSS
> is flat at 1.07→1.09 GiB against a 2.5 GiB ceiling, and the write-ahead log peaked at 288.6 MB and
> checkpointed to 0.
>
> **What it did not buy.** The complete 76-source working state still projects to about **186.5 GB
> against 86.3 GB free**, failing the ≥15 GiB reserve **on source 1 alone**. The canaries were
> therefore not run. The resolution layer is now **67.7 %** of everything E0 persists and is outside
> this ruling; Decision 112 §7 states it and the full-index corroboration layer with measured costs.
>
> **Real state is unchanged.** The operational catalog is byte-identical at 359,378,944 bytes with
> file digest `57e36a78…`, migration chain `1..15` at head `0015`, a 0-byte write-ahead log, a
> `released` lease, all 76 sources `not_started`, `census_parser_runs` empty, and no v3 namespace.
> Every real read was strictly read-only.

> **CONTROLLING CURRENT POSITION, 2026-08-18 (LATEST) — accepted
> [Decision 110](../Docs/Decisions/decision_110_m3_3_e0_successor_safety_remediation.md), outcome
> `M3_3_D110_E0_SUCCESSOR_SAFETY_REMEDIATION`, on the two MAJOR findings accepted by
> [Decision 109](../Docs/Decisions/decision_109_m3_3_e0_v2_interruption.md).**
> Both records are now committed, closing the numbering gap at 109: the E0-v2 interruption
> acceptance had been carried only by this file, and D109 §§2–4 now carry it from
> `Docs/Decisions/`. **Decision 110 grants no execution authority**; all three activation constants
> are `None` and none is reopened by anything below.
>
> **Workstream A (D109 F2) is closed.** The defect was that ordinary `CatalogWriter` acquisition
> overwrote a persisted stale `held` lease as soon as it won a *free* advisory `flock`, and did so
> **before** the create-once predicates refused the attempt — which is how the v2 run's lease was
> destroyed 3.96 seconds after the jetsam kill. The two signals disagree by construction: `flock`
> lives on the open file description and the kernel drops it the instant a process dies, so every
> SIGKILL-class death leaves the lock free and the document still recording `held`. Acquisition now
> reads any pre-existing document through the **production strict reader** before writing one byte,
> and proceeds only on an **absent** lease or a structurally valid one recording exactly
> `released`. A `held` lease refuses whatever the recorded pid, whatever the expiry, and whatever
> the lock says — each of those was a reason the old code felt safe, and each is true of every
> jetsam residue. Malformed, torn, oversized, unknown-field, and unknown-state documents refuse
> too. **Every refusal is proved on the bytes**, not on the exception. Converting `held ->
> released` remains the governed
> [Decision 103](../Docs/Decisions/decision_103_m3_3_e0_interruption_recovery.md) §3 (R3)
> reconciliation's job alone, and it still works end to end: a stale lease refuses ordinary
> acquisition, the governed recovery converts it with provenance intact, and the ordinary writer
> then acquires normally. A fail-fast create-once namespace check now runs **ahead of** lease
> acquisition so a doomed repeat never opens the lease for writing at all; it is deliberately
> **not authoritative** and the under-lease recheck remains, separately tested against the race.
> **Two pre-existing tests asserted the defect as correct behaviour** —
> `test_old_metadata_without_a_held_lock_is_safely_recovered` and
> `test_process_termination_releases_the_advisory_lock` — and were rewritten to assert the
> invariant; a bounded mutation proof restores the old overwrite and requires the new regression to
> die.
>
> **Workstream B (D109 F1): the memory MAJOR is closed on measured evidence, and a different
> blocker is now the barrier.** The root cause was measured before any parser edit. E0's first
> planned source is a 1.56 GB archive of **985,834** JSON members expanding to **5.71 GB** and
> parsing to roughly **22.5 million** records and **1,976,418** structural observations, and
> `_parse_bulk_submissions` materialized every member *and* every member's outcome before
> persisting any of them, after which `merge_outcomes` copied all of it again — **92,639 bytes
> retained per member** across a bounded 20,000-member prefix, about **91 GB** extrapolated, while
> the identical streamed traversal held traced memory **flat at 859.6 MB** from 5,000 to 20,000
> members. That flatness is what identifies the accumulation rather than the traversal as the
> cause. Two further unbounded classes sat on the same call. First, run-level structural state:
> **1.46 GB** retained and **1.35 GB** rendered into one `census_parser_runs.summary_json` cell,
> which **exceeds SQLite's `SQLITE_MAX_LENGTH` of 1,000,000,000 bytes** — so the merged shape could
> never have produced a valid row for this source at any memory budget, an independent hard failure
> the kill had been masking. Second, preloaded whole-catalog structures downstream of the parse: a
> set of every `accession_plain` (~2.9 GB), a blocking-field map over ~43 M entries, one tuple per
> established accession (~2.9 GB), a per-accession cardinality map, and one `AccessionResolution`
> per accession built for a caller that reads only the count. **All are now bounded**, and the
> archive's own central-directory index — 1.07 GB RSS, flat, required by the accepted Decision 051
> §4.1 defences — is recorded rather than removed.
>
> **The measured result on real data (D110 §10 canary, disposable state only):** peak
> diagnostic-process RSS **0.864 GiB** against the owner's **2.5 GiB** ceiling, versus the **33.9
> GB** the kernel killed. **The measured blocker that replaces it:** the run did not reach member
> 50,000 in 20 minutes — persistence below **42 members/second** against **766–1,600** for
> traversal alone — and its single uncommitted transaction had grown a **3.85 GB** write-ahead log,
> which extrapolates past the **77 GB** of free disk before the source would finish. Per §10 the
> disposable process was terminated at the ceiling, the state recorded, and work stopped; per §11
> the three-source canary was **not** run, because §11 gates it on a first-source canary that
> passes. **No further optimization is authorized without an owner ruling.**
>
> **Real state is byte-identical before and after every diagnostic**, measured rather than assumed:
> catalog file digest and byte length, catalog logical identity, observation-set identity, WAL at 0
> bytes, migration chain `1..15` at head `0015` with `0016` absent, all three integrity gates, the
> v1 and v2 ledgers and backups, the writer lease, and all three authorities at `None`. **No
> diagnostic created a real E0 run namespace**, and none touched the operational catalog.
>
> **One output change is disclosed and awaits owner ratification (D110 §8.2).** A streamed run's
> `summary_json` keeps every key with every value computed by the same rule, except `structural`,
> which holds the **blocking** observations only, bounded at 1,000, alongside a self-describing
> `structural_detail` key naming the scope, the observed and blocking totals, the retained count,
> the limit, and the table holding the full detail. No detail is lost — every observation is
> already persisted individually in `census_structural_observations`, and the summary's copy was
> always a duplicate — and no existing fixture pins the array. It is recorded here rather than
> absorbed silently because `census_parser_runs` is governed state.

> **CONTROLLING CURRENT POSITION, 2026-08-17 — the one authorized real M3.3-E0 (v2)
> execution STARTED, was INTERRUPTED, and its grant is SPENT.**
> The single `disclosure-drift m3 offline-parse --config configs/project.yaml --mode execute`
> [Decision 108](../Docs/Decisions/decision_108_m3_3_e0_v2_execution_authorization.md) §2 (R120)
> authorized was invoked **exactly once** through the governed operator surface, and it did not
> complete. **Durable v2 state, measured rather than inferred:** the namespace
> `m3_3_e0_offline_parse_v2` is a real non-symlinked directory holding exactly `e0_events.jsonl`
> and `pre_e0_catalog_0015.sqlite3`; the event ledger is **chain-valid** with sequences `1, 2`
> continuous and types `PREFLIGHT_PASSED` → `BACKUP_VERIFIED`; there is **no** terminal record,
> **no** execution receipt, and **no** closing event; and the governed verifier classifies the run
> **`UNDETERMINED / NOT COMPLETE`** at exit `4`. It is **not COMPLETE, not FAILED, and not durably
> INTERRUPTED** — no `INTERRUPTED` or `FAILED` event was ever written, because the process ran no
> handler. **The last safely durable boundary is `BACKUP_VERIFIED`**, and the run died in the
> `during_e0_source_parse` window **before any per-source commit boundary became durable**.
>
> **The catalog is provably unchanged (boundary A — before any catalog mutation).** File SHA-256
> `57e36a78…` at `359,378,944` bytes with an mtime still at the 2026-08-16 transition completion; a
> **0-byte** write-ahead log; migration chain exactly `1..15` at applied head `0015` with `0016`
> **absent**; `quick_check` ok, `integrity_check` ok, foreign-key violations `0`; accepted catalog
> logical identity `5c823d21…` **MATCH** and accepted observation-set identity `b1122bb9…`
> **MATCH**; all **13** precondition tables at `0` rows; all **76** `census_plan_sources.parser_state`
> still `not_started`; `census_parser_runs` count `0`. The v2 backup is present and verified —
> `359,378,944` bytes, file SHA-256 `00a808ab…`, logical digest equal to the accepted pre-E0
> identity and to its own `BACKUP_VERIFIED` event, and **byte-identical to the v1 backup**.
>
> **Termination cause is established, not guessed.** The ordinary macOS unified log records the E0
> process as `python3.12` **PID 67381**, started `2026-08-17 20:40:46.287` EDT and terminated by the
> kernel at `2026-08-17 21:44:13.694` EDT with
> `memorystatus: killing largest compressed process Python [67381] 33911 MB`, 1.4 s after
> `memorystatus: System is unhealthy` with `swap_low: 1`. That is a **kernel memory-pressure
> (jetsam) kill of the largest compressed process** on an 8 GiB host — SIGKILL-class, running no
> Python `except`/`finally`, which is precisely why no terminal, receipt, or closing event exists.
> It was **not** disk space (17 GiB free), **not** an I/O error, and no crash or jetsam report names
> the process.
>
> **The stale lease the kill left behind is unrecoverable, and the current lease is not its
> evidence.** `CatalogWriter` overwrites the lease document whenever it can take the free advisory
> `flock`, so the post-kill attempt overwrote it **3.96 s later**. The persisted lease now records
> `released`, is structurally valid through the production reader, leaves the exclusive writer lock
> available, and names a dead pid `68482` — all of which describe **that refused attempt**, which
> acquired at `01:44:17.650826Z`, passed the full under-lease recheck of every mutable predicate,
> was refused by **create-once namespace gating**, and released at `01:44:33.497032Z`. It did not
> restart E0 and wrote no catalog byte; its passing recheck is independent corroboration that the
> catalog was already unmutated.
>
> **§5 (R122) is applied.** `M3_3_E0_EXECUTION_AUTHORITY` is back to `None` and the spent D108
> literal is retained nowhere in `src/disclosure_drift/m3/e0.py`;
> `PRE_E0_CATALOG_TRANSITION_AUTHORITY` **remains** `None`; `STALE_WRITER_LEASE_RECOVERY_AUTHORITY`
> **remains** `None`. All three governed execute surfaces ship **disabled**. R122 requires the
> withdrawal on the invocation's return **whether COMPLETE or not**, and an interrupted run is
> exactly the case it was written for. **§6 (R123)'s R52 linkage diagnostic does not run**: it is
> conditioned on a COMPLETE and independently verified E0-v2.
>
> **The v2 evidence is preserved exactly as measured** and must not be deleted, renamed, edited, or
> normalized; **v1 is untouched** and remains permanently `UNDETERMINED / NOT COMPLETE`. **No
> successor is designed, implemented, or authorized here.** A v3 run needs **both** a new owner
> instrument **and** a reviewed source change, exactly as
> [Decision 103](../Docs/Decisions/decision_103_m3_3_e0_interruption_recovery.md) §3 (R105) requires
> and exactly as the v1 interruption already required once. One risk is **carried, not acted on**:
> the interrupted run held ~33.9 GB of compressed memory after 63 minutes without completing a
> single one of its 76 planned sources, so a v3 attempt on this host would likely die the same way.
> That is a finding for the owner; it authorizes no fix, profiling change, or design change.

> **THE AUTHORIZING POSITION, PRESERVED, 2026-08-17 — accepted [Decision 108](../Docs/Decisions/decision_108_m3_3_e0_v2_execution_authorization.md), outcome `M3_3_D108_E0_V2_EXECUTION_AUTHORIZED`.**
> **Exactly one real M3.3-E0 (v2) execution is AUTHORIZED, and it is the only execute surface open.**
> The Decision 107 real stale-writer-lease recovery is **owner-accepted and closed** under token
> `M3_3_D107_REAL_STALE_LEASE_RECOVERY_OWNER_ACCEPTED` at **BLOCKER 0 / MAJOR 0**, at published HEAD
> `0d699a14…`: the lease is `released`, the recovery namespace is present, spent, and create-once,
> the catalog is at migration head `0015` with `0016` absent and integrity PASS, both accepted
> identities MATCH, the v1 predecessor is permanently `UNDETERMINED / NOT COMPLETE`, and the latest
> real read-only E0-v2 preflight measured **PASS across every frozen successor predicate**.
> **§2 (R120)** sets `M3_3_E0_EXECUTION_AUTHORITY` to exactly `M3_3_D108_E0_V2_EXECUTION_AUTHORIZED`
> for **exactly one** `m3 offline-parse --config configs/project.yaml --mode execute` through the
> governed operator surface — no direct-library substitute, no second `execute`, no retry, no manual
> catalog or namespace edit, no migration, no network. This is the separate owner instrument
> Decision 107 §5 reserved: issued **on** the verified recovery and the read-only preflight that
> followed it, never granted **by** them. **Activation is necessary and never sufficient** — every
> frozen Decision 094 §5 predicate and Decision 103 §10 successor predicate still runs, conjunctively
> and fail-closed, `preflight` stays strictly read-only, and a PASS is a measurement rather than
> permission. **§3 (R119)** withdraws the **spent** `PRE_E0_CATALOG_TRANSITION_AUTHORITY` to `None`
> and retains the Decision 101 §7 literal nowhere in source; that withdrawal does not reach E0,
> because E0 reads the completed transition **terminal record** as a predicate and no verification
> path recomputes an authority digest from the constant. `STALE_WRITER_LEASE_RECOVERY_AUTHORITY`
> **remains** `None`. **§4 (R121)** fixes the required immediately-pre-execution read-only preflight
> and the required post-execution verification. **§5 (R122)** returns `M3_3_E0_EXECUTION_AUTHORITY`
> to `None` once the one invocation has returned, **whether COMPLETE or not**, so all three governed
> execute surfaces end the sequence **disabled**. **§6 (R123)** authorizes the post-E0 R52 linkage
> diagnostic as **READ ONLY** over exactly the 96 accepted form+date assertions, the six form-only
> partials outside the denominator, with no inference or fallback of any kind,
> `ORDERING_UNAVAILABLE` never converted into a PASS, and no owner linkage-gate ruling made by the
> executing session. **§7** authorizes two commits and two ordinary pushes and no others, with no
> force, rebase, amend, or tag. Migration `0016`, the persistence bridge, E1, E2, the final M3.3
> manifest or root, M3.4, SEC, EDGAR, HTTP, and DNS all remain unauthorized at request ceiling **0**.

> **CONTROLLING CURRENT POSITION, 2026-08-17 (LATEST) — the accepted [Decision 107](../Docs/Decisions/decision_107_m3_3_real_stale_writer_lease_reconciliation.md)
> sequence is COMPLETE, and both governed execute surfaces ship DISABLED.** The one authorized real
> stale-writer-lease reconciliation was executed **exactly once** through
> `m3 reconcile-writer-lease --config configs/project.yaml --mode execute`, returned `status: complete`,
> and has been verified against real state on every §6 obligation. **The lease:** persisted state
> exactly `released`, original `lease_id` and `writer_pid` preserved, governed host / acquisition /
> expiry provenance preserved, **no** false `released_at_utc`, `reconciliation_reason`
> `owner_authorized_stale_writer_recovery`, `reconciled_prior_state` `held`, `reconciled_at_utc`
> present, and structurally valid through the production reader — the only keys added are the three
> reconciliation fields, and none was removed. **The record:** exactly one recovery namespace
> `m3_3_stale_writer_lease_recovery_v1` and exactly one write-once record; canonical bytes round-trip;
> `terminal_record_id` and `result_token` both recompute; `owner_authority_sha256` equals the SHA-256 of
> the **R116** token and that token's value appears nowhere in the record; `prior_lease` matches the
> immediately-pre-execution lease and `resulting_lease` the actually released one; the eligibility block
> is measured; request and attempt counts are both `0`; no private absolute path or secret is
> serialized. **The catalog:** before equals after on file digest, byte length, logical digest,
> observation-set digest, chain `1..15`, head `0015` with `0016` absent, all three integrity gates,
> foreign-key violations `0`, and a **0-byte** write-ahead log. **v1:** byte-identical, no terminal, no
> receipt, no closing event, still `UNDETERMINED / NOT COMPLETE`. **Exactly-once**, established by
> read-only inspection and without a second `execute`: a repeat `preflight` now **REFUSES** at exit `4`
> on both grounds — the lease no longer records `held`, and the create-once namespace already exists.
> **R118 is applied:** `STALE_WRITER_LEASE_RECOVERY_AUTHORITY` is back to `None`,
> `M3_3_E0_EXECUTION_AUTHORITY` **remains** `None`, `PRE_E0_CATALOG_TRANSITION_AUTHORITY` is untouched,
> and neither governed literal is retained in `src/disclosure_drift/m3/e0.py`. **No E0-v2 execution is
> authorized** — a later separate owner instrument is required, and this verified recovery is neither
> that instrument nor evidence of it.
>
> **THE AUTHORIZING POSITION, PRESERVED, 2026-08-16 — accepted [Decision 107](../Docs/Decisions/decision_107_m3_3_real_stale_writer_lease_reconciliation.md), outcome `M3_3_D107_REAL_STALE_WRITER_LEASE_RECONCILIATION_AUTHORIZED`.** The one read-only real-state
> preflight [Decision 106](../Docs/Decisions/decision_106_m3_3_recovery_implementation_acceptance_and_preflight_authorization.md)
> §6 authorized has been executed and is **owner-accepted at BLOCKER 0 / MAJOR 0**, under token
> `M3_3_D106_REAL_RECOVERY_PREFLIGHT_OWNER_ACCEPTED`. Every applicable
> [Decision 103](../Docs/Decisions/decision_103_m3_3_e0_interruption_recovery.md) §5 predicate `L1`–`L11`
> measured **PASS** against real private state; byte and logical identities were unchanged across the
> measurement; the catalog measured migration chain `1..15` at applied head `0015` with `0016`
> **absent**, integrity **PASS**, foreign-key violations `0`, both accepted identities **MATCH**, and a
> **0-byte** write-ahead log; the recovery namespace was **absent**; both tracked network switches
> measured `false`. `L12` stays exempt as an execute-path control-flow property no read-only
> measurement can establish. The **v1 predecessor** is accepted exactly as measured — present, a real
> non-symlinked directory, a valid two-event ledger, no terminal, no receipt, no closing event — and is
> therefore permanently `UNDETERMINED / NOT COMPLETE` and **unmodified**.
>
> **Decision 107 authorizes exactly one real reconciliation, and disables E0-v2 first.** **R116** sets
> `STALE_WRITER_LEASE_RECOVERY_AUTHORITY` to exactly
> `M3_3_D107_REAL_STALE_WRITER_LEASE_RECONCILIATION_AUTHORIZED` — the separate owner instrument
> Decisions 104 and 106 each reserved — for **one** `m3 reconcile-writer-lease --mode execute`, with the
> conjunctive fail-closed `L1`–`L12` ladder still running in full, so **activation is necessary and
> never sufficient**. **R117** sets `M3_3_E0_EXECUTION_AUTHORITY` to `None` **before any private state
> is touched**: the [Decision 101](../Docs/Decisions/decision_101_m3_3_d100_owner_acceptance_and_transition_e0_authorization.md)
> §8 authorization was issued for the `…_v1` generation and was consumed by the invocation that was
> interrupted, and the stale lease was the only remaining barrier to E0-v2 — so clearing it must not
> re-enable a second, separately governed operation. **R118** returns the recovery constant to `None`
> once the one use is verified, and `M3_3_E0_EXECUTION_AUTHORITY` **stays** `None`, so both surfaces end
> the sequence **disabled**. `PRE_E0_CATALOG_TRANSITION_AUTHORITY` is untouched. **No E0-v2 execution is
> authorized** before, during, or after; a later separate owner instrument is required, and a verified
> recovery is neither that instrument nor evidence of it. Migration `0016`, the persistence bridge, E1,
> E2, M3.4, SEC, EDGAR, HTTP, and DNS remain unauthorized at request ceiling **0**; network authority is
> limited to the two ordinary Git pushes §7 authorizes, with no force, rebase, amend, or tag.
>
> **THE PRIOR POSITION, PRESERVED — accepted [Decision 106](../Docs/Decisions/decision_106_m3_3_recovery_implementation_acceptance_and_preflight_authorization.md), outcome `M3_3_D105_RECOVERY_IMPLEMENTATION_OWNER_ACCEPTED`.** The complete stale-writer-lease recovery implementation chain is **owner-accepted at BLOCKER 0 / MAJOR 0**: the Decision 103 implementation at `91f9058f…`, the Decision 104 activation correction at `104a5ec0…`, and the Decision 105 unreadable-lease correction at `f22dacedd…`, tree `e322b382…`. The final review observation that the lease reader consumes at most 64 KiB is owner-recorded **non-blocking**, because an oversized or otherwise unreadable lease document **fails closed** rather than being interpreted as released — the direction R115 requires. **No additional independent review of this implementation is required.** D106 §2 disposes of the carried adjudication points exactly once and reopens no D103, D104, or D105 ruling: **F1** the lock-continuity-over-rename trade **ACCEPTED**, now that downstream ordinary readers also fail closed on a malformed lease; **F2** in-place lease provenance beside the record's `prior_lease.*` binding **ACCEPTED** as sufficient and truthful; **F3** empty inherited SQLite sidecars **ACCEPTED OBSERVATION**; **F4** the narrowly scoped `owner_authority_sha256` scan handling **ACCEPTED**, the value still scanned and no general exemption added; **F6** stale illustrative v1 pointers **DEFERRED DOCUMENTATION DEBT**; **F7** the absent `decision_102_*.md` artifact an **ACCEPTED DOCUMENTATION/NUMBERING GAP** on which no runtime or controlling authority depends; **F8** the prior absence of real-state measurement **CLOSED** by the operation §6 authorizes; **F9** commit trailers **NON-MATERIAL**. **Acceptance of an implementation is not activation of an operation.** §5 authorizes one minimal governance commit and **one ordinary push of `main` to `origin/main`** — the only network activity the record permits, with no force, rebase, amend, or tag — and §6 authorizes, **after successful publication only**, exactly one read-only `m3 reconcile-writer-lease --mode preflight` through the accepted evidence-root resolver, requiring direct measurement of `L1`–`L11` and of the v1 predecessor state, and exempting **`L12`** as an execute-path control-flow property no read-only measurement can establish. §7 requires before/after identities proving nonmutation, and §8 imposes the **required stop**: even on a fully passing preflight the recovery is **not** executed. `STALE_WRITER_LEASE_RECOVERY_AUTHORITY` **remains `None`**; real reconciliation, the recovery record, the recovery namespace, writing the lease, and **E0-v2** execution all remain **unauthorized**, as do migration `0016`, the persistence bridge, E1, E2, M3.4, SEC, and HTTP at request ceiling **0**. `PRE_E0_CATALOG_TRANSITION_AUTHORITY` and `M3_3_E0_EXECUTION_AUTHORITY` are untouched and remain exactly as Decision 101 sections 7 and 8 set them.
>
> **CONTROLLING CURRENT POSITION, 2026-08-16 (LATEST) — accepted [Decision 105](../Docs/Decisions/decision_105_m3_3_unreadable_writer_lease_fail_closed.md), outcome `M3_3_D105_UNREADABLE_WRITER_LEASE_FAILS_CLOSED`.** The final Decision 103 + Decision 104 technical review is accepted as technical evidence and otherwise **PASSED**; its single MINOR is **owner-reclassified as MAJOR** and corrected here, and every other finding is owner-classified non-blocking and is not reopened. Because Decision 103 §7 (R109) rewrites the lease **in place** on the descriptor whose `flock` is held continuously, a process that dies between the truncation and the completed write leaves a lease that is not structurally readable — and the ordinary Decision 094 §5.2 predicate 9 read such a document leniently, returning its state as `None` and refusing only on the exact comparison `state == "held"`. An unreadable lease therefore arrived as a value that is not `held`, which read as permission to proceed: measured on the pre-correction tree over a disposable catalog beneath a synthetic root, both ordinary gates returned `passed=True, refusals=()` with a torn lease present, having already recorded `writer_lease: unreadable` as a measured fact. **R115** fixes the direction: an **existing** lease clears predicate 9 only by being a structurally valid document — read through the same production reader the `L1`–`L12` ladder uses — recording exactly `released`. Torn, truncated, non-JSON, field-missing, field-invalid, unknown-field, and unknown-state documents all **refuse**. A `held` lease keeps its own unchanged refusal, because "a writer holds this" and "this is not a lease I can read" are different facts an operator acts on differently; an **absent** lease keeps its accepted Decision 094 finding-m1 semantics, passes, and is still never created. No new lease-state vocabulary is introduced, `read_persisted_lease` is not weakened, no rename-based lease replacement is added, and the R109 in-place-write decision stands. **Nothing else changes**: Decision 103 R105–R112 and Decision 104 R113–R114 are preserved entire, `STALE_WRITER_LEASE_RECOVERY_AUTHORITY` remains `None`, and `PRE_E0_CATALOG_TRANSITION_AUTHORITY` and `M3_3_E0_EXECUTION_AUTHORITY` remain exactly as Decision 101 sections 7 and 8 set them. **D105 grants no execution authority**: reconciling the real stale lease still requires a separate owner instrument; migration `0016`, the persistence bridge, E1, E2, M3.4, network, SEC, and HTTP remain unauthorized at request ceiling 0.

> **CONTROLLING CURRENT POSITION, 2026-08-16 (LATEST) — accepted [Decision 104](../Docs/Decisions/decision_104_m3_3_d103_recovery_activation_correction.md), outcome `M3_3_D104_RECOVERY_ACTIVATION_CORRECTED_TO_DISABLED`.** The Decision 103 acceptance review returned one MAJOR, and this record corrects exactly that one and nothing else. **The governed stale-writer-lease reconciliation surface shipped with its activation constant live** — `STALE_WRITER_LEASE_RECOVERY_AUTHORITY = "M3_3_D103_STALE_WRITER_LEASE_RECONCILIATION_AUTHORIZED"` — which granted in source precisely what Decision 103's own header withheld with `REAL_LEASE_RECONCILIATION_EXECUTION: NOT AUTHORIZED BY THIS RECORD`. Because the `L1`–`L12` ladder is an eligibility test rather than an authorization, and Decision 102 established every one of its predicates was already true of the real lease, the constant was the only remaining barrier: one `m3 reconcile-writer-lease --mode execute` against a resolvable private root would have reconciled the real lease and created the real recovery record with no further human act, and the resulting record's `owner_authority_sha256` would have attested to a "Decision 103 authorization" that Decision 103 does not contain. **R113** ships the constant `None`, so `execute` is **not enabled** and returns exit `3` through the existing `_require_activation` door **ahead of private-root resolution** — the refusal is unconditional, consults no lease, catalog page, or namespace, and reads, creates, locks, or writes no private state. `preflight` stays strictly read-only as governed and **neither activates the surface nor implies mutation authority**: it renders `reconciliation_enabled` as a measured fact, so a passing report is a measurement rather than permission, and the `execute` immediately following it still refuses. **R114** requires the durable recovery record to bind the authority **actually active for that execution** — the value `_require_activation` returns — never a literal carried inside the record builder. **Nothing else changes.** The entire Decision 103 recovery architecture is preserved: the v2 successor generation, v1 predecessor validation, the conjunctive fail-closed `L1`–`L12` ladder, under-lock reassertion, the truthful `held -> released` reconciliation, the continuously held `flock`, measured catalog nonmutation, the create-once namespace, the write-once record, zero network/request semantics, and successor gating. `PRE_E0_CATALOG_TRANSITION_AUTHORITY` and `M3_3_E0_EXECUTION_AUTHORITY` remain exactly as Decision 101 sections 7 and 8 set them — **ordinary E0 and transition authority is unaffected**. Activating the recovery constant for exactly one real reconciliation requires a separate owner instrument that does not yet exist; migration `0016`, the persistence bridge, E1, E2, M3.4, network, SEC, and HTTP remain unauthorized at request ceiling 0.

> **CONTROLLING CURRENT POSITION, 2026-08-16 — accepted [Decision 103](../Docs/Decisions/decision_103_m3_3_e0_interruption_recovery.md), outcome `M3_3_D103_RECOVERY_IMPLEMENTATION_AUTHORIZED`.** The authorized Decision 101 sequence ran the `0013 -> 0014 -> 0015` transition to completion and then began M3.3-E0 under namespace `m3_3_e0_offline_parse_v1`. **That E0 invocation was interrupted.** Its durable state is two valid chained events (`PREFLIGHT_PASSED`, `BACKUP_VERIFIED`), no terminal record, and no execution receipt — classification **`UNDETERMINED / NOT COMPLETE`** — beside a verified backup, a catalog still at head `0015` with logical SHA-256 `5c823d21…6ad306`, input observation set `b1122bb9…8e533be`, 76/76 sources `not_started`, 0 parser runs, a 0-byte WAL, and a **stale persisted writer lease** recording `state = held` for the now-dead pid `43427`. Decision 102 independently established that no E0 process, catalog writer, or lock holder remains and that no existing governed mechanism could reconcile that lease. **D103 closes exactly the two resulting gaps and authorizes implementation only.** **R105** advances the E0 generation to `m3_3_e0_offline_parse_v2` by reviewed source change alone — no `--run-namespace`, environment, or configuration override — superseding the E0 literal in Decision 094 §7.1 and **only** that literal. **R106** keeps v1 as immutable interrupted evidence the successor **validates** (present, terminal-free, receipt-free, chain-valid, no closing event) rather than ignores; an absent v1 stops the successor instead of reading as a clean start. **R107** defines the conjunctive fail-closed `L1`–`L12` eligibility ladder in which no elapsed time, dead PID, or free advisory lock authorizes takeover alone. **R108** makes the reconciliation truthful: `held -> released` **without** `released_at_utc` and **with** `reconciliation_reason`, so voluntary release cannot be inferred. **R109** confines the write set to the lease sidecar and its record, documents why lock continuity outranks rename-atomicity for this file, and requires measured catalog nonmutation. **R110** adds `m3 reconcile-writer-lease --config … --mode {preflight,execute}` with its own activation constant and none of the prohibited override options. **R111** writes one write-once recovery record reusing the accepted evidence primitives. **R112** keeps the v2 successor preflight fail-closed. **The ordinary E0 surfaces still refuse a held lease.** Reconciling the real lease, creating the real recovery receipt, and running E0 v2 each require a separate owner instrument; migration `0016`, the persistence bridge, E1, E2, M3.4, network, SEC, and HTTP remain unauthorized at request ceiling 0.

> **CONTROLLING CURRENT POSITION, 2026-08-16 (LATEST) — accepted [Decision 101](../Docs/Decisions/decision_101_m3_3_d100_owner_acceptance_and_transition_e0_authorization.md), outcome `M3_3_D100_PRE_E0_IMPLEMENTATION_OWNER_ACCEPTED`.** Sol/GPT-5.6 performed the Decision 099 §9 corrected-target review directly and **owner-accepted the Decision 100 PRE-E0 implementation** at `3e8c82d1ec411bf667c0c8eb37603306a86e6dc4`, tree `67564d3f4c677548bfaff27e62e15df9c64dbc8e`, at zero BLOCKER and zero MAJOR. **The PRE-E0 remediation chain is CLOSED**; no further independent review, acceptance review, architecture review, or optimization pass precedes execution, and the already-accepted validation evidence is expressly not re-run. D100 R99–R101 are accepted. **R102** ratifies the catalog-observed claim/exposure correction as valid Decision 099 R96-preserving work needing no further code change. **R103** accepts the two zero-valued failure-only aggregates `submissions_membership_observation_count` and `substantive_membership_observation_count` as a non-blocking deferred limitation: on a failed or interrupted terminal they are never authoritative measured values — the durable `source_results`, event ledger, persisted catalog state, and `association_totality` are — and the limitation never applies to a COMPLETE run. **R104** defers the valid-but-wrong-interruption-state regression test; the invariant was demonstrated against the production validator and the guard is active. D101 then issues the two instruments Decision 094 §12.4 reserved: **one ordinary push of `main` to `origin/main` before any private catalog state is touched**; bounded private-root access for this sequence only, resolved through the accepted mechanism and never disclosed; **the exact `0013 -> 0014 -> 0015` transition**, with every frozen preflight predicate and the under-lease recheck required; and **one M3.3-E0 invocation, authorized if and only if that transition completes and verifies**. Each execute mode is enabled solely by its own constant-only source activation to the governed token D101 names, in its own separate local commit. **Migration `0016`, the persistence bridge, E1, E2, M3.4, network, SEC, and HTTP remain unauthorized at request ceiling 0**, and the sequence stops for owner review after verified E0.

> **CONTROLLING CURRENT POSITION, 2026-08-16 — accepted [Decision 099](../Docs/Decisions/decision_099_m3_3_post_d098_bounded_correction.md), outcome `M3_3_D099_POST_D098_BOUNDED_CORRECTION_AUTHORIZED`.** Joey authorizes one post-D098 correction. R96 makes failed/interrupted terminal conditional fields derive from the fully verified durable ledger; R97 freezes the exact accepted T7→T6 receipt chain and catalog-run binding for D094 §5.2 predicate 3 in preflight and under lease; R98 corrects the four directly implicated frozen-contract MINORs (catalog-aware verify, structural lease omission, real existing/operator-owned namespace parent, and truthful preflight coverage). One fresh actual-`claude-opus-5` Maximum executor may edit exactly `m3/e0.py`, `test_m3_e0.py`, the E0 record spec, operator runbook, and change-impact map; after targeted mutation proof it may run one `make check-fast` and create one local commit with the frozen subject. Sol performs the corrected-target review; no additional independent opinion or optimization pass follows. Any remaining BLOCKER/MAJOR or failed proof returns to Joey. **E0 remains HELD during correction.** Private-root access, accepted-catalog `0014`/`0015`, activation, transition, E0, linkage, bridge, `0016`, later stages, network, SEC, HTTP, push, and tag remain unauthorized at request ceiling 0.

> **CONTROLLING CURRENT POSITION, 2026-08-16 (LATEST) — accepted [Decision 098](../Docs/Decisions/decision_098_m3_3_d094_implementation_review_rejection_and_hold.md), outcome `M3_3_D094_PRE_E0_IMPLEMENTATION_REJECTED_PENDING_CORRECTION_AUTHORITY`.** Decision 097 produced clean local candidate `1e200218…` (tree `7d5f3aa9…`) and one successful `make check-fast` at 4351 passed / 1 skipped / 0 failed, but success was evidence rather than acceptance. The required fresh actual-`claude-opus-5` read-only independent review, durably recorded at [`Docs/m3/reviews/m3_3_d094_pre_e0_implementation_independent_review_1e20021.md`](../Docs/m3/reviews/m3_3_d094_pre_e0_implementation_independent_review_1e20021.md) with SHA-256 `07feb160…`, returned `M3_3_D094_PRE_E0_IMPLEMENTATION_INDEPENDENT_REVIEW_FAIL` at B0/M2/MIN4/OPT1/OBS4. Sol/GPT confirms both MAJORs: failure between conditional-field assignment and its conditioning event can leave an invalid create-once terminal, and mandatory Decision-094 §5.2 predicate 3 (accepted M3.2 completion-receipt/catalog binding) is absent from both preflight and under-lease recheck. The otherwise-strong candidate is preserved unchanged and unpushed but **not owner-accepted**. D098 grants no further correction authority; a new Joey ruling is required. **E0 remains HELD.** Accepted-catalog `0014`/`0015`, E0, private-root access, linkage, bridge, `0016`, later stages, activation, network, SEC, HTTP, push, and tag remain unauthorized at request ceiling 0.

> **CONTROLLING CURRENT POSITION, 2026-08-16 (LATEST) — accepted [Decision 097](../Docs/Decisions/decision_097_m3_3_m19_live_anchor_supersession_correction.md), outcome `M3_3_D097_M19_LIVE_ANCHOR_SUPERSESSION_OWNER_ACCEPTED`.** The D096 fresh actual-`claude-opus-5` Maximum remediation completed the PRE-E0 implementation and direct proofs but its sole `make check-fast` returned 4350 passed / 1 failed / 1 skipped, so it created no commit. The failure is Decision-076 mutation anchor M19: its historical definition still truthfully targets `_read_full_index_registrants`, while later Decision 094 §6.5 correctly deleted that observation-derived candidate fallback and Decision 096 R83 replaced it with a stronger pre-association `invalid_cik_rendering_count` proof. D097 preserves the immutable historical M19 definition and KILLED results, classifies only its **live-target applicability** as superseded, requires exactly 38 historical definitions / 37 live anchors / `M19` solely superseded / zero unexpected missing anchors, leaves the runner unchanged, and adds only `tests/unit/test_audit_tooling.py` for one exceptional correction epoch. The 22 D096 WIP paths are exact-hash preserved and may be committed once only after targeted non-vacuity and one successful `make check-fast`. **E0 remains operationally HELD.** Accepted-catalog `0014`/`0015`, E0, private-root access, linkage, persistence bridge, `0016`, E1, E2, M3.4, activation, network, SEC, HTTP, push, and tag remain unauthorized at request ceiling 0.

> **CONTROLLING CURRENT POSITION, 2026-08-16 (LATEST) — accepted [Decision 096](../Docs/Decisions/decision_096_m3_3_final_pre_e0_rehearsal_correction_and_remediation.md), outcome `M3_3_D096_FINAL_PRE_E0_CORRECTION_OWNER_ACCEPTED`.** The D095 remediation attested actual `claude-opus-5` but returned `M3_3_D095_REMEDIATION_BLOCKED`, made no commit, and left ten modified tracked files plus new `m3/e0.py` as unaccepted WIP. Sol/GPT reproduced 79 passed / 4 failed in `test_m3_3_execution.py`: D094 correctly moved malformed full-index CIK rejection from candidate derivation to the pre-association E0 projection, while the older E2 rehearsal and one R28 attribution still expected the deleted observation-derived consumer behavior. D096 removes only that stale candidate-layer expectation, requires the equivalent `invalid_cik_rendering_count` positive/adversarial proof in `test_m3_e0.py` before association projection with no fallback or entity invention, and attributes the post-projection R28 divergence to `candidate_accession_evidence_sha256` while canonical-relation `multi_registrant` stays unchanged. The executor union gains only `src/disclosure_drift/m3/execution_rehearsal.py`. One fresh actual-model-attested Claude Opus 5 Maximum final remediation must finish every D094/D095 deliverable and proof and may commit once only after one successful `make check-fast`; absence of a CLI-visible effort flag is a disclosed non-invalidating limitation. **No further autonomous remediation follows. E0 remains operationally HELD.** Accepted-catalog `0014`/`0015`, E0, private-root access, linkage, persistence bridge, `0016`, E1, E2, M3.4, activation, network, SEC, HTTP, push, and tag remain unauthorized at request ceiling 0.

> **CONTROLLING CURRENT POSITION, 2026-08-15 (LATEST) — accepted [Decision 095](../Docs/Decisions/decision_095_m3_3_d094_bounded_correction_and_remediation.md), outcome `M3_3_D095_BOUNDED_CORRECTION_OWNER_ACCEPTED`.** The first D094 implementation epoch returned `M3_3_PRE_E0_REDESIGN_IMPLEMENTATION_BLOCKED` with no commit and exactly two preserved uncommitted source files. D095 preserves D094 §6.2 condition 3 and §13 M6: missing registrants still fail closed and production E0 never invents an entity. It corrects only the synthetic base case by supplying accepted-shaped, zero-filing submissions objects for support-only co-registrants 917/918; centrally recognizes `DISCLOSURE_DRIFT_EVIDENCE_ROOT` as a non-override runtime root rather than filtering it in `cli.py`; and permits `m3/e0.py` to restate the fixed catalog-relative literal with a mechanical equality test and no acquisition import. One fresh attested Claude Opus 5 Maximum bounded remediation is authorized on D094 §12.1 plus D095's exact paths, with the preserved WIP treated as unreviewed, both execute constants `None`, one local implementation commit only after a passing final `make check-fast`, and no push. **E0 remains operationally HELD.** Applying `0014`/`0015` to the accepted catalog, E0, linkage diagnostic, persistence bridge, migration `0016`, E1, E2, M3.4, network, SEC, and HTTP remain unauthorized at request ceiling 0.
>
> **CONTROLLING CURRENT POSITION, 2026-08-15 (LATEST) — accepted [Decision 094](../Docs/Decisions/decision_094_m3_3_pre_e0_executability_redesign.md), outcome `M3_3_PRE_E0_EXECUTABILITY_REDESIGN_OWNER_ACCEPTED`.** The owner accepts the PRE-E0 redesign after one fresh Claude Opus 5 Maximum read-only architecture challenge (`ACCEPT_WITH_BOUNDED_CORRECTIONS`; B2/M6/MIN10/OPT5) and Sol/GPT adjudication. **E0 is operationally HELD.** D091 Review-A evidence/digests, D092 owner acceptance and purpose-gate closure, D093 durability closure and exact linkage predicate, the open linkage gate, and the read-only/owner-adjudicated post-E0 diagnostic are preserved; “all 96 necessarily `UNESTABLISHED_ASSOCIATION_SET`” remains an inference. D094 verifies the accepted catalog at exact head `0013` with the `0014`/`0015` empty-state window open, but executes no migration. It freezes: an exact future `0013 -> 0014 -> 0015` transition with backup, continuous lease, partial-head evidence, and no auto-resume/restore; a sixteen-table E0 footprint adding only `census_accession_registrants`; set/set submissions-plus-full-index membership with R59 fail-closed handling and no invented registrant; fixed operator commands and namespaces; disabled source-bound execute constants; version-isolated receipt v4; closed terminal/ledger schemas; non-self-referential identities; and a lease-spanning freeze. **Implementation is authorized only under D094 §12, against disposable fixtures, with both execute constants `None`; one local commit, no push.** Applying `0014`/`0015` to the accepted catalog, E0, linkage diagnostic, persistence bridge, migration `0016`, E1, E2, M3.4, network, SEC, and HTTP remain unauthorized at request ceiling 0.
>
> **CONTROLLING CURRENT POSITION, 2026-08-15 (LATEST) — accepted [Decision 093](../Docs/Decisions/decision_093_m3_3_review_evidence_durability_and_linkage_resolution.md), outcome `M3_3_DECISION_093_D091_EVIDENCE_DURABLE_E0_READY`.** The accepted D091 review evidence is now **DURABLY REPRODUCIBLE FROM THE REPOSITORY**: the canonical export at `Docs/m3/evidence/d091_review_a_d9c9d9c7/` reproduces BOTH accepted digests (`b84495a4…` and `d9c9d9c7…`) from the exported files alone, so **`M3_3_D091_REVIEW_EVIDENCE_DURABILITY_HOLD_CLOSED`** and **M3.3-E0 is EXECUTABLE IN A NEW SESSION** — E0 authority from Decision 092 is UNCHANGED and was never revoked. The prose review artifact ALONE is not sufficient for reconstruction (it carries 123 of 302 span locations); the export is. **CONTROLLING LINKAGE RESOLVER** — `M3_3_R52_LINKAGE_RESOLVER_USES_ASSOCIATION_SET_PLUS_STATED_FILING_DATE`: input is exactly the 96 accepted form+date records with the 6 form-only partials OUTSIDE the denominator as `NO_DATE / INELIGIBLE_FOR_LINKAGE_RESOLUTION`; registrant scope is the COMPLETE established association set, NEVER the nullable `anchor_cik_numeric` for a multi-registrant accession; and **the match is the candidate original's `filing_date` EXACTLY equal to the issuer-stated `original_filing_date` — `report_date` is NOT the matching field.** **ACCEPTANCE-TIMESTAMP PREFLIGHT** — `E0_ORIGINAL_ACCEPTANCE_TIMESTAMP_SOURCE = UNAVAILABLE`: E0 is NOT blocked, but `census_accessions` is populated from the LOWER-AUTHORITY submissions `acceptanceDateTime` while the R43 native `<ACCEPTANCE-DATETIME>` authority exists only in the 108 D081 artifacts, which are the AMENDMENTS not their originals — so **`REAL_ACCEPTANCE_ORDERING_ADEQUACY` REMAINS PENDING AFTER E0** and missing ordering evidence is NEVER read as PASS. **E0 DURABLE OUTPUT PATH IS ESTABLISHED, NOT INVENTED**: catalog state at `<accepted private evidence root>/catalogs/m3_2a_operational.sqlite3` (`OPERATIONAL_CATALOG_RELATIVE_PATH`), written ONLY within R17's exactly-fifteen-table footprint plus the `census_plan_sources.parser_state` transition; receipt at `runs/<E0 namespace>/execution_receipt.json` (`OPERATOR_RECEIPT_FILENAME`), namespace operator-selected create-once by accepted design. **SIX MANDATORY E0 EXECUTION INVARIANTS** bind the later E0 packet (Decision 093 §10): project Python 3.12 `.venv` not system 3.9; `storage.sqlite.connect()` through its context-manager API; the private root resolved once per process and cached with no `$HOME` rglob; the order compute → validate → independently recompute every identity from persisted rows → verify integrity → THEN freeze; NO persisted digest, identifier, seal, or content address computed from a preimage containing its own value; and per-column private-path validation rather than blanket `require_no_private_path`. **E0 IS NOT STARTED BY DECISION 093.** E1, E2, M3.4, and migration `0016` remain UNAUTHORIZED, the deferred level-1 `filing_level_metadata` native-header class is NOT activated, network/SEC/HTTP is **NONE** at `REQUEST_CEILING = 0`, and `m3.2-complete` is unmoved with no tag. **NEXT: M3.3-E0 in a NEW session.**
>
...
CURRENT_STAGE: M3.3 — DECISION 141 QUALIFIES HOW THE ACCEPTED EXTERNAL VOLUME IS ATTACHED AND INTEGRATES THAT QUALIFICATION INTO THE PRE-CANARY SYSTEM. NEITHER D137, D138, D140 NOR D141 IS OWNER ACCEPTED AND NONE AUTHORIZES A CANARY — CANARY_AUTHORIZED = NO. Entry baseline M3_3_D140_CORRECTED_PUBLICATION_BASELINE_OWNER_ACCEPTED_FOR_CONTINUATION, authorization M3_3_D141_THUNDERBOLT_DOCK_QUALIFICATION_AND_INTEGRATION_AUTHORIZED (issued outside this repository, now spent), completion token M3_3_D141_THUNDERBOLT_DOCK_QUALIFICATION_COMPLETE_READY_FOR_OWNER, AND NO ACCEPTANCE TOKEN. DECISIONS 137, 138, 139 AND 140 REMAIN HISTORICAL AND ARE NOT REWRITTEN. THE GOVERNING FINDING: accepted runbook §28e condition 3 read "the SSD is DIRECTLY CONNECTED — no hub" AND THAT WAS FALSE — the SSD is THREE USB HUB TIERS DEEP INSIDE A THINKPAD THUNDERBOLT 4 DOCK. A SECOND INDEPENDENT FINDING: require_launch_power_conditions, the D140-R20 AC-power and lid guard, was FULLY IMPLEMENTED, FULLY UNIT-TESTED, NAMED BY THAT SAME TABLE AS "CHECKED AT LAUNCH", AND CALLED BY NO PRODUCTION PATH — the guard existed and was UNREACHABLE. TOPOLOGY, DISCOVERED RATHER THAN INFERRED: the commercial name misled TWICE — it is a THUNDERBOLT 4 dock, not the Thunderbolt 3 the change was described as, and it negotiated mode_key = usb_four, NOT native Thunderbolt; its DOWNSTREAM THUNDERBOLT RECEPTACLE IS EMPTY and diskutil reports the volume's own BusProtocol = USB. DOCK_TRANSPORT_CLASS = USB_VIA_THUNDERBOLT_DOCK; dock Lenovo 0x17EF:0x30B3 firmware 38.6, upstream connected at 40 Gb/s on TB/USB4 Bus 1; cascade 0x8087:0x0B40 -> 0x17EF:0x30B6 -> 0x17EF:0x30B8 -> SSD 0x090C:0x2320, WALKED FROM THE MOUNTED VOLUME'S OWN MEDIA UPWARD RATHER THAN GUESSED. THE VOLUME UUID 397A4D4A-9508-391E-814E-3B533C7BD049 REMAINS PRIMARY AND IS UNWEAKENED; the transport is a SECOND, NARROWER condition. NO BSD IDENTIFIER IS FROZEN OR COMPARED — disk4/disk4s2 are a momentary IORegistry lookup key taken from the volume that has ALREADY proved its UUID, and A CHANGED DISK NUMBER DOES NOT REFUSE. I/O: every run non-sparse, fsync-ed, F_FULLFSYNC-ed, read back with F_NOCACHE, EVERY SHA-256 IDENTICAL. ONE READING IS REPORTED RATHER THAN TIDIED AWAY: the first write into the new directory measured 110.435 MiB/s, which would have read as a ~56% regression against D136's 250.438 MiB/s; IT WAS NOT REPRODUCED — 2/3/6 GiB runs measured 352.763, 404.909 and 388.493 MiB/s with a steady ~420-435 MiB/s plateau and NO CLIFF TO 6 GiB — so sustained dock write EXCEEDS the direct baseline and every run clears the 50 MiB/s D136 floor by >= 2.2x; THE FIRST READING'S CAUSE WAS NOT ISOLATED AND NO EXPLANATION IS ASSERTED. SQLITE: 120,000 rows, DB 553,132,032 B, WAL high-water 4,688,592 B -> 0 after TRUNCATE, commit p50 19.358 / p95 24.676 ms, integrity_check ok, 0 FK violations. LOCKING, IN SEPARATE OS PROCESSES: a second writer was EXCLUDED, a reader saw 0 uncommitted rows, the lock released on exit, integrity ok after contention. PROCESS-CRASH: SIGKILL mid-transaction left 0 uncommitted rows; SIGKILL after commit left a HOT 28,872 B WAL from which 1000 committed rows recovered, integrity ok before and after TRUNCATE. NO PHYSICAL INTERRUPTION OF ANY KIND. DOCK_LINK_FLAPS = 0, SSD_DETACH_EVENTS = 0, IO_ERRORS = 0 across 63,970 kernel log lines; the 25 broad-pattern candidates were ALL runningboardd terminateprocess records and NONE is interpreted as a storage event. DOCK_POWER_AND_STORAGE_COEXIST = PASS, MEASURED DURING THE LOAD — 13 samples across 7.7 s of sustained 4 GiB writing at 530.08 MiB/s with ac_power True, mounted True, st_dev constant and a 92 W adapter connected throughout. D140_SAFETY_ON_DOCK_PATH = PASS: 17/17 LIVE CONTROLS BEHAVED AS REQUIRED, EACH ASSERTING THE REASON FOR ITS OUTCOME — an earlier harness defect that made one refuse for the wrong reason was FOUND AND CORRECTED rather than accepted. INTEGRATION: one new module dock_transport.py and TWO CALLS added to the composed preflight, the single point all three canary modes already flow through; order is identity -> TRANSPORT -> HOST LAUNCH CONDITIONS -> isolation -> archive -> capacity -> temp -> observation. Both readers are module-global seams and THERE IS NO SWITCH THAT DISABLES EITHER CHECK. NO CLI FLAG WAS ADDED and cli.py is unchanged. The INTERNAL HISTORICAL PATH COSTS NO ioreg AND NO pmset, proved by making both fatal. D130: 24 entries, compact proofs identical, tar size/inode/mtime/ctime BYTE-IDENTICAL, 0 OPENS WITH THE TRIPWIRE PROVED ARMED BY MAKING IT FIRE ON A GENUINE OPEN; AN HONEST NEGATIVE RESULT IS RECORDED — atime does NOT advance on read on this ExFAT volume, so atime is NOT offered as evidence the tar was never opened; free space returned to 310,498,426,880 B, BYTE-IDENTICAL to the pre-qualification reading. VALIDATION: focused baseline 206 before and after; FULL SUITE 5140 PASSED / 1 PRE-EXISTING SKIPPED / 0 FAILED, exactly +33; 11 REVERSIBLE MUTATIONS, ALL 11 KILLED, every file byte-identical by SHA-256, NO SOURCE-MUTATING FRAMEWORK — M10 AND M11 ARE THE REACHABILITY MUTATIONS, leaving every guard correct and merely stopping the preflight from calling it, which is EXACTLY the state require_launch_power_conditions was actually in. WHETHER THE DOCK IS THE INTENDED CANARY TOPOLOGY IS THE OWNER'S CALL AND D141 DOES NOT MAKE IT: the D136 DIRECT topology is NOT REVOKED, both are recognized, a third refuses. GOVERNED PAUSE/RESUME REMAINS NOT_IMPLEMENTED — QUALIFYING THE DOCK DOES NOT CREATE A WAY TO DETACH IT. NO MIGRATION: HEAD REMAINS 0015 AND 0016 IS ABSENT. ALL THREE ACTIVATION CONSTANTS REMAIN None. NETWORK REMAINS DISABLED at both tracked switches. census_orchestrator.py::_parse_bulk REMAINS AN EXPLICIT PRE-NETWORK BLOCKER, DELIBERATELY UNREPAIRED. A COMPLETE-SOURCE CANARY IS NOT AUTHORIZED. E0 IS NOT AUTHORIZED.
ACTIVE_BLOCKER: THE CORRECTED COMPLETE-SOURCE CANARY REMAINS UNAUTHORIZED, AND THE PRIOR AUTHORIZATION REMAINS WITHDRAWN. D141's qualification and integration are COMPLETE but NOT INDEPENDENTLY REVIEWED AND NOT OWNER ACCEPTED, and neither D137, D138 nor D140 was ever owner accepted; the D136-R8 narrow one-canary exception takes effect ONLY AFTER IMPLEMENTATION AND ACCEPTANCE. A passing preflight still prints canary_authorized: false. SEPARATELY, GOVERNED PAUSE/RESUME IS AN OPEN OWNER-REDESIGN ITEM (Decision 140 §17): there is NO SAFE_TO_EJECT STATE, kill -STOP IS NOT A GOVERNED PAUSE, AND NEITHER THE SSD NOR THE DOCK MUST BE DISCONNECTED WHILE A CANARY RUNS — D141 QUALIFIES THE DOCK AND EXPLICITLY DOES NOT CREATE A WAY TO DETACH IT. THE NINE D140 §18 RESIDUAL LIMITATIONS ARE CARRIED UNCHANGED, AND DECISION 141 §12 ADDS NINE MORE, INCLUDING: F_FULLFSYNC RETURNING SUCCESS IS AN OS-VISIBLE RESULT ONLY AND IS NOT PROOF THE DOCK OR BRIDGE HONOURED A FLUSH; PROCESS-CRASH RECOVERY ONLY, WITH NO SURPRISE-REMOVAL, POWER-LOSS OR PHYSICAL DISCONNECTION TEST PERFORMED OR AUTHORIZED; THE CASCADE MATCH IS PORT-SPECIFIC SO MOVING THE SSD TO A DIFFERENT DOCK PORT REFUSES AND REQUIRES RE-QUALIFICATION; THE 110 MiB/s FIRST READING IS UNEXPLAINED AND NO CAUSE IS CLAIMED; AND HOST BATTERY HEALTH IS DEGRADED AT 73% MAXIMUM CAPACITY / 859 CYCLES / macOS REPORTING 'Check Battery', WHICH MAKES THE AC REQUIREMENT MORE IMPORTANT AND IS NOT A MITIGATION. SEPARATELY AND INDEPENDENTLY, census_orchestrator.py::_parse_bulk REMAINS AN OPEN PRE-NETWORK BLOCKER whose repair MUST NOT be performed as a side effect of unrelated work.
...
IMPLEMENTATION_AUTHORIZATION: SPENT — M3_3_D141_THUNDERBOLT_DOCK_QUALIFICATION_AND_INTEGRATION_AUTHORIZED was issued outside this repository and is now consumed by this qualification and integration. NO FURTHER IMPLEMENTATION AUTHORITY ARISES FROM THE DECISION 141 PUBLICATION. It does NOT accept Decision 137, 138, 140 or itself, does NOT adopt the external volume, does NOT create a canary world, a run identity, an execution namespace, a launch receipt, or a terminal state, does NOT authorize a canary, does NOT authorize E0, does NOT create or authorize migration 0016, does NOT authorize network, SEC or HTTP at request ceiling 0, does NOT repair census_orchestrator.py::_parse_bulk, does NOT change D131 parser or runtime semantics, does NOT adopt any D134 candidate, does NOT widen the D136-R8 one-canary exception, does NOT revoke the D136 direct-connection topology, does NOT select the canary topology, and does NOT implement governed pause/resume. IT CLAIMS NO OWNER ACCEPTANCE.
ACTIVE_STAGE_CONTRACT: Milestones/contracts/m3_3.md
NEXT_AUTHORIZED_ACTION: RETURN TO THE OWNER — AND NOTHING ELSE. The owner must decide whether any further pre-canary architecture change is planned BEFORE a final independent review is commissioned, because the GOVERNED PAUSE/RESUME REDESIGN REMAINS UNRESOLVED AND MAY STILL CHANGE THE TREE, and because the SELECTION OF ONE CANARY TOPOLOGY — docked or direct — IS AN OPEN OWNER DECISION THAT D141 DELIBERATELY DID NOT MAKE. A session that creates a canary world, a run identity, an execution namespace or a launch receipt, that writes to the SSK SSD, that sets any activation constant, that adds migration 0016, or that enables network on the strength of D137, D138, D140 or D141 is acting OUTSIDE all four. THE SSD MUST NOT BE WRITTEN TO under this publication, the D130 archive MUST NOT BE MODIFIED, MOVED, DELETED OR HASHED beyond its four compact proofs, and the large D130 tar MUST NOT BE OPENED. After the owner's decision, an OWNER DECISION ON WHETHER TO ACCEPT DECISIONS 137, 138, 140 AND 141 — and, separately and only then, whether to authorize the corrected canary, and whether to commission the Decision 140 §17 pause/resume redesign.
...
DECISION_093_STATUS: ACCEPTED — OWNER D091 REVIEW-EVIDENCE DURABILITY CLOSURE AND PRE-E0 LINKAGE-RESOLUTION RULING 2026-08-15; outcome M3_3_DECISION_093_D091_EVIDENCE_DURABLE_E0_READY. DURABILITY GAP ACCEPTED AS FACT: the committed prose review artifact carries all 108 rows but only 123 of the 302 span locations, which is not enough machine-readable state to reconstruct the accepted Review-A rows or reproduce the accepted digests; this is a DURABILITY/REPRODUCIBILITY GAP and is NOT a judgment defect, NOT a digest defect, and NOT a reopening of the D091 evidence review. CANONICAL DURABLE EXPORT created at Docs/m3/evidence/d091_review_a_d9c9d9c7/ — document_artifacts.jsonl (108 rows, sha256 0fdd6d02…), document_review_records.jsonl (108 rows, sha256 f66135b0…), document_review_spans.jsonl (302 rows, sha256 18b8fc6b…), manifest.json (sha256 599d9ff0…) — as deterministic UTF-8 JSON Lines with migration-0015 field ordering, declared-UNIQUE-business-key row ordering, exact persisted governed values, NO invented value and NO timestamp generated for the export, and NO Complete Submission Text body, absolute path, evidence-root name, scratch path, raw session identifier, or personal reviewer name. IT IS AN EXPORT OF ALREADY-FROZEN ACCEPTED STATE: no document was re-reviewed and no judgment, category, abstention, asserted form, asserted date, source span, span text, or review_epoch_id changed, no replacement review row was minted, and no Review-B or adjudication row was created. REPRODUCIBILITY PROOF: from ONLY the exported files plus the accepted repository hashing implementation, with the built catalog deliberately NOT opened, 27 checks PASS and BOTH accepted digests reproduce exactly — ARTIFACT_TABLE_SHA256 b84495a40b23fdc77c70c537b8cf6c9bd7675b90493fc73d55841a2ac425174e and REVIEW_A_TABLE_SHA256 d9c9d9c79a75d7808e09094fdafa189128ae522d884bb88c8fb28f0e40d89c4f — at artifact rows 108, review rows 108, span rows 302, Review-B rows 0, adjudicated rows 0, together with every review_record_sha256, every span_sha256, every review_id from sha256(review_epoch_id|accession_plain), and the accepted content counts (purpose 99 asserted / 9 abstained; form 102, date 96, accession 0, form+date 96). THEREFORE M3_3_D091_REVIEW_EVIDENCE_DURABILITY_HOLD_CLOSED and M3.3-E0 REMAINS OWNER AUTHORIZED AND IS EXECUTABLE IN A NEW SESSION — Decision 093 never revoked E0 authority, it held only the consumption of that authority pending this proof. CONTROLLING LINKAGE RESOLVER FROZEN PROSPECTIVELY BEFORE E0 — M3_3_R52_LINKAGE_RESOLVER_USES_ASSOCIATION_SET_PLUS_STATED_FILING_DATE: INPUT is exactly the 96 owner-accepted Review-A records carrying BOTH an accepted original form and an issuer-stated original filing date, with the 6 form-only partial records remaining in the reconciliation waterfall as NO_DATE / INELIGIBLE_FOR_LINKAGE_RESOLUTION, receiving NO linkage credit, and sitting OUTSIDE the 96-match denominator; A REGISTRANT SCOPE is the COMPLETE established amendment registrant association set unioned over pilot_candidate_accession_registrants or its exact accepted relational successor, with the nullable anchor_cik_numeric NEVER used as the registrant scope for a multi-registrant accession and an unestablished set failing closed as UNESTABLISHED_ASSOCIATION_SET; B FORM PREDICATE requires an ORIGINAL compatible annual filing whose form EXACTLY matches the accepted asserted 10-K or 10-KT with no 10-K/A, no 10-KT/A, no 10-KSB, and NO FUZZY FORM INFERENCE; C DATE PREDICATE requires the candidate original's filing_date to EXACTLY EQUAL the issuer-stated original_filing_date accepted from the D091 review, and REPORT_DATE IS NOT THE LINKAGE MATCHING FIELD — it may be reported diagnostically but may NEVER create or destroy a match; D SET OPERATION collects all E0 original rows satisfying B+C for every substantive registrant in the association set, UNIONs, DEDUPES by canonical original accession, and classifies ZERO / EXACTLY_ONE / MULTIPLE / UNESTABLISHED_ASSOCIATION_SET. ACCEPTANCE ORDERING is evaluated SEPARATELY for an EXACTLY_ONE resolved original using the accepted native acceptance-timestamp authority (Decision 080 R43) ONLY, NEVER substituting filing_date, report_date, retrieval time, filesystem time, or row-insertion time: original acceptance < amendment acceptance is ORDERING_PASS, >= is ORDERING_FAIL, and either native timestamp unavailable is ORDERING_UNAVAILABLE — an ORDERING_UNAVAILABLE case KEEPS its EXACTLY_ONE identity resolution but CANNOT receive final linkage or quota credit until owner disposition, and MISSING ORDERING EVIDENCE IS NEVER TREATED AS PASS. E0 SOURCE-ADEQUACY PREFLIGHT (READ-ONLY; E0 NOT RUN): E0_ORIGINAL_ACCEPTANCE_TIMESTAMP_SOURCE = UNAVAILABLE, and E0 IS NOT BLOCKED. census_accessions carries acceptance_datetime_sec_raw and acceptance_date_sec populated by the accepted parser from the entity-submissions acceptanceDateTime field, which Decision 080 R43 makes the LOWER-AUTHORITY observation while designating the native accession-level <ACCEPTANCE-DATETIME> EDGAR header the authority and prohibiting the four submissions remedies that the Decision-079 MAJOR-1/MAJOR-2 source findings would otherwise invite; for the ORIGINAL candidate filings the native header is present in NO accepted stored M3.2 source object, the only accepted stored artifacts carrying a validated native header being the 108 D081 Complete Submission Text artifacts which are the AMENDMENTS and not their originals, and acquiring originals' headers would require new SEC retrieval at REQUEST_CEILING 0. CONSEQUENTLY REAL_ACCEPTANCE_ORDERING_ADEQUACY REMAINS PENDING AFTER E0 and the ordering state for resolved originals is expected to be ORDERING_UNAVAILABLE unless a later owner authority activates the level-1 filing_level_metadata class R43 describes as defined and deliberately deferred — WHICH DECISION 093 DOES NOT GRANT. E0 DURABLE OUTPUT PATH PREFLIGHT (READ-ONLY): the accepted authority DOES name the durable locations with sufficient exactness and NO PATH IS INVENTED — E0 catalog state at <accepted private evidence root>/catalogs/m3_2a_operational.sqlite3, pinned by the OPERATIONAL_CATALOG_RELATIVE_PATH Final constant in accepted source src/disclosure_drift/m3/acquisition.py and identical to the contract's accepted real private catalog, with writes confined to EXACTLY the fifteen tables of contract section 10.2 item 2 (R17, Decision 068 section 3) plus the census_plan_sources.parser_state transition for category-A sources; and the E0 receipt at <accepted private evidence root>/runs/<E0 namespace>/execution_receipt.json, filename pinned by the OPERATOR_RECEIPT_FILENAME Final constant in accepted source src/disclosure_drift/m3/receipt.py and directory pattern governed by the accepted execution-receipt spec, the namespace being operator-selected create-once BY ACCEPTED DESIGN with the receipt addressed by recorded identity rather than by an assumed path; no separate private real-state database or export is required beyond these. A NON-BINDING RECOMMENDATION carried to the E0 packet, not a ruling: the E0 packet should name its run namespace explicitly rather than leaving the executor to choose it. SIX MANDATORY E0 EXECUTION INVARIANTS recorded for the later E0 execution packet: (1) use the project Python 3.12 environment, specifically the accepted .venv interpreter, and NOT system python3 where it resolves to Python 3.9; (2) storage.sqlite.connect() is a CONTEXT MANAGER and must be used through its accepted context-manager API; (3) resolve the accepted private root ONCE PER PROCESS and cache the resolved reference, never recursively rglob-ing all of $HOME; (4) E0 order is compute → validate → INDEPENDENTLY RECOMPUTE EVERY IDENTITY AND DIGEST FROM THE PERSISTED ROWS → verify foreign keys, integrity, and content bindings → THEN freeze, NEVER freezing before identity validation; (5) NO persisted digest, identifier, seal, or content address may be computed from a preimage containing that same field's own value; (6) apply the accepted PER-COLUMN schema and shape rules for private-path validation and do NOT blindly apply require_no_private_path to text columns whose accepted syntax legitimately contains '/' or ':', and NEVER weaken nonleakage checks to suppress false positives. GOVERNANCE AND EVIDENCE-EXPORT ONLY: no source, test, migration, script, or configuration byte changes with this record, no frozen evidence row or accepted digest is rewritten, no document is re-reviewed, no D081 artifact or receipt is altered, the deferred level-1 filing_level_metadata class is NOT activated, migrations remain 0001-0015 with 0016 ABSENT, m3.2-complete is unmoved, no tag is created, network/SEC/HTTP is NONE at REQUEST_CEILING 0, and THE RECORDING SESSION DOES NOT START E0. M3.3-E1, M3.3-E2, and M3.4 remain UNAUTHORIZED. NEXT AUTHORIZED ACTION: RETURN TO SOL/GPT — M3.3-E0 runs in a NEW session under its accepted frozen scope and the six invariants above, followed by the read-only linkage resolution returned to the owner
```

DECISION_094_STATUS: ACCEPTED — M3.3 PRE-E0 EXECUTABILITY REDESIGN OWNER AUTHORITY 2026-08-15; outcome M3_3_PRE_E0_EXECUTABILITY_REDESIGN_OWNER_ACCEPTED. Preserves D091–D093 evidence, acceptance, durability, exact linkage predicate, and gate state; “all 96 necessarily UNESTABLISHED_ASSOCIATION_SET” remains inference. Strictly read-only pre-design verified the accepted catalog at head 0013 with the 0014/0015 empty-state window open; no migration or E0 ran. One fresh Claude Opus 5 Maximum read-only architecture challenge of proposal SHA b01bd2736… returned ACCEPT_WITH_BOUNDED_CORRECTIONS at BLOCKER 2 / MAJOR 6 / MINOR 10 / OPTIMIZATION 5 with Git bytes unchanged. Sol/GPT corrected and accepted: exact future 0013->0014->0015 transition safety; sixteen-table E0 footprint adding only census_accession_registrants; set/set canonical membership with R59 fail-closed handling and no invented entity; fixed operator commands/namespaces; independent execute constants both None; isolated receipt v4; closed event/terminal schemas; continuous-lease freeze; bounded hashing and association streaming; and Sol/executor path separation. Implementation is authorized only under D094 §12, one fresh attested Claude Opus 5 Maximum session, disposable fixtures, one local commit, no push. E0 remains HELD. Applying 0014/0015 to the accepted catalog, E0, linkage diagnostic, persistence bridge, migration 0016, E1, E2, M3.4, network, SEC, and HTTP remain unauthorized at REQUEST_CEILING 0. NEXT: bounded D094 implementation, Sol review, at most one remediation, one justified fresh read-only independent review, then owner acceptance.

DECISION_095_STATUS: ACCEPTED — D094 BOUNDED CORRECTION AND SINGLE REMEDIATION AUTHORITY 2026-08-15; outcome M3_3_D095_BOUNDED_CORRECTION_OWNER_ACCEPTED. The first fresh Claude Opus 5 Maximum D094 implementation epoch returned M3_3_PRE_E0_REDESIGN_IMPLEMENTATION_BLOCKED with no commit and exactly two preserved uncommitted source files. D095 preserves D094 §6.2 condition 3, §13 M6, R58/R59 fail-closed semantics, the no-invented-entity rule, and every transition/write/identity/recovery/freeze contract. R79 corrects only the disposable synthetic base case: support-only CIKs 917/918 receive accepted-shaped submissions objects with zero own filings so production parsing creates their census_registrants rows while company.idx remains the only joint-filing membership source; required reconciliation is 65 accessions, 26 registrants, 65 established, 0 unestablished, 63 singleton, 2 multi, 67 substantive association rows, 0 unbindable, 2 candidate multi accessions, 4 associated rows, and a feasible hard quota, with one-object-at-a-time negative controls. R80 centrally defines DISCLOSURE_DRIFT_EVIDENCE_ROOT as a recognized non-override runtime root in config.py, never a config override or persisted/logged value, and prohibits a cli.py filtering bypass. R81 permits e0.py to restate exactly catalogs/m3_2a_operational.sqlite3 with an equality/drift test and no acquisition import. R82 authorizes one genuinely fresh attested Claude Opus 5 Maximum normal bounded remediation on D094 §12.1 plus the exact D095 additions, treating the preserved WIP as unreviewed, requiring all D094 proof families plus D095 mutation/nonleakage proofs and one final make check-fast, and permitting one local implementation commit only on full success with no push. Both execute constants remain None. E0 remains HELD; accepted-catalog 0014/0015, linkage diagnostic, persistence bridge, 0016, E1, E2, M3.4, network, SEC, HTTP, activation, push, and tag remain unauthorized at REQUEST_CEILING 0. NEXT: local D095 governance commit, one fresh bounded remediation, then Sol/GPT verification; do not migrate or run E0.

DECISION_096_STATUS: ACCEPTED — FINAL BOUNDED PRE-E0 REHEARSAL CORRECTION AND SINGLE REMEDIATION AUTHORITY 2026-08-16; outcome M3_3_D096_FINAL_PRE_E0_CORRECTION_OWNER_ACCEPTED. The D095 remediation ran in a fresh actual claude-opus-5 epoch, returned M3_3_D095_REMEDIATION_BLOCKED, created no commit, and left ten tracked files plus new m3/e0.py as unaccepted WIP. Sol/GPT reproduced 79 passed / 4 failed: the stale E2 candidate-layer malformed-full-index expectation survives even though D094 §6.5 deleted observation-derived consumer fallback and D094 §9.5 moved the invariant to E0. R83 removes only that stale candidate-layer variant and requires an equivalent positive/adversarial pre-association E0 projection proof in test_m3_e0.py that fails on invalid_cik_rendering_count, persists no established projection or invented entity, and never invokes candidate/scalar/observation fallback. R84 corrects R28 attribution: post-projection observation divergence leaves canonical-relation multi_registrant unchanged and must fail the bridge through candidate_accession_evidence_sha256, with stale multi_registrant attribution absent. R85 requires one fresh Claude Opus 5 parent dispatch at Maximum and actual claude-opus-5 attestation while accepting the absent CLI-visible effort flag as a disclosed non-invalidating observability limitation. R86 widens the executor union only by src/disclosure_drift/m3/execution_rehearsal.py, requires every remaining D094/D095 deliverable and proof plus one successful make check-fast, and permits one local implementation commit only on full success. No further autonomous remediation follows. Both activation constants remain None. E0 remains HELD; accepted-catalog 0014/0015, private-root access, linkage diagnostic, persistence bridge, 0016, E1, E2, M3.4, network, SEC, HTTP, activation, push, and tag remain unauthorized at REQUEST_CEILING 0. NEXT: local D096 governance commit, one fresh final remediation, then Sol/GPT verification; do not migrate or run E0.

DECISION_097_STATUS: ACCEPTED — EXCEPTIONAL POST-D096 M19 LIVE-ANCHOR SUPERSESSION AND ONE-FILE CORRECTION AUTHORITY 2026-08-16; outcome M3_3_D097_M19_LIVE_ANCHOR_SUPERSESSION_OWNER_ACCEPTED. The D096 executor attested actual claude-opus-5 and completed every authorized implementation/proof surface, but its sole make check-fast returned 4350 passed / 1 failed / 1 skipped at test_all_38_anchors_resolve_against_the_live_target, with exactly M19 missing, so no implementation commit was created. R87 preserves M19's immutable historical definition and KILLED evidence while superseding only its live-target applicability under D094 §6.5 and D096 R83: 38 historical definitions, 37 live anchors, superseded [M19], unexpected missing 0. R88 authorizes only tests/unit/test_audit_tooling.py to assert that exact partition, pin M19's source/locus/anchor, prove the old candidate fallback absent and canonical relation/completeness present, and fail on any second missing anchor; the mutation runner and historical artifact remain unchanged. R89 authorizes one fresh actual-model-attested Claude Opus 5 Maximum exceptional correction, red-before/green-after plus isolated non-vacuity, one post-correction make check-fast, and one local implementation commit containing only the 22 exact-hash D096 WIP paths plus the audit test on full success. No push or tag. Both activation constants remain None. E0 remains HELD; accepted-catalog 0014/0015, private-root access, linkage diagnostic, persistence bridge, 0016, E1, E2, M3.4, network, SEC, HTTP, activation, push, and tag remain unauthorized at REQUEST_CEILING 0. NEXT: local D097 governance commit, one fresh one-file correction, then Sol/GPT verification; do not migrate or run E0.

DECISION_098_STATUS: ACCEPTED — D094 IMPLEMENTATION INDEPENDENT-REVIEW REJECTION AND PRE-E0 HOLD 2026-08-16; outcome M3_3_D094_PRE_E0_IMPLEMENTATION_REJECTED_PENDING_CORRECTION_AUTHORITY. Decision 097 produced clean local candidate 1e200218 at tree 7d5f3aa9 and one successful make check-fast at 4351 passed / 1 skipped / 0 failed. The required fresh read-only independent review attested actual claude-opus-5 and returned M3_3_D094_PRE_E0_IMPLEMENTATION_INDEPENDENT_REVIEW_FAIL at BLOCKER 0 / MAJOR 2 / MINOR 4 / OPTIMIZATION 1 / OBSERVATION 4; its exact durable report is Docs/m3/reviews/m3_3_d094_pre_e0_implementation_independent_review_1e20021.md at sha256 07feb1608f85ae30b61ff3ec4cdc1fb67ad6b17da03fa6cebd97295174cf1beb. R90 accepts the review evidence as authentic. R91 confirms the event-conditioned failure-terminal defect: a pre-event failure can leave a create-once terminal that its own validator refuses while the validation failure is suppressed. R92 confirms Decision 094 §5.2 predicate 3 remains mandatory and is absent from transition preflight and under-lease recheck. R93 records four MINORs, one deferred optimization, and four observations without authorizing cleanup. R94 rejects but preserves candidate 1e200218 unchanged, clean, unpushed, and unaccepted. Decision 097's implementation authority is consumed; no further automatic correction is authorized. Both activation constants remain None. E0 remains HELD; accepted-catalog 0014/0015, private-root access, linkage, bridge, 0016, later stages, network, SEC, HTTP, activation, push, and tag remain unauthorized at REQUEST_CEILING 0. NEXT: Joey ruling on one exceptional bounded correction and the corrected-target review boundary; do not launch an executor or run E0.
DECISION_099_STATUS: ACCEPTED — ONE POST-D098 BOUNDED PRE-E0 CORRECTION AUTHORIZED 2026-08-16; outcome M3_3_D099_POST_D098_BOUNDED_CORRECTION_AUTHORIZED. Joey explicitly authorized the one post-D098 correction. R95 preserves governance HEAD e4950cc and candidate 1e200218 as the correction baseline. R96 requires failed/interrupted terminal conditional fields to derive from the fully verified durable event ledger, covering backup, postcheck, association-totality, and validation-conditioned identity/integrity groups. R97 freezes the exact accepted T7→T6 receipt chain, fixed receipt/run/plan identities, 77 cumulative attempts, catalog run/attempt agreement, and T7 observation attribution as D094 §5.2 predicate 3 in transition preflight and under lease, using receipt.py only and no recovery/acquisition/network import. R98 corrects D098 MINOR-1 through MINOR-4 only where they directly implement frozen D094 requirements: truthful full-predicate preflight, catalog-aware verify, structural lease omission, and a pre-existing non-symlink operator-owned runs parent. One fresh actual-claude-opus-5 Maximum executor may edit exactly five paths, run targeted mutation proof and one make check-fast, and create one conditional local commit. Sol directly reviews; no additional opinion or optimization pass follows. Any remaining BLOCKER/MAJOR or failed proof returns to Joey; no further automatic correction. Both execute constants remain None. E0 remains HELD during correction; private-root access, accepted-catalog 0014/0015, transition, E0, activation, linkage, bridge, 0016, later stages, network, SEC, HTTP, push, and tag remain unauthorized at REQUEST_CEILING 0.

DECISION_100_STATUS: ACCEPTED — OWNER RULING ON THE RESIDUAL D094 SECTION 9.2 REPRESENTABILITY GAP 2026-08-16; outcome M3_3_D100_COMMIT_BEFORE_EVENT_REPRESENTABILITY_CLOSED. R99 records the reproduced category-A gap: run_offline_metadata_parse commits one plan-row boundary per category-A source inside the call while every SOURCE_DISPOSITION_RECORDED event is appended after it returns, so a failure in between left durable boundaries that the call-stack-gated derivation dropped and that a failed status could not state. R100 derives failed-set membership from durable evidence alone — every durable disposition event plus every independently observed category-A census_plan_sources.parser_state boundary lacking one, deduplicated toward the event — and derives the disclosed interruption state from the resulting rows, using the existing accepted value after_e0_source_commit_before_event with NO vocabulary amendment: INTERRUPTION_STATES_V4 and m3/receipt.py are unchanged. R101 projects the tail INTERRUPTED event to the accepted closed key set, which every prior append had violated by copying catalog_state_observed from the terminal failure object. The A-F table shows no lawful combination is representable-but-unstatable. Implemented at commit 3e8c82d1, tree 67564d3f. SUPERSEDED ON CURRENT STATE BY DECISION 101: this record's own E0-HELD and no-activation position was true as at its date and is now replaced by the D101 acceptance and execution authorization.

DECISION_101_STATUS: ACCEPTED — D100 PRE-E0 OWNER ACCEPTANCE, CATALOG-TRANSITION AUTHORITY, AND E0 EXECUTION AUTHORITY 2026-08-16; outcome M3_3_D100_PRE_E0_IMPLEMENTATION_OWNER_ACCEPTED. Sol/GPT-5.6 performed the Decision 099 section 9 corrected-target review directly and owner-accepted the D100 PRE-E0 implementation at 3e8c82d1ec411bf667c0c8eb37603306a86e6dc4, tree 67564d3f4c677548bfaff27e62e15df9c64dbc8e, at zero BLOCKER and zero MAJOR. THE PRE-E0 REMEDIATION CHAIN IS CLOSED: no further independent review, acceptance review, architecture review, optimization pass, or speculative hardening precedes execution, and the already-accepted validation evidence is expressly not re-run. D100 R99-R101 are accepted as issued. R102 ratifies the catalog-observed claim/exposure correction — the whole conditioned group is derived, validated by _catalog_observation, and exposed before the in-memory claim is set — as valid Decision 099 R96-preserving work inside D100 scope, fail-safe, with no methodology change and no further code correction required. R103 accepts as a non-blocking deferred limitation the two zero-valued failure-only aggregates submissions_membership_observation_count and substantive_membership_observation_count: on a FAILED or INTERRUPTED terminal they must never be read as authoritative measured values, and authoritative evidence there remains the durable source_results, the durable event ledger, persisted catalog state, association_totality, and the other specifically governed durable evidence; COMPLETE-run semantics, canonical persisted data, source-result membership, and the E0 success gate are unaffected and the limitation does not apply to them. R104 defers the missing valid-but-wrong-interruption-state regression test as test hardening; the invariant was demonstrated against the production validator and the guard is active. Neither deferral delays execution. D101 issues the instruments Decision 094 section 12.4 reserved: ONE ordinary push of main to origin/main, required before any private catalog state is touched, with no force push, rebase, amend, or tag; bounded private evidence root access for this sequence only, resolved through the accepted DISCLOSURE_DRIFT_EVIDENCE_ROOT mechanism once per process and never printed, logged, persisted, or copied; the exact 0013 -> 0014 -> 0015 transition through the accepted operator surface with every frozen Decision 094 section 5.2 predicate and the under-lease recheck required, including the Decision 099 R97 M3.2 completion-receipt/catalog binding at cumulative 77 physical attempts; and ONE M3.3-E0 invocation authorized IF AND ONLY IF that transition completes and verifies COMPLETE. Each execute mode is enabled solely by its own constant-only source activation — PRE_E0_CATALOG_TRANSITION_AUTHORITY to M3_3_D101_PRE_E0_CATALOG_TRANSITION_AUTHORIZED and M3_3_E0_EXECUTION_AUTHORITY to M3_3_D101_E0_EXECUTION_AUTHORIZED — each in its own separate local commit, with the SHA-256 of the token recorded as owner_authority_sha256 in the corresponding terminal record. Every accepted D091-D100 evidence, canonical relation, complete association, no-fallback, no-entity-invention, projection, provenance, verification, freeze, and identity rule is preserved. E0 is OFFLINE; migration 0016, the persistence bridge, E1, E2, and M3.4 remain unauthorized; network, SEC, HTTP, DNS, and fetch authority remain NONE at REQUEST_CEILING 0. The sequence stops for Sol owner review after verified E0; the read-only R52 linkage diagnostic may run only under unambiguous existing authority and never becomes a new owner ruling by the executing session. NEXT: checkpoint push, then transition, then conditional E0, then owner review.

DECISION_103_STATUS: ACCEPTED — OWNER IMPLEMENTATION AUTHORIZATION 2026-08-16; outcome M3_3_D103_RECOVERY_IMPLEMENTATION_AUTHORIZED. The Decision 101 sequence completed the 0013 -> 0014 -> 0015 transition and then began M3.3-E0 under namespace m3_3_e0_offline_parse_v1; that invocation was INTERRUPTED and is classified UNDETERMINED / NOT COMPLETE with two valid chained events, no terminal, and no receipt, beside a verified backup, catalog head 0015 at logical SHA-256 5c823d216957c0035babd4956f9d9e0c3c0b8ea54455231436a514191c6ad306, input observation set b1122bb9fbb084411ce3cb3b7d192c7874c8969aadbb29f6ca313543b8e533be, 76 of 76 sources not_started, 0 census parser runs, a 0-byte WAL, and a stale persisted writer lease recording state held for the dead pid 43427. D103 closes the two resulting gaps and authorizes IMPLEMENTATION ONLY. R105 advances E0_RUN_NAMESPACE to m3_3_e0_offline_parse_v2 by reviewed source change alone, adding no --run-namespace, environment, or configuration override, and supersedes the E0 run-namespace literal in Decision 094 section 7.1 and only that literal. R106 keeps m3_3_e0_offline_parse_v1 as immutable interrupted evidence that the successor validates — present, non-symlinked, terminal-free, receipt-free, chain-valid, and recording no EXECUTION_RECEIPT_WRITTEN, FAILED, or INTERRUPTED event — so an absent, renamed, or manufactured-success v1 stops the successor. R107 defines the conjunctive fail-closed eligibility ladder L1 through L12: persisted state held, structural validity with no unrecognized field, host-fingerprint match, recorded PID not alive, no other active catalog writer including an empty write-ahead log, an exclusive non-blocking flock acquired without creating the file, expiry passed, all three SQLite integrity gates, both catalog identity digests equal to the fixed accepted recovery baseline, both network switches disabled, no conflicting recovery namespace, and the lock held continuously across reassertion and mutation. No elapsed time, dead PID, or free advisory lock authorizes takeover alone. R108 makes the reconciliation truthful: the lease moves held -> released WITHOUT released_at_utc and WITH reconciliation_reason owner_authorized_stale_writer_recovery, reconciled_at_utc, and reconciled_prior_state, while lease_id, writer_pid, host_fingerprint, acquired_at_utc, and expires_at_utc are carried through unchanged, so voluntary release by pid 43427 cannot be inferred. R109 confines the durable write set to the lease sidecar and its own record, opens the catalog only through SQLITE_OPEN_READONLY, requires measured before-equals-after catalog identity, and documents that lock continuity outranks rename-atomicity because flock is held on the inode. R110 adds the operator surface m3 reconcile-writer-lease with exactly --config and --mode preflight or execute, its own STALE_WRITER_LEASE_RECOVERY_AUTHORITY activation constant, no verify mode, and none of --force, --pid, --lease-id, --host, --catalog, --lease-file, --evidence-root, --ignore-lock, --skip-check, --run-namespace, or --network. R111 writes one write-once recovery record at runs/m3_3_stale_writer_lease_recovery_v1/writer_lease_recovery_record.json reusing canonical_bytes, compute_terminal_record_id, result_token, write_once, create_run_namespace, and the section 5 prohibited-content scan, binding both lease digests, the prior lease_id and writer_pid, every eligibility result, and the catalog's before and after logical, byte, input-observation-set, WAL, integrity, and applied-chain measurements. R112 keeps the v2 successor preflight fail-closed and requires v2 to start its own event sequence, backup, terminal, and receipt. The ordinary E0 preflight, execute, and verify surfaces continue to refuse a persisted lease state of held. THIS RECORD AUTHORIZES IMPLEMENTATION ONLY: modifying, deleting, or reconciling the real stale lease, creating the real recovery receipt, executing E0 v2, modifying v1 evidence, restoring the catalog, migration 0016, the persistence bridge, E1, E2, M3.4, network, SEC, HTTP, DNS, a push, and a tag all remain unauthorized at REQUEST_CEILING 0. NEXT: one fresh read-only independent review of the implementation commit, then Sol owner acceptance.

DECISION_105_STATUS: ACCEPTED — OWNER BOUNDED CORRECTION AUTHORIZATION 2026-08-16; outcome M3_3_D105_UNREADABLE_WRITER_LEASE_FAILS_CLOSED. The final D103 + D104 technical review is accepted as technical evidence and otherwise PASSED; its single MINOR is OWNER-RECLASSIFIED AS MAJOR and dispositioned here, and every other finding is owner-classified non-blocking and is not reopened. THE DEFECT: Decision 103 R109 rewrites the lease IN PLACE on the descriptor whose flock is held continuously, so a process that dies between the truncation and the completed write leaves a lease that is not structurally readable; the ordinary Decision 094 section 5.2 predicate 9 parsed that file with a lenient json probe, returned the recorded state as None whenever it could not establish one, and refused only on the exact comparison state == held. An unreadable lease therefore arrived as a value that is not held, and a value that is not held read as permission to proceed. Measured on the pre-correction tree over a disposable catalog beneath a synthetic root with a torn lease present, BOTH ordinary gates returned passed=True with an empty refusal tuple, having already recorded writer_lease: unreadable as a measured fact. R115: an EXISTING persisted writer lease clears predicate 9 in exactly one way — it is a structurally valid lease document, read through the same production read_persisted_lease the L1-L12 ladder uses, recording exactly released. Torn, truncated-to-zero, non-UTF-8, non-JSON, non-object, required-field-missing, unknown-field, unusable-field-value, and unknown-state documents ALL REFUSE, at BOTH the PRE-E0 transition gate and the E0 gate, which share one implementation. A valid held lease keeps its own unchanged refusal and the two refusals are never merged, because a writer holding the lease and a lease that cannot be read are different facts an operator acts on differently. An ABSENT lease keeps its accepted Decision 094 finding-m1 semantics exactly: it passes, and the read-only preflight still never creates the file it inspects. NO new lease-state vocabulary is created — storage/catalog.py remains the module that defines held and released and the predicate imports those two constants; read_persisted_lease is NOT weakened in either direction; NO rename-based lease replacement is added; and the R109 in-place-write decision is NOT disturbed. NOTHING ELSE CHANGES: the v2 successor namespace, v1 immutable predecessor validation, the conjunctive fail-closed L1-L12 ladder, under-lock reassertion, the truthful held -> released reconciliation, the continuous flock, measured catalog nonmutation, the create-once recovery namespace, the write-once recovery record, recovery-record authority binding, prohibited-content scan handling, and zero network/request semantics are all preserved, and Decision 103 R105-R112 and Decision 104 R113-R114 stand. STALE_WRITER_LEASE_RECOVERY_AUTHORITY remains None. PRE_E0_CATALOG_TRANSITION_AUTHORITY and M3_3_E0_EXECUTION_AUTHORITY remain exactly as Decision 101 sections 7 and 8 set them, so transition and E0 activation semantics are unchanged. No accepted test conflicted with this record and none was deleted, skipped, or relaxed; the regression family is additive, drives the shipped predicate rather than a test-local reimplementation, and non-vacuity was demonstrated by a bounded disposable mutation that restored the pre-correction behaviour, failed 24 of 24 unreadable-lease assertions, and was restored byte-exactly. THIS RECORD GRANTS NO EXECUTION AUTHORITY: activating the recovery constant, reconciling the real stale lease, creating the real recovery receipt, executing E0 v2, modifying v1 evidence, restoring the catalog, migration 0016, the persistence bridge, E1, E2, M3.4, network, SEC, HTTP, DNS, a push, and a tag all remain unauthorized at REQUEST_CEILING 0. NEXT: return to Sol for owner acceptance; no additional independent review is required.

DECISION_104_STATUS: ACCEPTED — OWNER BOUNDED CORRECTION AUTHORIZATION 2026-08-16; outcome M3_3_D104_RECOVERY_ACTIVATION_CORRECTED_TO_DISABLED. The Decision 103 acceptance review returned one MAJOR and D104 corrects exactly that one: the governed stale-writer-lease reconciliation surface shipped with its activation constant live as STALE_WRITER_LEASE_RECOVERY_AUTHORITY = M3_3_D103_STALE_WRITER_LEASE_RECONCILIATION_AUTHORIZED, granting in source precisely what Decision 103's own header withheld with REAL_LEASE_RECONCILIATION_EXECUTION: NOT AUTHORIZED BY THIS RECORD. The L1-L12 ladder is an eligibility test and not an authorization, and Decision 102 established every one of its predicates was already true of the real lease, so the constant was the only remaining barrier between a governed capability and the accepted private evidence root. R113 ships the constant None: m3 reconcile-writer-lease --mode execute is NOT ENABLED and returns exit 3 through the existing _require_activation door ahead of private-root resolution, so the refusal is unconditional, consults no lease, catalog page, or namespace, and reads, creates, locks, or writes no private state; no flag, environment value, configuration field, preflight result, catalog state, lease state, namespace, or receipt substitutes for it; and preflight stays strictly read-only as governed, rendering reconciliation_enabled as a measured fact so a passing report neither activates the surface nor implies mutation authority. R114 requires the durable recovery record to bind the authority actually active for the execution — the value _require_activation returns — never a literal carried in the record builder, asserted adversarially against the Decision 103 literal's digest. NOTHING ELSE CHANGES: the v2 successor namespace, v1 predecessor validation, the conjunctive fail-closed L1-L12 stale-lease ladder, under-lock reassertion, the truthful held -> released reconciliation withholding released_at_utc and recording reconciliation_reason, the continuously held flock, measured catalog nonmutation through SQLITE_OPEN_READONLY, the create-once recovery namespace, the write-once recovery record, zero network and request semantics, and successor gating are all preserved, and Decision 103 R105-R112 stand. PRE_E0_CATALOG_TRANSITION_AUTHORITY and M3_3_E0_EXECUTION_AUTHORITY remain exactly as Decision 101 sections 7 and 8 set them, so ordinary E0 and transition authority is unaffected. One accepted assertion pinned the shipped constant to the Decision 103 literal and is RESTATED, not deleted or skipped, per Decision 104 section 5; every test exercising successful execute behaviour injects its own disposable activation token explicitly. THIS RECORD GRANTS NO EXECUTION AUTHORITY: activating the constant, reconciling the real stale lease, creating the real recovery receipt, executing E0 v2, modifying v1 evidence, restoring the catalog, migration 0016, the persistence bridge, E1, E2, M3.4, network, SEC, HTTP, DNS, a push, and a tag all remain unauthorized at REQUEST_CEILING 0. NEXT: one fresh read-only independent review of the corrected implementation, then Sol owner acceptance.

DECISION_106_STATUS: ACCEPTED — OWNER ACCEPTANCE AND READ-ONLY PREFLIGHT AUTHORIZATION 2026-08-16; outcome M3_3_D105_RECOVERY_IMPLEMENTATION_OWNER_ACCEPTED. THE COMPLETE STALE-WRITER-LEASE RECOVERY IMPLEMENTATION CHAIN IS OWNER-ACCEPTED AT BLOCKER 0 / MAJOR 0: the Decision 103 implementation at 91f9058ff42737ddde09720bd0745ef92c4f3daf, the Decision 104 activation correction at 104a5ec09115457db95aefbf87c2322dab1398af, and the Decision 105 unreadable-lease correction at f22dacedd7ced9c943e8a4ef1ba3002c75ed4173, tree e322b382cf6bbfeb4beb47b825558faa643019ad. The final D103+D104 review observation that the lease reader consumes at most 64 KiB is owner-recorded NON-BLOCKING, because an oversized or otherwise unreadable lease document fails closed rather than being interpreted as released. NO ADDITIONAL INDEPENDENT REVIEW OF THIS IMPLEMENTATION IS REQUIRED and the accepted executable validation is expressly not re-run. Decision 106 section 2 disposes of the carried adjudication points exactly once and reopens no Decision 103, Decision 104, or Decision 105 ruling: F1 the lock-continuity-over-rename trade ACCEPTED, because downstream ordinary transition and E0 readers now also fail closed on an existing malformed, torn, or unreadable lease; F2 in-place lease provenance beside the recovery record's prior_lease binding ACCEPTED as sufficient and truthful; F3 empty inherited SQLite WAL/SHM sidecars ACCEPTED OBSERVATION; F4 the narrowly scoped owner_authority_sha256 prohibited-content-scan handling ACCEPTED, the value still scanned and no general exemption added; F6 stale illustrative v1 pointers DEFERRED DOCUMENTATION DEBT that does not delay recovery; F7 the absent decision_102 record artifact an ACCEPTED DOCUMENTATION/NUMBERING GAP on which no runtime behaviour and no controlling authority depends, Decision 103 section 1 being the committed record that carries those findings; F8 the prior absence of real-state measurement CLOSED by the operation section 6 authorizes; F9 commit trailers NON-MATERIAL. ACCEPTANCE OF AN IMPLEMENTATION IS NOT ACTIVATION OF AN OPERATION. Section 5 authorizes one minimal governance commit carrying this record and the minimum registry/index/status navigation, plus ONE ORDINARY PUSH OF main TO origin/main with no force, rebase, amend, or tag, that push being the only network activity the record permits; a failed push or any divergence is a STOP and private state is not accessed. Section 6 authorizes, AFTER SUCCESSFUL PUBLICATION ONLY, exactly one read-only disclosure-drift m3 reconcile-writer-lease --config configs/project.yaml --mode preflight against the accepted private evidence root, resolved through the accepted resolver alone with no filesystem discovery, no HOME search, no disclosure of the private absolute root, no copying of private evidence into the repository, and no mutation of any private-state byte, requiring direct measurement of Decision 103 section 5 predicates L1 through L11 plus the read-only v1 predecessor state, and exempting L12 as an execute-path control-flow property that no read-only measurement can establish. Section 7 requires before/after identities proving nonmutation across the lease digest and byte length, the catalog digest and byte length, the catalog logical digest, the observation-set digest, the applied migration chain, the governed WAL byte length, the v1 event-ledger digest and byte length, and the continued absence of the recovery namespace and record; any unexpected change to governed state is a STOP classified MAJOR or BLOCKER. Section 8 imposes the REQUIRED STOP: even if every real-state predicate passes, the recovery is NOT executed, STALE_WRITER_LEASE_RECOVERY_AUTHORITY REMAINS None, no recovery record is created, the lease is not written, the recovery namespace is not created, and E0 v2 is not started. Real reconciliation execution, the real recovery receipt, E0 v2 execution, modifying v1 evidence, restoring the catalog, migration 0016, the persistence bridge, E1, E2, M3.4, SEC, HTTP, DNS, a force push, a rebase, an amend, and a tag all remain unauthorized at REQUEST_CEILING 0. PRE_E0_CATALOG_TRANSITION_AUTHORITY and M3_3_E0_EXECUTION_AUTHORITY are untouched and remain exactly as Decision 101 sections 7 and 8 set them. NEXT: return the measured real state to Sol/GPT-5.6 for the reconciliation-authorization ruling.

DECISION_107_STATUS: ACCEPTED — OWNER AUTHORIZATION OF ONE REAL STALE-WRITER-LEASE RECONCILIATION 2026-08-16; outcome M3_3_D107_REAL_STALE_WRITER_LEASE_RECONCILIATION_AUTHORIZED. EXERCISED AND CLOSED 2026-08-17: the one authorized reconciliation was executed EXACTLY ONCE through the governed operator surface, returned status complete, and was verified against real state on every section 6 obligation — released lease with preserved provenance and no false released_at_utc, exactly one recovery namespace and one write-once record whose canonical bytes round-trip and whose terminal_record_id, result_token, and R116 authority digest all recompute, prior and resulting lease identities matching the immediately-pre-execution and actually-released documents, request and attempt counts 0, no private path or secret serialized, catalog before equals after at head 0015 with 0016 absent and a 0-byte WAL, v1 byte-identical and still UNDETERMINED / NOT COMPLETE, and exactly-once established by read-only inspection alone because a repeat preflight now REFUSES at exit 4 on both grounds. R118 IS APPLIED: STALE_WRITER_LEASE_RECOVERY_AUTHORITY is None, M3_3_E0_EXECUTION_AUTHORITY REMAINS None, PRE_E0_CATALOG_TRANSITION_AUTHORITY is untouched, and neither governed literal is retained in source. The section 7 budget of two commits and two ordinary pushes is SPENT. THE RECORD AS ACCEPTED FOLLOWS. THE ONE READ-ONLY REAL-STATE PREFLIGHT DECISION 106 SECTION 6 AUTHORIZED HAS BEEN EXECUTED AND IS OWNER-ACCEPTED AT BLOCKER 0 / MAJOR 0 under token M3_3_D106_REAL_RECOVERY_PREFLIGHT_OWNER_ACCEPTED. Every applicable Decision 103 section 5 predicate L1 through L11 measured PASS against real private state; byte and logical identities were unchanged across the measurement; the catalog measured migration chain 1..15 at applied head 0015 with 0016 absent, integrity PASS, foreign-key violations 0, accepted catalog logical identity MATCH, accepted observation-set identity MATCH, and a 0-byte write-ahead log; the recovery namespace was ABSENT; both tracked network switches measured false. L12 remains exempt from real-state proof as an execute-path control-flow property that no read-only measurement can establish, exactly as Decision 106 section 6 rules. THE V1 PREDECESSOR IS ACCEPTED AS MEASURED: present, a real non-symlinked directory, a valid two-event ledger, no terminal record, no execution receipt, no closing event, and therefore permanently UNDETERMINED / NOT COMPLETE. Decision 103 R106 is unchanged and controls: v1 is immutable interrupted evidence and is not repaired, resumed, renamed, overwritten, deleted, closed, or converted into success evidence. R116 ACTIVATES THE RECOVERY SURFACE FOR EXACTLY ONE USE: STALE_WRITER_LEASE_RECOVERY_AUTHORITY is set by reviewed source change to exactly M3_3_D107_REAL_STALE_WRITER_LEASE_RECONCILIATION_AUTHORIZED, which is the separate owner instrument Decision 104 R113 and Decision 106 section 8 each reserved, authorizing exactly one disclosure-drift m3 reconcile-writer-lease --config configs/project.yaml --mode execute through that governed operator surface with no direct-library substitute, no second execute, and no auto-retry. ACTIVATION IS NECESSARY AND NEVER SUFFICIENT: the conjunctive fail-closed L1 through L12 ladder still runs in full, no flag, environment value, configuration field, preflight result, catalog state, lease state, namespace, or receipt substitutes for any predicate, preflight stays strictly read-only, and a passing preflight remains a measurement rather than permission. Per Decision 104 R114 the durable recovery record binds the authority actually active for the execution, so owner_authority_sha256 is the SHA-256 of that token and of nothing else, and the token's value is never printed, logged, or persisted. R117 IS CAPABILITY SEPARATION AND IS APPLIED BEFORE ANY PRIVATE STATE IS TOUCHED: M3_3_E0_EXECUTION_AUTHORITY is set to None, so m3 offline-parse --mode execute is NOT ENABLED and returns exit 3 through the existing _require_activation door ahead of private-root resolution, consulting no lease, catalog page, namespace, or receipt. The Decision 101 section 8 authorization was issued for the m3_3_e0_offline_parse_v1 generation and was consumed by the invocation that was interrupted, and the only thing that had kept E0-v2 from proceeding since was the stale writer lease this record authorizes clearing, so leaving E0 executable across that reconciliation would have meant one operation's success silently re-enabled a second, separately governed one. PRE_E0_CATALOG_TRANSITION_AUTHORITY is untouched and remains exactly as Decision 101 section 7 set it. R118 WITHDRAWS THE RECOVERY AUTHORITY AFTER VERIFIED COMPLETION: STALE_WRITER_LEASE_RECOVERY_AUTHORITY returns to None by a further reviewed source change and M3_3_E0_EXECUTION_AUTHORITY REMAINS None, so both surfaces ship disabled at the end of the sequence; a second real reconciliation would require both a new owner instrument and a reviewed source change to a v2 recovery generation, exactly as Decision 103 R105 requires of a second E0. Section 6 fixes the required real verification: the lease persisted as exactly released with the original lease_id and writer_pid and the governed host, acquisition, and expiry provenance preserved, released_at_utc NOT falsely written, reconciliation_reason exactly owner_authorized_stale_writer_recovery, reconciled_at_utc present, reconciled_prior_state exactly held, and the result structurally valid through the production reader; exactly one recovery namespace and one write-once record with canonical bytes, recomputing terminal_record_id and result_token, binding this record's active authority digest, the prior lease identity matching the D106 and immediately-pre-execution lease, the resulting lease identity matching the actually released lease, an eligibility block reflecting measured real facts, logical request count 0, physical attempt count 0, and no private absolute path or secret serialized; before equals after for the catalog file digest and byte length, catalog logical digest, observation-set digest, applied migration chain, applied head 0015, integrity, foreign-key violations, and governed write-ahead-log content and length, with NO catalog mutation permitted on any path; and the v1 event ledger byte-identical with no v1 terminal, receipt, or closing event. EXACTLY-ONCE IS ESTABLISHED WITHOUT A SECOND EXECUTE, from read-only inspection alone, because the lease no longer records held and the create-once recovery namespace already exists. Any unexpected change to governed real state is a STOP classified MAJOR or BLOCKER; on failure, interruption, an undetermined outcome, a permission block, or verification inconsistency the recovery namespace and record are NOT deleted, the lease is NOT repaired by hand, the recovery is NOT re-run, E0 is NOT activated, and the exact measured state is returned to Sol/GPT-5.6. Section 7 authorizes two commits and two ordinary pushes of main to origin/main and no others, with no force push, rebase, amend, or tag: one activation/governance commit gated by ONE make check-fast captured on its first run, a failure there being a STOP at which no private state is touched, and local main required to equal origin/main before any private-state mutation; then one post-recovery deactivation/status commit gated by bounded targeted activation/refusal tests plus touched-file static checks. Section 8 bounds private-root access to the accepted DISCLOSURE_DRIFT_EVIDENCE_ROOT resolver alone, with no filesystem discovery, no HOME search, no rediscovery, no disclosure of the private absolute path, no persistence of it in the repository, deletion of any session-local carrier afterwards, and a governed durable write set of exactly the writer-lease sidecar and the one recovery record. Section 9 authorizes ONE READ-ONLY E0-v2 preflight after verified recovery and after both authorities are disabled, solely to measure whether the accepted successor predicates now hold; THAT MEASUREMENT AUTHORIZES NOTHING and E0-v2 is not executed. NO E0-v2 EXECUTION IS AUTHORIZED BY THIS RECORD before, during, or after the reconciliation; a later separate owner instrument is required and a verified recovery is neither that instrument nor evidence of it. A second real reconciliation, any migration and migration 0016 specifically, the persistence bridge, E1, E2, M3.4, SEC, EDGAR, HTTP, DNS, any acquisition, direct SQLite mutation, manual lease editing, any direct recovery-library substitute for the governed operator surface, restoring the catalog, modifying v1 evidence, a force push, a rebase, an amend, and a tag all remain unauthorized at REQUEST_CEILING 0. NEXT: return the verified reconciliation result and the read-only E0-v2 preflight measurement to Sol/GPT-5.6.

DECISION_108_STATUS: ACCEPTED — OWNER AUTHORIZATION OF ONE REAL M3.3-E0 (v2) EXECUTION 2026-08-17; outcome M3_3_D108_E0_V2_EXECUTION_AUTHORIZED. THE DECISION 107 REAL STALE-WRITER-LEASE RECOVERY IS OWNER-ACCEPTED AND CLOSED under token M3_3_D107_REAL_STALE_LEASE_RECOVERY_OWNER_ACCEPTED at BLOCKER 0 / MAJOR 0, at published HEAD 0d699a149cd74dedbbcae1b907a431ff6ba35fd6 on main and origin/main alike, with the writer lease released, the recovery namespace present and spent and create-once, the catalog at migration head 0015 with 0016 absent and integrity PASS, accepted catalog logical identity MATCH, accepted observation-set identity MATCH, the v1 predecessor present with a valid 2-event ledger and no terminal, no execution receipt and no closing event and therefore permanently UNDETERMINED / NOT COMPLETE, and the latest real read-only E0-v2 preflight PASS across every frozen successor predicate. No additional recovery work is authorized and none is needed. R120 AUTHORIZES EXACTLY ONE REAL E0-v2 EXECUTION: M3_3_E0_EXECUTION_AUTHORITY is set by reviewed source change to exactly M3_3_D108_E0_V2_EXECUTION_AUTHORIZED, authorizing exactly one disclosure-drift m3 offline-parse --config configs/project.yaml --mode execute through the governed operator surface with no direct-library substitute, no second execute, no retry, no manual catalog edit, no manual namespace edit, no migration and no network. That is the separate owner instrument Decision 107 section 5 reserved, issued ON the verified recovery and the read-only successor preflight and never granted BY them. ACTIVATION IS NECESSARY AND NEVER SUFFICIENT: every frozen Decision 094 section 5 predicate and every Decision 103 section 10 successor predicate still runs, conjunctively and fail-closed; no flag, environment value, configuration field, preflight result, catalog state, lease state, namespace or receipt substitutes for any predicate; preflight remains strictly read-only and a passing preflight remains a measurement rather than permission. Per Decision 104 R114 the durable terminal binds the authority actually active, so owner_authority_sha256 is the SHA-256 of that token and of nothing else and the value itself is never printed, logged or persisted. The run namespace remains exactly m3_3_e0_offline_parse_v2 per Decision 103 R105, with no --run-namespace, environment override or configuration field, and the interrupted v1 predecessor remains immutable evidence under Decision 103 R106 that the successor VALIDATES rather than repairs, resumes, renames, overwrites, deletes, closes or reads as a v2 prefix. R119 WITHDRAWS THE SPENT TRANSITION GRANT: PRE_E0_CATALOG_TRANSITION_AUTHORITY is set to None and the Decision 101 section 7 literal is retained nowhere in the module, because that grant authorized exactly one 0013 -> 0014 -> 0015 transition, that transition ran to a COMPLETE and verified terminal, and a consumed grant left lying in source is a value a later reader can mistake for a live one. THE WITHDRAWAL IS SAFE FOR E0 AND IS NOT A CHANGE TO E0'S INPUTS: E0 reads the completed transition TERMINAL RECORD as a predicate, does not re-derive it from the constant, and no verification path recomputes an authority digest from it. The intended capability state immediately before execution is m3 offline-parse --mode execute ENABLED by the exact R120 token for exactly one invocation, m3 prepare-e0-catalog --mode execute DISABLED at None, and m3 reconcile-writer-lease --mode execute DISABLED at None; neither spent capability is reactivated by this record, by the execution, or by the execution's success. R121 FIXES THE REQUIRED PREFLIGHT AND VERIFICATION: immediately before execution and after publication, exactly one fresh real read-only E0-v2 preflight must PASS on every frozen predicate including a valid released writer lease, an available exclusive writer lock, migration chain exactly 1..15 at applied head 0015 with 0016 absent, quick_check PASS, integrity_check PASS, foreign-key violations 0, accepted catalog logical identity MATCH, accepted observation-set identity MATCH, a present COMPLETE and valid transition terminal, a present immutable v1 predecessor with a valid 2-event chain and no terminal, no execution receipt and no closing event, an absent v2 namespace, all 13 precondition tables at the frozen empty state, planned source count 76 with all 76 parser_state not_started, census parser-run count 0, satisfied disk headroom, both network switches disabled, and E0 execute enabled by exactly the R120 authority; ANY failing or changed predicate is a STOP and E0 is not executed. Verification then requires the v2 run namespace exactly m3_3_e0_offline_parse_v2 with a COMPLETE terminal whose terminal_record_id and result token both recompute, a valid event ledger contiguous from 1 whose head identity recomputes, a canonical execution receipt where governed and NO sequence or head inheritance from v1; the catalog still at chain 1..15, head 0015, 0016 absent, quick_check and integrity_check ok, foreign-key violations 0 and the governed catalog-state identity recomputing; planned source count 76 with source-result totality satisfying accepted Decision 094, Decision 099 and Decision 100 semantics, every durable source disposition represented exactly once, disposition counts reconciling, parser state and result identities reproducing, NO invented source and NO observation or scalar fallback; a valid canonical relational association materialization with complete association-set rules enforced and association_totality valid, NO entity invention and NO scalar anchor used as canonical association scope; all governed table hashes, the parser-state hash and the E0 catalog-state hash reproducing, FK/integrity/content validations PASS, freeze identities independently recomputing and NO self-referential identity preimage; E0-v2 owning its own backup with v1 backup and evidence untouched and required provenance identities reconciling; and actual_logical_request_count 0, actual_physical_attempt_count 0, with no SEC, EDGAR, HTTP or DNS activity. Any unexpected change to governed real state is a STOP classified MAJOR or BLOCKER; on failure, interruption, an undetermined outcome, a permission block or verification inconsistency the run is NOT re-run, NOT resumed and NOT manufactured into completion, v2 evidence is NOT removed or overwritten, v1 evidence is NOT modified, the catalog is NOT repaired by hand, and the exact measured state is returned to Sol/GPT-5.6 after the R122 shutdown. R122 WITHDRAWS THE EXECUTION AUTHORITY AFTER THE ONE INVOCATION: once the single real invocation has returned, whether COMPLETE or not, M3_3_E0_EXECUTION_AUTHORITY is set back to None by a further reviewed source change while STALE_WRITER_LEASE_RECOVERY_AUTHORITY and PRE_E0_CATALOG_TRANSITION_AUTHORITY both REMAIN None, so all three governed execute surfaces ship disabled at the end of the sequence and a second real E0 would require both a new owner instrument and a reviewed source change to a v3 generation exactly as Decision 103 R105 requires. A verified E0-v2 is NOT linkage-gate closure, migration 0016 authority, persistence-bridge authority, E1 authority, E2 authority or M3.4 authority; each remains a separate owner act. R123 AUTHORIZES THE POST-E0 R52 LINKAGE DIAGNOSTIC AS READ ONLY, only if E0-v2 is COMPLETE and independently verified, with no methodology change and no persistence write: it runs against the accepted Decision 091 durable Review-A evidence in the canonical export Decision 093 sections 3 to 5 fix, over an input denominator of exactly the 96 accepted form+date assertions with the six form-only partials visible but OUTSIDE the denominator, resolving through the canonical relational association E0 establishes and classifying each eligible assertion only under the accepted exact resolver as ZERO, EXACTLY_ONE, MULTIPLE or UNESTABLISHED_ASSOCIATION_SET, with NO name inference, ticker inference, fuzzy matching, scalar fallback, observation fallback or entity invention; acceptance ordering for EXACTLY_ONE cases is assessed separately from accepted native authority alone and is reported ORDERING_UNAVAILABLE where the native original acceptance timestamp remains unavailable per Decision 093 sections 7 to 8, and MISSING ORDERING EVIDENCE IS NEVER CONVERTED INTO A PASS; the executing session does NOT make the owner linkage-gate ruling. Section 7 authorizes two commits and two ordinary pushes of main to origin/main and no others, with no force push, rebase, amend or tag: one activation/governance commit gated by ONE make check-fast captured on its first run, a failure there being a STOP at which the real E0 state is neither accessed nor mutated, and local main required to equal origin/main before any private state is mutated; then one post-invocation shutdown/status commit gated by bounded targeted activation and refusal tests plus touched-file static checks. Section 8 bounds private-root access to the accepted DISCLOSURE_DRIFT_EVIDENCE_ROOT resolver alone with no filesystem discovery, no HOME search, no rediscovery, no disclosure of the private absolute path and no persistence of it in the repository, and fixes the governed durable write set as the Decision 094 section 6.1 sixteen-table footprint plus the category-A parser_state transition inside the operational catalog and the E0-v2 run namespace with its own backup, event ledger, terminal record and execution receipt, with v1 untouched. A second E0 execution, any migration and migration 0016 specifically, the persistence bridge, E1, E2, the final M3.3 manifest or root, M3.4, SEC, EDGAR, HTTP, DNS, any acquisition, direct SQLite mutation, manual catalog or namespace editing, any direct-library substitute for the governed operator surface, restoring the catalog, modifying v1 evidence, modifying completed v2 evidence, a force push, a rebase, an amend and a tag all remain unauthorized at REQUEST_CEILING 0. NEXT: one fresh read-only preflight, then exactly one E0-v2 execution if and only if every predicate passes, then verification, then the R122 shutdown, then the read-only R52 diagnostic if and only if E0-v2 is COMPLETE and verified, then return to Sol/GPT-5.6.
