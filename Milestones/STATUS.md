...
**`CHATGPT_OWNER_M3_2_T2_5_STAGE_AUTHORIZATION_DECISION`** — control returns to the ChatGPT owner
for the next stage decision. **T2.5 has not begun and is not authorized**, and T2.4 acceptance does
not itself authorize it: combined stage T2.5–T2.6 requires a separate explicit owner stage
