...
> packet** from Sol/GPT.
>
> **M3.3-I/R IS IMPLEMENTED, REHEARSED, AND CORRECTED AFTER ULTRAREVIEW; THE CORRECTED TARGET IS
> PENDING A FRESH READ-ONLY REREVIEW; AND NO REAL EXECUTION IS AUTHORIZED.** Accepted
...
> **THE CORRECTED TARGET HAS NOT YET PASSED A REREVIEW AND NO FORMAL ACCEPTANCE IS COMPLETE**: a
> fresh read-only ultrareview-rereview against the corrected SHA is the next act. **Two real-path
...
> OR-2 open and entry-blocking, or the M3.3 contract corrected-and-not-accepted or pending its
> fresh rereview is HISTORICAL** — accurate as at its own record's acceptance, and superseded as a
